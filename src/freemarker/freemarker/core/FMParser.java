...
public class FMParser implements FMParserConstants {
	...
	/**
	 * Throw an exception if the expression passed in is a literal other than of
	 * the numerical type
	 */
	...
	// expression syntax.
	/**
	 * This is the same as OrExpression, since the OR is the operator with the
	 * lowest precedence.
	 */
	...
	/**
	 * Lowest level expression, a literal, a variable, or a possibly more
	 * complex expression bounded by parentheses.
	 */
	...
	/**
	 * A primary expression preceded by zero or more unary operators. (The only
	 * unary operator we currently have is the NOT.)
	 */
	...
	final public Expression AdditiveExpression() throws ParseException {
		...
		label_3: while (true) {
			...
			if (plus) {
				...
				result = new ArithmeticExpression(lhs, rhs, ArithmeticExpression.SUBSTRACTION);
			}
	...
	/**
	 * A unary expression followed by zero or more unary expressions with
	...
	/**
	 * Production that builds up an expression using the dot or dynamic key name
	...
	/**
	 * Production used to jump out of a macro. The stop instruction terminates
	...
	/**
	 * Production for a block of raw text i.e. text that contains no FreeMarker
	 * directives.
	 */
	...
	/**
	 * Production for dealing with unparsed content, i.e. what is inside a
	 * comment or noparse tag. It returns the ending token. The content of the
	 * tag is put in buf.
	 */
	...
	/**
	 * A production freemarker text that may contain ${...} and #{...} but no
	 * directives.
	 */
	...
	/**
	 * A production for a block of optional content. Returns an empty Text block
	...
	final private boolean jj_3R_171() {
		if (jj_scan_token(OPEN_PAREN))
			return true;
		if (jj_3R_160())
			return true;
		if (jj_scan_token(CLOSE_PAREN))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_108() {
		if (jj_scan_token(NOESCAPE))
			return true;
		return false;
	}
	final private boolean jj_3R_170() {
		if (jj_scan_token(OPEN_BRACKET))
			return true;
		if (jj_3R_23())
			return true;
		if (jj_scan_token(CLOSE_BRACKET))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_121() {
		if (jj_scan_token(LOCALASSIGN))
			return true;
		return false;
	}
	final private boolean jj_3R_120() {
		if (jj_scan_token(GLOBALASSIGN))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_48() {
		if (jj_scan_token(NUMERICAL_ESCAPE))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_130() {
		if (jj_scan_token(SIMPLE_NESTED))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_47() {
		if (jj_scan_token(OUTPUT_ESCAPE))
			return true;
		return false;
	}
	final private boolean jj_3R_125() {
		if (jj_scan_token(STOP))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_148() {
		if (jj_scan_token(OPEN_BRACE))
			return true;
		Token xsp;
		xsp = jj_scanpos;
		if (jj_3R_156())
			jj_scanpos = xsp;
		if (jj_scan_token(CLOSE_BRACE))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_123() {
		if (jj_scan_token(SIMPLE_RETURN))
			return true;
		return false;
	}
	...
	private static void jj_la1_0() {
		jj_la1_0 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x200, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1000000, 0x800000, 0x0, 0x0, 0x1c000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x180000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x30000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2000, 0x0, 0x7fffdd40, 0x0, 0x0, 0x0, 0x7fffdd40, 0x7fffdd40, 0x0, 0x0, 0x7fffdd40, 0x0, 0x0, 0x0,
				0x0, 0x0, };
	}
	private static void jj_la1_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1000, 0x6, 0x0, 0x0, 0x0, 0x3000000, 0x4000, 0x8000, 0xc00000, 0x1e0000, 0x0, 0x0, 0x0, 0x0, 0x70, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x180, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x200000, 0x0, 0xafdfe000, 0x0, 0x0, 0x0, 0xafdfe000, 0xafdfe000, 0x0, 0x0, 0xafdfe000, 0x0, 0x0, 0x0,
				0x0, 0x0, };
	}
	private static void jj_la1_2() {
		jj_la1_2 = new int[] { 0xfe0000, 0xfe0000, 0x0, 0x0, 0x0, 0x0, 0x38000000, 0xc0000000, 0x600000, 0x60000, 0x6800000, 0x0, 0xc0180000, 0xc0180000, 0x60000, 0x180000, 0x0, 0x0, 0x0, 0xfe0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0xfe0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xfe0000, 0x0, 0xfe0000, 0x0, 0x0, 0x0, 0x0, 0x10, 0x10, 0x0, 0x0, 0x0, 0x70, 0x0, 0x0, 0x1f0,
				0x1f0, 0x1f0, 0x1f0, 0x1f0, 0x10, 0x0, 0x6, 0x0, 0x0, };
	}
	private static void jj_la1_3() {
		jj_la1_3 = new int[] { 0x10a8000, 0x10a880c, 0x800, 0xc, 0xc, 0x190, 0x0, 0x60000003, 0x0, 0x1000000, 0x28800, 0x800, 0xe00003, 0x1e00033, 0x0, 0x0, 0x5000, 0x1000, 0x5000, 0x10a880c, 0x2000, 0x0, 0x0, 0x0, 0x800000, 0x10a880c, 0x800000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1000, 0x200000, 0x200000, 0x0, 0x8200000, 0x2000, 0x1000000, 0x0, 0x20000, 0x1000000, 0x40, 0x0, 0x1000, 0x40000, 0x0, 0x80000000, 0x80000000, 0x80001000, 0x80000000, 0x80000000, 0x81000000, 0x2000, 0x18000000, 0x40000,
				0x1000000, 0x10a980c, 0x1000, 0x10a880c, 0x0, 0x2000, 0x1000000, 0x18000000, 0x0, 0x0, 0x0, 0x18000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1000000, 0x0, 0x1000, 0x1000000, };
	}
