...
function trans(key){
	if(window.transMap == null){
		...
		window.transMap.ml_pageRowCount = "每页显示";
//		window.transMap.ml_pageRowCountLabel = "每页显示行数";
		...
		window.transMap.loading_img_name="loading_simpchn.gif";
		window.transMap.ml_confirm_close_dialog = "确定关闭窗口?";
		window.transMap.ml_confirm_save_dialog = "信息已修改,是否保存当前操作?";
		window.transMap.ml_save = "保存";
		window.transMap.ml_does_not_save = "不保存";
		window.transMap.ml_cancel = "取消";
		window.transMap.ml_dialogclose_msg1 = "当前窗口将在";
		window.transMap.ml_dialogclose_msg2 = "秒钟后自动关闭！";
