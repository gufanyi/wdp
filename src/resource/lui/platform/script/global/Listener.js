			...
			for (var i = 0; i < arrListener.length; i++) {
				...
				if (func instanceof Function) {
					if (this.beforeCallEvent(eventName, eventObj) == true) {
						...
						if(eventObj != null && eventObj.stopEvent)
							return result;
						if (result != null)
							return result;
					}
...
var MouseListener = function(bIgnoreError) {
	...
	this.ignoreError = $.argumentutils.getBoolean(bIgnoreError, false);
};
...
var ExcelListener = function(bIgnoreError) {
	this.type = ExcelListener.listenerType;
	this.ignoreError = $.argumentutils.getBoolean(bIgnoreError, false);
};
 ...
 * @param {} bIgnoreError
 */
//var PasteListener = function(bIgnoreError) {
//	this.type = PasteListener.listenerType;
//	this.ignoreError = $.argumentutils.getBoolean(bIgnoreError, false);
//};
//
//PasteListener.listenerType = "PASTE_LISTENER";
//PasteListener.prototype.onBeforePaste = function(pasteEvent) {};
