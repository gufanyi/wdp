...
import xap.sys.jdbc.kernel.utils.BeanConvertor;
import xap.sys.jdbc.kernel.utils.InOutUtil;
...
public class HandlerUtils {
	 ...
	 * @throws SQLException
	 */
	public static Object toBean(ResultSet resultSet, Class<?> type) throws SQLException {
		if (resultSet == null)
			throw new SQLException("toBean(resultSet,type) : resultset is null");
		return toBeanInner(resultSet, type);
	}

	public static Object toBeanOfCurrentRow(ResultSet resultSet, Class<?> type, MethodAndTypes methodAndTypes) throws SQLException {
		Object target = null;
	...
	public static List toBeanList(ResultSet resultSet, Class<?> type) throws SQLException {
		if (resultSet == null)
			throw new SQLException("toBeanList(resultSet,type) : resultset is null");
		return toBeanListInner(resultSet, type, null);
	}

	private static List<?> toBeanListInner(ResultSet resultSet, Class<?> type, String columns[]) throws SQLException {
	...
	public static List toBeanList(ResultSet resultSet, Class<?> type, int skip, int size) throws SQLException {
		MethodAndTypes methodAndTypes = getBeanInvokeAndTypes(type, resultSet, null);
		List<Object> list = new ArrayList<Object>();
		int index = -1;
	...
	public static Object getColumnValue(int type, ResultSet resultSet, String colName) throws SQLException {
		Object value;
		switch (type) {
		case Types.VARCHAR:
		case Types.CHAR:
	 ...
	 * @throws SQLException
	 */
	public static byte[] getBlob(ResultSet rs, int columnIndex) throws SQLException {
