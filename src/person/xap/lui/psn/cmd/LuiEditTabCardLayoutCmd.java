...
public class LuiEditTabCardLayoutCmd extends LuiCommand{
	...
	public LuiEditTabCardLayoutCmd(String tabLayoutId, String dsIds, String cardLayoutIds) {
		this.tabLayoutId=tabLayoutId;
		this.dsIds = dsIds;
		this.cardLayoutIds = cardLayoutIds;
	}
	public LuiEditTabCardLayoutCmd(String tabLayoutId, String dsIds, String cardLayoutIds,String menuBarCompId) {
		this.tabLayoutId=tabLayoutId;
		this.dsIds = dsIds;
		this.cardLayoutIds = cardLayoutIds;
		this.menuBarCompId=menuBarCompId;
	}
	public LuiEditTabCardLayoutCmd(String tabLayoutId, String dsIds, String cardLayoutIds,String menuBarCompId,String toolBarCompId) {
		this.tabLayoutId=tabLayoutId;
		this.dsIds = dsIds;
		this.cardLayoutIds = cardLayoutIds;
		this.menuBarCompId=menuBarCompId;
	...
	public void execute() {
		...
		if(this.toolBarComp!=null)
			CmdInvoker.invoke(new LuiEditCardLayoutCmd(arrDsid[tabCurrentIndex],arrCardLayoutId[tabCurrentIndex],this.toolBarComp));
		else
			CmdInvoker.invoke(new LuiEditCardLayoutCmd(arrDsid[tabCurrentIndex],arrCardLayoutId[tabCurrentIndex]));

		
		if(StringUtils.isNotBlank(this.menuBarCompId))
		{
			new MenuBarItemStatusCtrl(this.menuBarCompId,"edit","card");
		}
	}
}
