...
public class Model_OpenViewCmd implements ModelCmdConf<LuiOpenViewCmd> {
	@Override
	public Class<LuiOpenViewCmd> getLuiCmdClazz() {
		return LuiOpenViewCmd.class;
	}
	@Override
	public String getCmdTpl() {
		return "OpenViewTpl.tpl";
	}
	@Override
