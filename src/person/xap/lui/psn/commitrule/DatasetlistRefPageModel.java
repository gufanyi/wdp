...
/**
 * 
 * 构建节点类，如果该节点只有一棵树时，则继承MockTreePageModel,其控制类需要重写MockTreeViewController中方法
 *    只有一个表，则继承MockGridPageModel，控制类要重写MockGridViewController中方法
 *    左树右表，继承MockTreeGridPageModel，控制类要重写MockTreeGridController中方法
 * 若为其他结构，则需自行构建
 *
 */
public class DatasetlistRefPageModel extends MockTreePageModel {
	protected void constructWidget(ViewPartMeta widget) {
		widget.setController(DatasetlistRefController.class.getName());//设置节点控制类为DatasetlistRefController
	}
