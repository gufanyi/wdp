...
public class TreeTabTabFullCardOper extends ParChiTabFullCardOper{
	public TreeTabTabFullCardOper(Map<String,String> treeMap,Map<String,String> tab_ParMap,List<Map<String,String>> listMap,List<Map<String,String>> listMap_Rela,List<Map<String,String>> listMap_TreeRela){
		super(tab_ParMap,listMap,listMap_Rela);
		
		LifeCyclePhase phase = RequestLifeCycleContext.get().getPhase();
		RequestLifeCycleContext.get().setPhase(LifeCyclePhase.nullstatus);
		
		UiTreeTabTabPopUpCardLayout  treeTabTabPopUpCardLayout=(UiTreeTabTabPopUpCardLayout)getSigTabLayout();
		...
		treeTabTabPopUpCardLayout.getTreeComp().setId(treeCompId);
