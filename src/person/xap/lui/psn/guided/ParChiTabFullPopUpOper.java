...
public class ParChiTabFullPopUpOper extends SigTabFullOper{
	public ParChiTabFullPopUpOper(){}
	public	ParChiTabFullPopUpOper(Map<String,String> map,List<Map<String,String>> listMap,List<Map<String,String>> listMap_Rela){
	    super(map);
