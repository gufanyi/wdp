...
public class TreeTabTabPopUpPopUpOper extends ParChiTabPopUpPopUpOper{
	public TreeTabTabPopUpPopUpOper(Map<String,String> treeMap,Map<String,String> tab_ParMap,List<Map<String,String>> listMap,List<Map<String,String>> listMap_Rela,List<Map<String,String>> listMap_TreeRela){
