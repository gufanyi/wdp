/**
 * css编辑器主要js文件，根据开源脚本改造
 * @author liujmc
 * @date 2012-06-12
 * @description 支持实时样式和style字符串查看，需要放开target显示
 */
...
//---------------------------------------------------QrSpinner：边框布局，如padding、margin----------------------------------------------------------
/**
 * 边框布局的构造方法
 * 
 * @param {} _defaultValue
...
function setTargetStyle(style, value){
	...
	document.getElementById("areaOutPut").value = divstr;
}
