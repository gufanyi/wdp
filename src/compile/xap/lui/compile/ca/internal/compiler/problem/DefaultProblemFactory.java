...
import xap.lui.compile.ca.jdt.internal.compiler.util.HashtableOfInt;
...
public class DefaultProblemFactory implements IProblemFactory {
	...
	private  HashtableOfInt DEFAULT_LOCALE_TEMPLATES;
...
public static HashtableOfInt loadMessageTemplates(Locale loc) {
	...
	try {
		...
		CompileLog.error("Missing resource : " + bundleName.replace('.', '/') + ".properties for locale " + loc); //$NON-NLS-1$//$NON-NLS-2$
		throw e;
	}
