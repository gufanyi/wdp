...
/**
 * @see xap.lui.compile.ca.jdt.core.compiler.CategorizedProblem#getCategoryID()
 */
 ...
 * @see xap.lui.compile.ca.jdt.core.compiler.IProblem#getID()
 * @return int
 */
public int getID() {
	return this.id;
 ...
 * @see xap.lui.compile.ca.jdt.core.compiler.CategorizedProblem#getMarkerType()
 */
