 ...
 *******************************************************************************/
package xap.lui.compile.ca.internal.core.dom;

import java.util.Iterator;
import java.util.List;
import xap.lui.compile.ca.jdt.core.dom.AST;
import xap.lui.compile.ca.jdt.core.dom.ASTNode;
import xap.lui.compile.ca.jdt.core.dom.ASTVisitor;
import xap.lui.compile.ca.jdt.core.dom.AbstractTypeDeclaration;
import xap.lui.compile.ca.jdt.core.dom.Annotation;
import xap.lui.compile.ca.jdt.core.dom.AnnotationTypeDeclaration;
import xap.lui.compile.ca.jdt.core.dom.AnnotationTypeMemberDeclaration;
import xap.lui.compile.ca.jdt.core.dom.AnonymousClassDeclaration;
import xap.lui.compile.ca.jdt.core.dom.ArrayAccess;
import xap.lui.compile.ca.jdt.core.dom.ArrayCreation;
import xap.lui.compile.ca.jdt.core.dom.ArrayInitializer;
import xap.lui.compile.ca.jdt.core.dom.ArrayType;
import xap.lui.compile.ca.jdt.core.dom.AssertStatement;
import xap.lui.compile.ca.jdt.core.dom.Assignment;
import xap.lui.compile.ca.jdt.core.dom.Block;
import xap.lui.compile.ca.jdt.core.dom.BlockComment;
import xap.lui.compile.ca.jdt.core.dom.BodyDeclaration;
import xap.lui.compile.ca.jdt.core.dom.BooleanLiteral;
import xap.lui.compile.ca.jdt.core.dom.BreakStatement;
import xap.lui.compile.ca.jdt.core.dom.CastExpression;
import xap.lui.compile.ca.jdt.core.dom.CatchClause;
import xap.lui.compile.ca.jdt.core.dom.CharacterLiteral;
import xap.lui.compile.ca.jdt.core.dom.ClassInstanceCreation;
import xap.lui.compile.ca.jdt.core.dom.CompilationUnit;
import xap.lui.compile.ca.jdt.core.dom.ConditionalExpression;
import xap.lui.compile.ca.jdt.core.dom.ConstructorInvocation;
import xap.lui.compile.ca.jdt.core.dom.ContinueStatement;
import xap.lui.compile.ca.jdt.core.dom.DoStatement;
import xap.lui.compile.ca.jdt.core.dom.EmptyStatement;
import xap.lui.compile.ca.jdt.core.dom.EnhancedForStatement;
import xap.lui.compile.ca.jdt.core.dom.EnumConstantDeclaration;
import xap.lui.compile.ca.jdt.core.dom.EnumDeclaration;
import xap.lui.compile.ca.jdt.core.dom.Expression;
import xap.lui.compile.ca.jdt.core.dom.ExpressionStatement;
import xap.lui.compile.ca.jdt.core.dom.FieldAccess;
import xap.lui.compile.ca.jdt.core.dom.FieldDeclaration;
import xap.lui.compile.ca.jdt.core.dom.ForStatement;
import xap.lui.compile.ca.jdt.core.dom.IfStatement;
import xap.lui.compile.ca.jdt.core.dom.ImportDeclaration;
import xap.lui.compile.ca.jdt.core.dom.InfixExpression;
import xap.lui.compile.ca.jdt.core.dom.Initializer;
import xap.lui.compile.ca.jdt.core.dom.InstanceofExpression;
import xap.lui.compile.ca.jdt.core.dom.Javadoc;
import xap.lui.compile.ca.jdt.core.dom.LabeledStatement;
import xap.lui.compile.ca.jdt.core.dom.LineComment;
import xap.lui.compile.ca.jdt.core.dom.MarkerAnnotation;
import xap.lui.compile.ca.jdt.core.dom.MemberRef;
import xap.lui.compile.ca.jdt.core.dom.MemberValuePair;
import xap.lui.compile.ca.jdt.core.dom.MethodDeclaration;
import xap.lui.compile.ca.jdt.core.dom.MethodInvocation;
import xap.lui.compile.ca.jdt.core.dom.MethodRef;
import xap.lui.compile.ca.jdt.core.dom.MethodRefParameter;
import xap.lui.compile.ca.jdt.core.dom.Modifier;
import xap.lui.compile.ca.jdt.core.dom.Name;
import xap.lui.compile.ca.jdt.core.dom.NormalAnnotation;
import xap.lui.compile.ca.jdt.core.dom.NullLiteral;
import xap.lui.compile.ca.jdt.core.dom.NumberLiteral;
import xap.lui.compile.ca.jdt.core.dom.PackageDeclaration;
import xap.lui.compile.ca.jdt.core.dom.ParameterizedType;
import xap.lui.compile.ca.jdt.core.dom.ParenthesizedExpression;
import xap.lui.compile.ca.jdt.core.dom.PostfixExpression;
import xap.lui.compile.ca.jdt.core.dom.PrefixExpression;
import xap.lui.compile.ca.jdt.core.dom.PrimitiveType;
import xap.lui.compile.ca.jdt.core.dom.QualifiedName;
import xap.lui.compile.ca.jdt.core.dom.QualifiedType;
import xap.lui.compile.ca.jdt.core.dom.ReturnStatement;
import xap.lui.compile.ca.jdt.core.dom.SimpleName;
import xap.lui.compile.ca.jdt.core.dom.SimpleType;
import xap.lui.compile.ca.jdt.core.dom.SingleMemberAnnotation;
import xap.lui.compile.ca.jdt.core.dom.SingleVariableDeclaration;
import xap.lui.compile.ca.jdt.core.dom.Statement;
import xap.lui.compile.ca.jdt.core.dom.StringLiteral;
import xap.lui.compile.ca.jdt.core.dom.SuperConstructorInvocation;
import xap.lui.compile.ca.jdt.core.dom.SuperFieldAccess;
import xap.lui.compile.ca.jdt.core.dom.SuperMethodInvocation;
import xap.lui.compile.ca.jdt.core.dom.SwitchCase;
import xap.lui.compile.ca.jdt.core.dom.SwitchStatement;
import xap.lui.compile.ca.jdt.core.dom.SynchronizedStatement;
import xap.lui.compile.ca.jdt.core.dom.TagElement;
import xap.lui.compile.ca.jdt.core.dom.TextElement;
import xap.lui.compile.ca.jdt.core.dom.ThisExpression;
import xap.lui.compile.ca.jdt.core.dom.ThrowStatement;
import xap.lui.compile.ca.jdt.core.dom.TryStatement;
import xap.lui.compile.ca.jdt.core.dom.Type;
import xap.lui.compile.ca.jdt.core.dom.TypeDeclaration;
import xap.lui.compile.ca.jdt.core.dom.TypeDeclarationStatement;
import xap.lui.compile.ca.jdt.core.dom.TypeLiteral;
import xap.lui.compile.ca.jdt.core.dom.TypeParameter;
import xap.lui.compile.ca.jdt.core.dom.VariableDeclarationExpression;
import xap.lui.compile.ca.jdt.core.dom.VariableDeclarationFragment;
import xap.lui.compile.ca.jdt.core.dom.VariableDeclarationStatement;
import xap.lui.compile.ca.jdt.core.dom.WhileStatement;
import xap.lui.compile.ca.jdt.core.dom.WildcardType;
