 ...
 *******************************************************************************/
package xap.lui.compile.ca.internal.core.util;
...
import xap.lui.compile.ca.internal.core.util.CommentRecorderScanner;
...
public class CommentRecorderParser extends Parser {
	 ...
	 * @see xap.lui.compile.ca.jdt.internal.compiler.parser.Parser#containsComment(int, int)
	 */
	...
	public int flushCommentsDefinedPriorTo(int position) {
		...
		if (validCount > 0){
			...
			while (index<lastCommentIndex && (immediateCommentEnd = -this.scanner.commentStops[index+1])  > 0){ // only tolerating non-javadoc comments (non-javadoc comment end positions are negative)
				...
				if (xap.lui.compile.ca.jdt.internal.compiler.util.Util.getLineNumber(position, this.scanner.lineEnds, 0, this.scanner.linePtr) 
						!= xap.lui.compile.ca.jdt.internal.compiler.util.Util.getLineNumber(immediateCommentEnd, this.scanner.lineEnds, 0, this.scanner.linePtr)) break;
