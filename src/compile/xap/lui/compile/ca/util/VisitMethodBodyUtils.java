...
//							break;
		...
		try{
			...
			CompileLog.info("VisitMethodBodyUtils:"+ch+":"+exp.getClass().getSimpleName());
		}catch(Exception e1){CompileLog.info(e1.getMessage());}
		
		//BooleanLiteral
		try{
			Boolean bo = (Boolean)c.getMethod("booleanValue", null).invoke(exp, null);
			CompileLog.info("VisitMethodBodyUtils:"+bo+":"+exp.getClass().getSimpleName());
		}catch(Exception e1){CompileLog.info(e1.getMessage());}
		
		//NumberLiteral
		try{
			value = (String)c.getMethod("getToken", null).invoke(exp, null);
			CompileLog.info("VisitMethodBodyUtils:"+value+":"+exp.getClass().getSimpleName());
		}catch(Exception e1){CompileLog.info(e1.getMessage());}
	...
	//	} catch(Exception e1){CaLogger.info(e1.getMessage());}
		...
		try{
			...
			CompileLog.info("VisitMethodBodyUtils:"+t.toString()+":"+exp.getClass().getSimpleName());
		} catch(Exception e1){CompileLog.info(e1.getMessage());}
	...
	//	}catch(Exception e1){CaLogger.info(e1.getMessage());}
		...
		try{
			...
			CompileLog.info("VisitMethodBodyUtils:"+sn.getFullyQualifiedName()+":"+exp.getClass().getSimpleName());
		}catch(Exception e1){CompileLog.info(e1.getMessage());}
