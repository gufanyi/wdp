...
import xap.lui.compile.ca.jdt.internal.compiler.ast.JavadocAllocationExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.JavadocFieldReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.JavadocMessageSend;
import xap.lui.compile.ca.jdt.internal.compiler.ast.JavadocQualifiedTypeReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.JavadocReturnStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.JavadocSingleNameReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.JavadocSingleTypeReference;
...
public class Javadoc extends ASTNode {
	...
	public ASTNode getNodeStartingAt(int start) {
		...
		if (this.seeReferences != null) {
			...
			for (int i=0; i<length; i++) {
				xap.lui.compile.ca.jdt.internal.compiler.ast.Expression expression = this.seeReferences[i];
