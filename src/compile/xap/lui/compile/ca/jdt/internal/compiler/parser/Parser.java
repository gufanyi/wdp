 ...
 *******************************************************************************/
package xap.lui.compile.ca.jdt.internal.compiler.parser;
...
import xap.lui.compile.ca.internal.compiler.problem.AbortCompilation;
import xap.lui.compile.ca.internal.compiler.problem.AbortCompilationUnit;
import xap.lui.compile.ca.internal.compiler.problem.ProblemReporter;
import xap.lui.compile.ca.internal.compiler.problem.ProblemSeverities;
import xap.lui.compile.ca.jdt.core.compiler.CharOperation;
import xap.lui.compile.ca.jdt.core.compiler.InvalidInputException;
...
import xap.lui.compile.ca.jdt.internal.compiler.ast.AND_AND_Expression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode;
import xap.lui.compile.ca.jdt.internal.compiler.ast.AbstractMethodDeclaration;
import xap.lui.compile.ca.jdt.internal.compiler.ast.AbstractVariableDeclaration;
import xap.lui.compile.ca.jdt.internal.compiler.ast.AllocationExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation;
import xap.lui.compile.ca.jdt.internal.compiler.ast.AnnotationMethodDeclaration;
import xap.lui.compile.ca.jdt.internal.compiler.ast.Argument;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayAllocationExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayInitializer;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayQualifiedTypeReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayTypeReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.AssertStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.Assignment;
import xap.lui.compile.ca.jdt.internal.compiler.ast.BinaryExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.Block;
import xap.lui.compile.ca.jdt.internal.compiler.ast.BreakStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.CaseStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.CastExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.CharLiteral;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ClassLiteralAccess;
import xap.lui.compile.ca.jdt.internal.compiler.ast.CombinedBinaryExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.CompilationUnitDeclaration;
import xap.lui.compile.ca.jdt.internal.compiler.ast.CompoundAssignment;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ConditionalExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ConstructorDeclaration;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ContinueStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.DoStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.DoubleLiteral;
import xap.lui.compile.ca.jdt.internal.compiler.ast.EmptyStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.EqualExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ExplicitConstructorCall;
import xap.lui.compile.ca.jdt.internal.compiler.ast.Expression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.FalseLiteral;
import xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration;
import xap.lui.compile.ca.jdt.internal.compiler.ast.FieldReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.FloatLiteral;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ForStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ForeachStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.IfStatement;
...
import xap.lui.compile.ca.jdt.internal.compiler.ast.InstanceOfExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.IntLiteral;
import xap.lui.compile.ca.jdt.internal.compiler.ast.IntLiteralMinValue;
import xap.lui.compile.ca.jdt.internal.compiler.ast.Javadoc;
import xap.lui.compile.ca.jdt.internal.compiler.ast.LabeledStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration;
import xap.lui.compile.ca.jdt.internal.compiler.ast.LongLiteral;
import xap.lui.compile.ca.jdt.internal.compiler.ast.LongLiteralMinValue;
import xap.lui.compile.ca.jdt.internal.compiler.ast.MarkerAnnotation;
import xap.lui.compile.ca.jdt.internal.compiler.ast.MemberValuePair;
import xap.lui.compile.ca.jdt.internal.compiler.ast.MessageSend;
import xap.lui.compile.ca.jdt.internal.compiler.ast.MethodDeclaration;
import xap.lui.compile.ca.jdt.internal.compiler.ast.NameReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.NormalAnnotation;
import xap.lui.compile.ca.jdt.internal.compiler.ast.NullLiteral;
import xap.lui.compile.ca.jdt.internal.compiler.ast.OR_OR_Expression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ParameterizedQualifiedTypeReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ParameterizedSingleTypeReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.PostfixExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.PrefixExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedAllocationExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedNameReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedSuperReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedThisReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedTypeReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.Reference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ReturnStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.SingleMemberAnnotation;
import xap.lui.compile.ca.jdt.internal.compiler.ast.SingleNameReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.SingleTypeReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.Statement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.StringLiteral;
import xap.lui.compile.ca.jdt.internal.compiler.ast.SuperReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.SwitchStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.SynchronizedStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ThisReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.ThrowStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.TrueLiteral;
import xap.lui.compile.ca.jdt.internal.compiler.ast.TryStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration;
import xap.lui.compile.ca.jdt.internal.compiler.ast.TypeParameter;
import xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference;
import xap.lui.compile.ca.jdt.internal.compiler.ast.UnaryExpression;
import xap.lui.compile.ca.jdt.internal.compiler.ast.WhileStatement;
import xap.lui.compile.ca.jdt.internal.compiler.ast.Wildcard;
import xap.lui.compile.ca.jdt.internal.compiler.classfmt.ClassFileConstants;
import xap.lui.compile.ca.jdt.internal.compiler.env.ICompilationUnit;
import xap.lui.compile.ca.jdt.internal.compiler.impl.CompilerOptions;
import xap.lui.compile.ca.jdt.internal.compiler.impl.ReferenceContext;
...
import xap.lui.compile.ca.jdt.internal.compiler.lookup.ExtraCompilerModifiers;
...
import xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeIds;
import xap.lui.compile.ca.jdt.internal.compiler.parser.diagnose.DiagnoseParser;
import xap.lui.compile.ca.jdt.internal.compiler.util.Messages;
import xap.lui.compile.ca.jdt.internal.compiler.util.Util;
import xap.lui.compile.ca.log.CompileLog;
import xap.lui.compile.ca.util.ConstantUtils;
...
public class Parser implements ParserBasicInformation, TerminalTokens, OperatorIds, TypeIds {
	...
	private final static String READABLE_NAMES_FILE_NAME = ConstantUtils.READABLE_NAMES_PATH + READABLE_NAMES_FILE; //$NON-NLS-1$
	...
	protected boolean diet = false; // tells the scanner to jump over some parts
	// of the code/expressions like method
	// bodies
	protected int dietInt = 0; // if > 0 force the none-diet-parsing mode (even
	// if diet if requested) [field parsing with
	// anonymous inner classes...]
	protected int endPosition; // accurate only when used ! (the start position
	// is pushed into intStack while the end the
	// current one)
	...
	protected int listLength; // for recovering some incomplete list
	// (interfaces, throws or parameters)
	protected int listTypeParameterLength; // for recovering some incomplete
	...
	protected int rBraceStart, rBraceEnd, rBraceSuccessorStart; // accurate only
	// when used !
	...
	public xap.lui.compile.ca.jdt.internal.compiler.ReadManager readManager;
		...
		try {
			...
			if (writer != null) {
				try {
					...
					CompileLog.error(e1.getMessage(), e1);
					// ignore
				}
			}
		}
		CompileLog.debug(filename + " creation complete");
	}
	...
	private static void buildFileForReadableName(String file, char[] newLhs, char[] newNonTerminalIndex, String[] newName, String[] tokens) {
		...
		for (; i < alreadyAdded.length; i++) {
			if (!alreadyAdded[i]) {
				CompileLog.debug(newName[i] + " has no readable name");
			}
		}
	...
	private static void buildFilesForRecoveryTemplates(String indexFilename, String templatesFilename, char[] newTerminalIndex, char[] newNonTerminalIndex, String[] newName, char[] newLhs,
			String[] tokens) {
		...
		try {
			...
			if (stream != null) {
				try {
					...
					CompileLog.error(e.getMessage(), e);
				}
			}
		}
		CompileLog.debug(filename + " creation complete");
	...
	private final static void buildFileForTable(String filename, char[] chars) {
		...
		CompileLog.debug(filename + " creation complete"); //$NON-NLS-1$
	}
	...
	// public final static void buildFilesFromLPG(String dataFilename, String
	// dataFilename2) {
	//
	...
	// CompileLog.debug(Messages.parser_incorrectPath);
	// return;
	// }
	...
	//
	//	
	// CompileLog.debug(Messages.parser_moveFiles);
	// }
	...
	protected static String[] readReadableNameTable(String filename) {
		...
		try {
			...
			CompileLog.debug("Missing resource : " + filename.replace('.', '/') + ".properties for locale " + Locale.getDefault());
			CompileLog.error(e.getMessage(), e);
			throw e;
		}
	...
	protected static long[] readLongTable(String filename) throws java.io.IOException {
		...
		while (true) {
			longs[longIndex++] = (((long) (bytes[i++] & 0xFF)) << 56) + (((long) (bytes[i++] & 0xFF)) << 48) + (((long) (bytes[i++] & 0xFF)) << 40) + (((long) (bytes[i++] & 0xFF)) << 32)
					+ (((long) (bytes[i++] & 0xFF)) << 24) + (((long) (bytes[i++] & 0xFF)) << 16) + (((long) (bytes[i++] & 0xFF)) << 8) + (bytes[i++] & 0xFF);
	...
	protected void blockReal() {
		// See consumeLocalVariableDeclarationStatement in case of change:
		// duplicated code
	...
	/*
	 * Build initial recovery state. Recovery state is inferred from the current
	 * state of the parser (reduced node stack).
	 */
	public RecoveredElement buildInitialRecoveryState() {

		/*
		 * initialize recovery by retrieving available reduced nodes also
		 * rebuild bracket balance
		 */
		...
		if (this.referenceContext instanceof CompilationUnitDeclaration) {
			...
			if (this.referenceContext instanceof AbstractMethodDeclaration) {
				...
				/*
				 * Initializer bodies are parsed in the context of the type
				 * declaration, we must thus search it inside
				 */
				if (this.referenceContext instanceof TypeDeclaration) {
					TypeDeclaration type = (TypeDeclaration) this.referenceContext;
					for (int i = 0; i < type.fields.length; i++) {
						FieldDeclaration field = type.fields[i];
						if (field != null && field.getKind() == AbstractVariableDeclaration.INITIALIZER && ((Initializer) field).block != null
								&& field.declarationSourceStart <= this.scanner.initialPosition && this.scanner.initialPosition <= field.declarationSourceEnd
		...
		if (this.statementRecoveryActivated) {
			if (this.pendingRecoveredType != null && this.scanner.startPosition - 1 <= this.pendingRecoveredType.declarationSourceEnd) {
				// Add the pending type to the AST if this type isn't already
				// added in the AST.
	...
	protected void checkAndSetModifiers(int flag) {
		/*
		 * modify the current modifiers buffer. When the startPosition of the
		 * modifiers is 0 it means that the modifier being parsed is the first
		 * of a list of several modifiers. The startPosition is zeroed when a
		 * copy of modifiers-buffer is push onto the this.astStack.
		 */
	...
	public void checkComment() {
		...
		// discard obsolete comments while inside methods or fields initializer
		// (see bug 74369)
		...
		if (this.modifiersSourceStart >= 0) {
			// eliminate comments located after modifierSourceStart if
			// positionned
			while (lastComment >= 0 && this.scanner.commentStarts[lastComment] > this.modifiersSourceStart)
				lastComment--;
		}
		if (lastComment >= 0) {
			// consider all remaining leading comments to be part of current
			// declaration
			this.modifiersSourceStart = this.scanner.commentStarts[0];

			// check deprecation in last comment if javadoc (can be followed by
			// non-javadoc comments which are simply ignored)
			while (lastComment >= 0 && this.scanner.commentStops[lastComment] < 0)
				lastComment--; // non javadoc comment have negative end
			// positions
			if (lastComment >= 0 && this.javadocParser != null) {
				int commentEnd = this.scanner.commentStops[lastComment] - 1; // stop
				// is
				// one
				// over,
				// do not report problem before last parsed comment while
				// recovering code...
				...
				this.javadoc = this.javadocParser.docComment; // null if check
				// javadoc is
				// not activated
	...
	protected void classInstanceCreation(boolean isQualified) {
		...
		// ClassBodyopt produces a null item on the astStak if it produces NO
		// class body
		...
		if (((length = this.astLengthStack[this.astLengthPtr--]) == 1) && (this.astStack[this.astPtr] == null)) {
			...
			alloc.sourceEnd = this.endPosition; // the position has been stored
			// explicitly
			...
			// will be created and added by the TC (see
			// createsInternalConstructorWithBinding)
	...
	protected void concatNodeLists() {
		/*
		 * This is a case where you have two sublists into the this.astStack
		 * that you want to merge in one list. There is no action required on
		 * the this.astStack. The only thing you need to do is merge the two
		 * lengths specified on the astStackLength. The top two length are for
		 * example: ... p n and you want to result in a list like: ... n+p This
		 * means that the p could be equals to 0 in case there is no astNode
		 * pushed on the this.astStack. Look at the InterfaceMemberDeclarations
		 * for an example.
		 */
	...
	protected void consumeAllocationHeader() {
		...
		if (this.currentElement == null) {
			return; // should never occur, this consumeRule is only used in
			// recovery mode
		}
		...
		this.lastCheckPoint = this.scanner.startPosition; // force to restart at
		// this exact
		// position
	...
	protected void consumeAnnotationTypeDeclarationHeader() {
		if (this.currentElement != null) {
			this.restartRecovery = true; // used to avoid branching back into
	...
	protected void consumeAnnotationTypeDeclarationHeaderName() {
		// consumeAnnotationTypeDeclarationHeader ::= Modifiers '@'
		// PushModifiers interface Identifier
		// consumeAnnotationTypeDeclarationHeader ::= '@' PushModifiers
		...
		// 'interface' push two int positions: the beginning of the class token
		// and its end.
		// we want to keep the beginning position but get rid of the end
		// position
	...
	protected void consumeAnnotationTypeDeclarationHeaderNameWithTypeParameters() {
		// consumeAnnotationTypeDeclarationHeader ::= Modifiers '@'
		// PushModifiers interface Identifier TypeParameters
		// consumeAnnotationTypeDeclarationHeader ::= '@' PushModifiers
	...
	protected void consumeAnnotationTypeMemberDeclaration() {
		...
		// store the this.endPosition (position just before the '}') in case
		// there is
	...
	protected void consumeArrayCreationExpressionWithInitializer() {
		...
		arrayAllocation.type.bits |= ASTNode.IgnoreRawTypeCheck; // no need to
		// worry
		// about raw
		// type
		// usage
	...
	protected void consumeAssignment() {
		...
		this.expressionPtr--;
		this.expressionLengthPtr--;
		this.expressionStack[this.expressionPtr] = (op != EQUAL) ? new CompoundAssignment(this.expressionStack[this.expressionPtr], this.expressionStack[this.expressionPtr + 1], op,
				this.scanner.startPosition - 1) : new Assignment(this.expressionStack[this.expressionPtr], this.expressionStack[this.expressionPtr + 1], this.scanner.startPosition - 1);

		if (this.pendingRecoveredType != null) {
			// Used only in statements recovery.
			// This is not a real assignment but a placeholder for an existing
			// anonymous type.
	...
	protected void consumeBinaryExpressionWithName(int op) {
		...
		this.expressionLengthPtr--;
		/*
		 * if (op == OR_OR) { this.expressionStack[this.expressionPtr] = new
		 * OR_OR_Expression( this.expressionStack[this.expressionPtr + 1],
		 * this.expressionStack[this.expressionPtr], op); } else { if (op ==
		 * AND_AND) { this.expressionStack[this.expressionPtr] = new
		 * AND_AND_Expression( this.expressionStack[this.expressionPtr + 1],
		 * this.expressionStack[this.expressionPtr], op); } else { // look for
		 * "string1" + "string2" if ((op == PLUS) &&
		 * this.optimizeStringLiterals) { Expression expr1, expr2; expr1 =
		 * this.expressionStack[this.expressionPtr + 1]; expr2 =
		 * this.expressionStack[this.expressionPtr]; if (expr1 instanceof
		 * StringLiteral) { if (expr2 instanceof CharLiteral) { // string+char
		 * this.expressionStack[this.expressionPtr] = ((StringLiteral)
		 * expr1).extendWith((CharLiteral) expr2); } else if (expr2 instanceof
		 * StringLiteral) { //string+string
		 * this.expressionStack[this.expressionPtr] = ((StringLiteral)
		 * expr1).extendWith((StringLiteral) expr2); } else {
		 * this.expressionStack[this.expressionPtr] = new
		 * BinaryExpression(expr1, expr2, PLUS); } } else {
		 * this.expressionStack[this.expressionPtr] = new
		 * BinaryExpression(expr1, expr2, PLUS); } } else {
		 * this.expressionStack[this.expressionPtr] = new BinaryExpression(
	...
	protected void consumeCastExpressionLL1() {
		// CastExpression ::= '(' Expression ')' InsideCastExpressionLL1
	...
	protected void consumeCastExpressionWithGenericsArray() {
		// CastExpression ::= PushLPAREN Name TypeArguments Dims PushRPAREN
	...
	protected void consumeCastExpressionWithPrimitiveType() {
		// CastExpression ::= PushLPAREN PrimitiveType Dimsopt PushRPAREN
	...
	protected void consumeCastExpressionWithQualifiedGenericsArray() {
		// CastExpression ::= PushLPAREN Name OnlyTypeArguments '.'
		// ClassOrInterfaceType Dims PushRPAREN InsideCastExpression
		// UnaryExpressionNotPlusMinus
		Expression exp, cast, castType;
		int end = this.intStack[this.intPtr--];
	...
	protected void consumeCatchHeader() {
		...
		// current element should be a block due to the presence of the opening
		// brace
	...
	protected void consumeClassBodyDeclaration() {
		...
		this.astLengthPtr--;
		if (this.diet)
			block.bits &= ~ASTNode.UndocumentedEmptyBlock; // clear bit since
		// was diet
		...
		this.intPtr--; // pop sourcestart left on the stack by
		// consumeNestedMethod.
		initializer.bodyStart = this.intStack[this.intPtr--];
		this.realBlockPtr--; // pop the block variable counter left on the stack
		// by consumeNestedMethod
	...
	protected void consumeClassHeaderName1() {
		...
		// compute the declaration source too
		// 'class' and 'interface' push two int positions: the beginning of the
		// class token and its end.
		// we want to keep the beginning position but get rid of the end
		// position
		// it is only used for the ClassLiteralAccess positions.
	...
	protected void consumeClassInstanceCreationExpressionQualified() {
		...
		// ClassInstanceCreationExpressionName 'new' SimpleName '('
		// ArgumentListopt ')' ClassBodyopt
	...
	protected void consumeClassInstanceCreationExpressionQualifiedWithTypeArguments() {
		// ClassInstanceCreationExpression ::= Primary '.' 'new' TypeArguments
		// SimpleName '(' ArgumentListopt ')' ClassBodyopt
		// ClassInstanceCreationExpression ::=
		// ClassInstanceCreationExpressionName 'new' TypeArguments SimpleName
		// '(' ArgumentListopt ')' ClassBodyopt
	...
	protected void consumeClassInstanceCreationExpressionWithTypeArguments() {
		// ClassInstanceCreationExpression ::= 'new' TypeArguments ClassType '('
		// ArgumentListopt ')' ClassBodyopt
		AllocationExpression alloc;
		int length;
		if (((length = this.astLengthStack[this.astLengthPtr--]) == 1) && (this.astStack[this.astPtr] == null)) {
	...
	protected void consumeClassTypeElt() {
		...
		/*
		 * if incomplete thrown exception list, this.listLength counter will not
		 * have been reset, indicating that some items are available on the
		 * stack
		 */
		this.listLength++;
	}
	...
	protected void consumeConditionalExpression(int op) {
		...
		this.expressionLengthPtr -= 2;
		this.expressionStack[this.expressionPtr] = new ConditionalExpression(this.expressionStack[this.expressionPtr], this.expressionStack[this.expressionPtr + 1],
	...
	protected void consumeConditionalExpressionWithName(int op) {
		// ConditionalExpression ::= Name '?' Expression ':'
		// ConditionalExpression
		this.intPtr -= 2;// consume position of the question mark
		pushOnExpressionStack(getUnspecifiedReferenceOptimized());
		this.expressionPtr -= 2;
		this.expressionLengthPtr -= 2;
		this.expressionStack[this.expressionPtr] = new ConditionalExpression(this.expressionStack[this.expressionPtr + 2], this.expressionStack[this.expressionPtr],
				this.expressionStack[this.expressionPtr + 1]);
	}
	...
	protected void consumeConstructorBlockStatements() {
		...
		// BlockStatements '}'
		concatNodeLists(); // explictly add the first statement into the list of
		// statements
	}
	...
	protected void consumeConstructorDeclaration() {
		...
		/*
		 * this.astStack : MethodDeclaration statements this.identifierStack :
		 * name ==> this.astStack : MethodDeclaration this.identifierStack :
		 */
		...
		if ((length = this.astLengthStack[this.astLengthPtr--]) != 0) {
			...
			if (this.astStack[this.astPtr + 1] instanceof ExplicitConstructorCall) {
				// avoid a isSomeThing that would only be used here BUT what is
				// faster between two alternatives ?
			...
			if (!this.diet || insideFieldInitializer) {
				// add it only in non-diet mode, if diet_bodies, then
				// constructor call will be added elsewhere.
				constructorCall = SuperReference.implicitSuperConstructorCall();
			}
		}
	...
	protected void consumeConstructorHeader() {
		...
		// recovery
		if (this.currentElement != null) {
			if (this.currentToken == TokenNameSEMICOLON) { // for invalid
				// constructors
	...
	protected void consumeConstructorHeaderName() {
		...
		if (this.currentElement != null) {
			if (this.lastIgnoredToken == TokenNamenew) { // was an allocation
				// expression
				this.lastCheckPoint = this.scanner.startPosition; // force to
				// restart
				// at this
				// exact
				// position
		...
		this.listLength = 0; // initialize this.listLength before reading
		// parameters/throws
	...
	protected void consumeDiet() {
		// Diet ::= $empty
		checkComment();
		pushOnIntStack(this.modifiersSourceStart); // push the start position of
		// a javadoc comment if
		// there is one
		resetModifiers();
		jumpOverMethodBody();
	}
	...
	protected void consumeEmptyMethodHeaderDefaultValue() {
		...
		AbstractMethodDeclaration method = (AbstractMethodDeclaration) this.astStack[this.astPtr];
		if (method.isAnnotationMethod()) { // 'method' can be a
			// MethodDeclaration when recovery
			// is started
			pushOnExpressionStackLengthStack(0);
		}
			...
			if (source.length > 5) {
				...
				if (source[pos] == '\\'
						&& !((c1 = ScannerHelper.getNumericValue(source[this.endStatementPosition - 3])) > 15 || c1 < 0
								...
								|| (c4 = ScannerHelper.getNumericValue(source[this.endStatementPosition])) > 15 || c4 < 0) && ((char) (((c1 * 16 + c2) * 16 + c3) * 16 + c4)) == ';') {
	...
	protected void consumeEnhancedForStatementHeaderInit(boolean hasModifiers) {
		...
		type = getTypeReference(this.intStack[this.intPtr--] + extraDims); // type
		// dimension
	...
	protected void consumeEnhancedForStatementHeader() {
		// EnhancedForStatementHeader ::= EnhancedForStatementHeaderInit ':'
		// Expression ')'
	...
	protected void consumeEnterAnonymousClassBody() {
		...
		alloc.sourceEnd = this.rParenPos; // the position has been stored
		// explicitly
		int argumentLength;
		...
		if (this.currentElement != null) {
			...
			if (!(this.currentElement instanceof RecoveredAnnotation)) {
				this.currentToken = 0; // opening brace already taken into
				// account
			} else {
				this.ignoreNextOpeningBrace = true;
				this.currentElement.bracketBalance++;
	...
	protected void consumeEnterVariable() {
		...
		if (variableIndex == 0) {
			...
			if (isLocalDeclaration) {
				...
				type = getTypeReference(typeDim = this.intStack[this.intPtr--]); // type
				// dimension
				if (declaration.declarationSourceStart == -1) {
					// this is true if there is no modifiers for the local
				...
				// Store javadoc only on first declaration as it is the same for
				// all ones
		...
		if (this.currentElement != null) {
			...
			// || declaration.modifiers != 0
					|| (Util.getLineNumber(declaration.type.sourceStart, this.scanner.lineEnds, 0, this.scanner.linePtr) != Util.getLineNumber((int) (namePosition >>> 32), this.scanner.lineEnds, 0,
	...
	protected void consumeEnumBodyNoConstants() {
		// nothing to do
		// The 0 on the astLengthStack has been pushed by
	...
	protected void consumeEnumConstantHeaderName() {
		if (this.currentElement != null) {
			if (!(this.currentElement instanceof RecoveredType || (this.currentElement instanceof RecoveredField && ((RecoveredField) currentElement).fieldDeclaration.type == null))
	...
	protected void consumeEnumConstantWithClassBody() {
		...
		TypeDeclaration anonymousType = (TypeDeclaration) this.astStack[this.astPtr--]; // pop
		// type
		this.astLengthPtr--;
	...
	protected void consumeEnumHeaderName() {
		...
		if (!this.statementRecoveryActivated && options.sourceLevel < ClassFileConstants.JDK1_5 && this.lastErrorEndPositionBeforeRecovery < this.scanner.currentPosition) {
			// TODO this code will be never run while 'enum' is an identifier in
			// 1.3 scanner
	...
	protected void consumeEnumHeaderNameWithTypeParameters() {
		// EnumHeaderNameWithTypeParameters ::= Modifiersopt 'enum' Identifier
		// TypeParameters
		TypeDeclaration enumDeclaration = new TypeDeclaration(this.compilationUnit.compilationResult);
		// consume type parameters
		int length = this.genericsLengthStack[this.genericsLengthPtr--];
	...
	protected void consumeExitVariableWithInitialization() {
		...
		// we need to update the declarationSourceEnd of the local variable
		// declaration to the
	...
	protected void consumeExplicitConstructorInvocation(int flag, int recFlag) {
		...
		/*
		 * flag allows to distinguish 3 cases : (0) :
		 * ExplicitConstructorInvocation ::= 'this' '(' ArgumentListopt ')' ';'
		 * ExplicitConstructorInvocation ::= 'super' '(' ArgumentListopt ')' ';'
		 * (1) : ExplicitConstructorInvocation ::= Primary '.' 'super' '('
		 * ArgumentListopt ')' ';' ExplicitConstructorInvocation ::= Primary '.'
		 * 'this' '(' ArgumentListopt ')' ';' (2) :
		 * ExplicitConstructorInvocation ::= Name '.' 'super' '('
		 * ArgumentListopt ')' ';' ExplicitConstructorInvocation ::= Name '.'
	...
	protected void consumeExplicitConstructorInvocationWithTypeArguments(int flag, int recFlag) {
		 ...
		 * ArgumentListopt ')' ';' ExplicitConstructorInvocation ::=
		 * TypeArguments 'super' '(' ArgumentListopt ')' ';' (1) :
		 * ExplicitConstructorInvocation ::= Primary '.' TypeArguments 'super'
		 * '(' ArgumentListopt ')' ';' ExplicitConstructorInvocation ::= Primary
		 * '.' TypeArguments 'this' '(' ArgumentListopt ')' ';' (2) :
		 * ExplicitConstructorInvocation ::= Name '.' TypeArguments 'super' '('
		 * ArgumentListopt ')' ';' ExplicitConstructorInvocation ::= Name '.'
		 * TypeArguments 'this' '(' ArgumentListopt ')' ';'
		 */
		int startPosition = this.intStack[this.intPtr--];
		ExplicitConstructorCall ecc = new ExplicitConstructorCall(recFlag);
		int length;
	...
	protected void consumeFieldDeclaration() {
		...
		/*
		 * this.astStack : this.expressionStack: Expression Expression ......
		 * Expression this.identifierStack : type identifier identifier ......
		 * identifier this.intStack : typeDim dim dim dim ==> this.astStack :
		 * FieldDeclaration FieldDeclaration ...... FieldDeclaration
		 * this.expressionStack : this.identifierStack : this.intStack :
		 */
		...
		for (int i = variableDeclaratorsCounter - 1; i >= 0; i--) {
			...
			fieldDeclaration.declarationEnd = this.endStatementPosition; // semi-colon
			// included
		}
	...
	protected void consumeFormalParameter(boolean isVarArgs) {
		...
		/*
		 * this.astStack : this.identifierStack : type identifier this.intStack
		 * : dim dim ==> this.astStack : Argument this.identifierStack :
		 * this.intStack :
		 */
		...
		this.intPtr--;
		Argument arg = new Argument(identifierName, namePositions, type, this.intStack[this.intPtr + 1] & ~ClassFileConstants.AccDeprecated); // modifiers
		...
		/*
		 * if incomplete method header, this.listLength counter will not have
		 * been reset, indicating that some arguments are available on the stack
		 */
		this.listLength++;
	...
	protected void consumeInterfaceType() {
		...
		pushOnAstStack(getTypeReference(0));
		/*
		 * if incomplete type header, this.listLength counter will not have been
		 * reset, indicating that some interfaces are available on the stack
		 */
		this.listLength++;
	}
	...
	protected void consumeInvalidConstructorDeclaration() {
		...
		cd.bodyEnd = this.endPosition; // position just before the trailing
		// semi-colon
		cd.declarationSourceEnd = flushCommentsDefinedPriorTo(this.endStatementPosition);
		// report the problem and continue the parsing - narrowing the problem
		// onto the method

		cd.modifiers |= ExtraCompilerModifiers.AccSemicolonBody; // remember
		// semi-colon
		// body
	}
	...
	protected void consumeInvalidConstructorDeclaration(boolean hasBody) {
		 ...
		 * this.identifierStack : name ==> this.astStack : MethodDeclaration
		 * this.identifierStack :
		 */
		if (hasBody) {
			// pop the position of the { (body of the method) pushed in block
			// decl
			this.intPtr--;
		}
	...
	protected void consumeInvalidInterfaceDeclaration() {
		...
		// ExtendsInterfacesopt InterfaceHeader InterfaceBody
		TypeDeclaration typeDecl = (TypeDeclaration) this.astStack[this.astPtr];
		if (!this.statementRecoveryActivated)
			problemReporter().illegalLocalTypeDeclaration(typeDecl);
		// remove the ast node created in interface header
	...
	protected void consumeInvalidMethodDeclaration() {
		...
		/*
		 * this.astStack : modifiers arguments throws statements
		 * this.identifierStack : type name this.intStack : dim dim dim ==>
		 * this.astStack : MethodDeclaration this.identifierStack :
		 * this.intStack :
		 */
	...
	protected void consumeLocalVariableDeclarationStatement() {
		...
		for (int i = variableDeclaratorsCounter - 1; i >= 0; i--) {
			...
			localDeclaration.declarationEnd = this.endStatementPosition; // semi-colon
			// included
		}
	...
	protected void consumeMethodDeclaration(boolean isNotAbstract) {
		...
		// now we know that we have a method declaration at the top of the ast
		// stack
		MethodDeclaration md = (MethodDeclaration) this.astStack[this.astPtr];
		md.statements = statements;
		md.explicitDeclarations = explicitDeclarations;

		// cannot be done in consumeMethodHeader because we have no idea whether
		// or not there
		// is a body when we reduce the method header
		if (!isNotAbstract) { // remember the fact that the method has a
			// semicolon body
	...
	protected void consumeMethodHeaderName(boolean isAnnotationMethod) {
		...
		if (this.currentElement != null) {
			...
			// || md.modifiers != 0
					|| (Util.getLineNumber(md.returnType.sourceStart, this.scanner.lineEnds, 0, this.scanner.linePtr) == Util.getLineNumber(md.sourceStart, this.scanner.lineEnds, 0,
							this.scanner.linePtr))) {
				this.lastCheckPoint = md.bodyStart;
	...
	protected void consumeMethodHeaderRightParen() {
		...
		this.listLength = 0; // reset this.listLength after having read all
		// parameters
		// recovery
		if (this.currentElement != null) {
			this.lastCheckPoint = md.bodyStart;
	...
	protected void consumeMethodInvocationName() {
		...
		// when the name is only an identifier...we have a message send to
		// "this" (implicit)
	...
	protected void consumeMethodInvocationNameWithTypeArguments() {
		// MethodInvocation ::= Name '.' TypeArguments 'Identifier' '('
		// ArgumentListopt ')'
	...
	protected void consumeMethodInvocationSuper() {
		...
		MessageSend m = newMessageSend();
		m.sourceStart = this.intStack[this.intPtr--]; // start position of the
		// super keyword
		m.sourceEnd = this.rParenPos;
	...
	protected void consumeNestedType() {
		...
		if (++this.nestedType >= length) {
			...
			// increase the size of the variablesCounter as well. It has to be
			// consistent with the size of the nestedMethod collection
	...
	protected void consumePackageDeclaration() {
		...
		/*
		 * build an ImportRef build from the last name stored in the identifier
		 * stack.
		 */
	...
	protected void consumePackageDeclarationNameWithModifiers() {
		...
		int packageModifiersSourceStart = this.intStack[this.intPtr--]; // we
		// don't
		// need
		// the
		// modifiers
	...
	protected void consumeQualifiedName() {
		...
		/*
		 * back from the recursive loop of QualifiedName. Updates identifier
		 * length into the length stack
		 */
	...
	protected void consumeRule(int act) {
		...
		case 30:
			if (DEBUG) {
				CompileLog.debug("Type ::= PrimitiveType");} //$NON-NLS-1$
			consumePrimitiveType();
			break;

		case 44:
			if (DEBUG) {
				CompileLog.debug("ReferenceType ::= ClassOrInterfaceType");} //$NON-NLS-1$
			consumeReferenceType();
			break;

		case 48:
			if (DEBUG) {
				CompileLog.debug("ClassOrInterface ::= Name");} //$NON-NLS-1$
			consumeClassOrInterfaceName();
			break;

		case 49:
			if (DEBUG) {
				CompileLog.debug("ClassOrInterface ::= GenericType DOT Name");} //$NON-NLS-1$
			consumeClassOrInterface();
			break;

		case 50:
			if (DEBUG) {
				CompileLog.debug("GenericType ::= ClassOrInterface TypeArguments");} //$NON-NLS-1$
			consumeGenericType();
			break;

		case 51:
			if (DEBUG) {
				CompileLog.debug("ArrayTypeWithTypeArgumentsName ::= GenericType DOT Name");} //$NON-NLS-1$
			consumeArrayTypeWithTypeArgumentsName();
			break;

		case 52:
			if (DEBUG) {
				CompileLog.debug("ArrayType ::= PrimitiveType Dims");} //$NON-NLS-1$
			consumePrimitiveArrayType();
			break;

		case 53:
			if (DEBUG) {
				CompileLog.debug("ArrayType ::= Name Dims");} //$NON-NLS-1$
			consumeNameArrayType();
			break;

		case 54:
			if (DEBUG) {
				CompileLog.debug("ArrayType ::= ArrayTypeWithTypeArgumentsName Dims");} //$NON-NLS-1$
			consumeGenericTypeNameArrayType();
			break;

		case 55:
			if (DEBUG) {
				CompileLog.debug("ArrayType ::= GenericType Dims");} //$NON-NLS-1$
			consumeGenericTypeArrayType();
			break;

		case 60:
			if (DEBUG) {
				CompileLog.debug("QualifiedName ::= Name DOT SimpleName");} //$NON-NLS-1$
			consumeQualifiedName();
			break;

		case 61:
			if (DEBUG) {
				CompileLog.debug("CompilationUnit ::= EnterCompilationUnit...");} //$NON-NLS-1$
			consumeCompilationUnit();
			break;

		case 62:
			if (DEBUG) {
				CompileLog.debug("InternalCompilationUnit ::= PackageDeclaration");} //$NON-NLS-1$
		...
		case 66:
			if (DEBUG) {
				CompileLog.debug("InternalCompilationUnit ::= ImportDeclarations...");} //$NON-NLS-1$
			consumeInternalCompilationUnit();
			break;

		case 67:
			if (DEBUG) {
				CompileLog.debug("InternalCompilationUnit ::= TypeDeclarations");} //$NON-NLS-1$
			consumeInternalCompilationUnitWithTypes();
			break;
		...
		case 69:
			if (DEBUG) {
				CompileLog.debug("InternalCompilationUnit ::=");} //$NON-NLS-1$
			consumeEmptyInternalCompilationUnit();
			break;

		case 70:
			if (DEBUG) {
				CompileLog.debug("ReduceImports ::=");} //$NON-NLS-1$
			consumeReduceImports();
			break;

		case 71:
			if (DEBUG) {
				CompileLog.debug("EnterCompilationUnit ::=");} //$NON-NLS-1$
			consumeEnterCompilationUnit();
			break;

		case 87:
			if (DEBUG) {
				CompileLog.debug("CatchHeader ::= catch LPAREN FormalParameter RPAREN...");} //$NON-NLS-1$
			consumeCatchHeader();
			break;

		case 89:
			if (DEBUG) {
				CompileLog.debug("ImportDeclarations ::= ImportDeclarations...");} //$NON-NLS-1$
			consumeImportDeclarations();
			break;

		case 91:
			if (DEBUG) {
				CompileLog.debug("TypeDeclarations ::= TypeDeclarations TypeDeclaration");} //$NON-NLS-1$
			consumeTypeDeclarations();
			break;

		case 92:
			if (DEBUG) {
				CompileLog.debug("PackageDeclaration ::= PackageDeclarationName SEMICOLON");} //$NON-NLS-1$
			consumePackageDeclaration();
			break;

		case 93:
			if (DEBUG) {
				CompileLog.debug("PackageDeclarationName ::= Modifiers package...");} //$NON-NLS-1$
			consumePackageDeclarationNameWithModifiers();
			break;

		case 94:
			if (DEBUG) {
				CompileLog.debug("PackageDeclarationName ::= PackageComment package Name");} //$NON-NLS-1$
			consumePackageDeclarationName();
			break;

		case 95:
			if (DEBUG) {
				CompileLog.debug("PackageComment ::=");} //$NON-NLS-1$
			consumePackageComment();
			break;

		case 100:
			if (DEBUG) {
				CompileLog.debug("SingleTypeImportDeclaration ::=...");} //$NON-NLS-1$
			consumeImportDeclaration();
			break;

		case 101:
			if (DEBUG) {
				CompileLog.debug("SingleTypeImportDeclarationName ::= import Name");} //$NON-NLS-1$
			consumeSingleTypeImportDeclarationName();
			break;

		case 102:
			if (DEBUG) {
				CompileLog.debug("TypeImportOnDemandDeclaration ::=...");} //$NON-NLS-1$
			consumeImportDeclaration();
			break;

		case 103:
			if (DEBUG) {
				CompileLog.debug("TypeImportOnDemandDeclarationName ::= import Name DOT...");} //$NON-NLS-1$
			consumeTypeImportOnDemandDeclarationName();
			break;

		case 106:
			if (DEBUG) {
				CompileLog.debug("TypeDeclaration ::= SEMICOLON");} //$NON-NLS-1$
			consumeEmptyTypeDeclaration();
			break;

		case 110:
			if (DEBUG) {
				CompileLog.debug("Modifiers ::= Modifiers Modifier");} //$NON-NLS-1$
			consumeModifiers2();
			break;

		case 122:
			if (DEBUG) {
				CompileLog.debug("Modifier ::= Annotation");} //$NON-NLS-1$
			consumeAnnotationAsModifier();
			break;

		case 123:
			if (DEBUG) {
				CompileLog.debug("ClassDeclaration ::= ClassHeader ClassBody");} //$NON-NLS-1$
			consumeClassDeclaration();
			break;

		case 124:
			if (DEBUG) {
				CompileLog.debug("ClassHeader ::= ClassHeaderName ClassHeaderExtendsopt...");} //$NON-NLS-1$
			consumeClassHeader();
			break;

		case 125:
			if (DEBUG) {
				CompileLog.debug("ClassHeaderName ::= ClassHeaderName1 TypeParameters");} //$NON-NLS-1$
			consumeTypeHeaderNameWithTypeParameters();
			break;

		case 127:
			if (DEBUG) {
				CompileLog.debug("ClassHeaderName1 ::= Modifiersopt class Identifier");} //$NON-NLS-1$
			consumeClassHeaderName1();
			break;

		case 128:
			if (DEBUG) {
				CompileLog.debug("ClassHeaderExtends ::= extends ClassType");} //$NON-NLS-1$
			consumeClassHeaderExtends();
			break;

		case 129:
			if (DEBUG) {
				CompileLog.debug("ClassHeaderImplements ::= implements InterfaceTypeList");} //$NON-NLS-1$
			consumeClassHeaderImplements();
			break;

		case 131:
			if (DEBUG) {
				CompileLog.debug("InterfaceTypeList ::= InterfaceTypeList COMMA...");} //$NON-NLS-1$
			consumeInterfaceTypeList();
			break;

		case 132:
			if (DEBUG) {
				CompileLog.debug("InterfaceType ::= ClassOrInterfaceType");} //$NON-NLS-1$
			consumeInterfaceType();
			break;

		case 135:
			if (DEBUG) {
				CompileLog.debug("ClassBodyDeclarations ::= ClassBodyDeclarations...");} //$NON-NLS-1$
			consumeClassBodyDeclarations();
			break;

		case 139:
			if (DEBUG) {
				CompileLog.debug("ClassBodyDeclaration ::= Diet NestedMethod...");} //$NON-NLS-1$
			consumeClassBodyDeclaration();
			break;

		case 140:
			if (DEBUG) {
				CompileLog.debug("Diet ::=");} //$NON-NLS-1$
			consumeDiet();
			break;

		case 141:
			if (DEBUG) {
				CompileLog.debug("Initializer ::= Diet NestedMethod CreateInitializer...");} //$NON-NLS-1$
			consumeClassBodyDeclaration();
			break;

		case 142:
			if (DEBUG) {
				CompileLog.debug("CreateInitializer ::=");} //$NON-NLS-1$
			consumeCreateInitializer();
			break;

		case 149:
			if (DEBUG) {
				CompileLog.debug("ClassMemberDeclaration ::= SEMICOLON");} //$NON-NLS-1$
			consumeEmptyTypeDeclaration();
			break;

		case 152:
			if (DEBUG) {
				CompileLog.debug("FieldDeclaration ::= Modifiersopt Type...");} //$NON-NLS-1$
			consumeFieldDeclaration();
			break;

		case 154:
			if (DEBUG) {
				CompileLog.debug("VariableDeclarators ::= VariableDeclarators COMMA...");} //$NON-NLS-1$
			consumeVariableDeclarators();
			break;

		case 157:
			if (DEBUG) {
				CompileLog.debug("EnterVariable ::=");} //$NON-NLS-1$
			consumeEnterVariable();
			break;

		case 158:
			if (DEBUG) {
				CompileLog.debug("ExitVariableWithInitialization ::=");} //$NON-NLS-1$
			consumeExitVariableWithInitialization();
			break;

		case 159:
			if (DEBUG) {
				CompileLog.debug("ExitVariableWithoutInitialization ::=");} //$NON-NLS-1$
			consumeExitVariableWithoutInitialization();
			break;

		case 160:
			if (DEBUG) {
				CompileLog.debug("ForceNoDiet ::=");} //$NON-NLS-1$
			consumeForceNoDiet();
			break;

		case 161:
			if (DEBUG) {
				CompileLog.debug("RestoreDiet ::=");} //$NON-NLS-1$
			consumeRestoreDiet();
			break;

		case 166:
			if (DEBUG) {
				CompileLog.debug("MethodDeclaration ::= MethodHeader MethodBody");} //$NON-NLS-1$
		...
		case 167:
			if (DEBUG) {
				CompileLog.debug("AbstractMethodDeclaration ::= MethodHeader SEMICOLON");} //$NON-NLS-1$
		...
		case 168:
			if (DEBUG) {
				CompileLog.debug("MethodHeader ::= MethodHeaderName FormalParameterListopt");} //$NON-NLS-1$
			consumeMethodHeader();
			break;

		case 169:
			if (DEBUG) {
				CompileLog.debug("MethodHeaderName ::= Modifiersopt TypeParameters Type...");} //$NON-NLS-1$
			consumeMethodHeaderNameWithTypeParameters(false);
			break;

		case 170:
			if (DEBUG) {
				CompileLog.debug("MethodHeaderName ::= Modifiersopt Type Identifier LPAREN");} //$NON-NLS-1$
			consumeMethodHeaderName(false);
			break;

		case 171:
			if (DEBUG) {
				CompileLog.debug("MethodHeaderRightParen ::= RPAREN");} //$NON-NLS-1$
			consumeMethodHeaderRightParen();
			break;

		case 172:
			if (DEBUG) {
				CompileLog.debug("MethodHeaderExtendedDims ::= Dimsopt");} //$NON-NLS-1$
			consumeMethodHeaderExtendedDims();
			break;

		case 173:
			if (DEBUG) {
				CompileLog.debug("MethodHeaderThrowsClause ::= throws ClassTypeList");} //$NON-NLS-1$
			consumeMethodHeaderThrowsClause();
			break;

		case 174:
			if (DEBUG) {
				CompileLog.debug("ConstructorHeader ::= ConstructorHeaderName...");} //$NON-NLS-1$
			consumeConstructorHeader();
			break;

		case 175:
			if (DEBUG) {
				CompileLog.debug("ConstructorHeaderName ::= Modifiersopt TypeParameters...");} //$NON-NLS-1$
			consumeConstructorHeaderNameWithTypeParameters();
			break;

		case 176:
			if (DEBUG) {
				CompileLog.debug("ConstructorHeaderName ::= Modifiersopt Identifier LPAREN");} //$NON-NLS-1$
			consumeConstructorHeaderName();
			break;

		case 178:
			if (DEBUG) {
				CompileLog.debug("FormalParameterList ::= FormalParameterList COMMA...");} //$NON-NLS-1$
			consumeFormalParameterList();
			break;

		case 179:
			if (DEBUG) {
				CompileLog.debug("FormalParameter ::= Modifiersopt Type...");} //$NON-NLS-1$
			consumeFormalParameter(false);
			break;

		case 180:
			if (DEBUG) {
				CompileLog.debug("FormalParameter ::= Modifiersopt Type ELLIPSIS...");} //$NON-NLS-1$
			consumeFormalParameter(true);
			break;

		case 182:
			if (DEBUG) {
				CompileLog.debug("ClassTypeList ::= ClassTypeList COMMA ClassTypeElt");} //$NON-NLS-1$
			consumeClassTypeList();
			break;

		case 183:
			if (DEBUG) {
				CompileLog.debug("ClassTypeElt ::= ClassType");} //$NON-NLS-1$
			consumeClassTypeElt();
			break;

		case 184:
			if (DEBUG) {
				CompileLog.debug("MethodBody ::= NestedMethod LBRACE BlockStatementsopt...");} //$NON-NLS-1$
			consumeMethodBody();
			break;

		case 185:
			if (DEBUG) {
				CompileLog.debug("NestedMethod ::=");} //$NON-NLS-1$
			consumeNestedMethod();
			break;

		case 186:
			if (DEBUG) {
				CompileLog.debug("StaticInitializer ::= StaticOnly Block");} //$NON-NLS-1$
			consumeStaticInitializer();
			break;

		case 187:
			if (DEBUG) {
				CompileLog.debug("StaticOnly ::= static");} //$NON-NLS-1$
			consumeStaticOnly();
			break;

		case 188:
			if (DEBUG) {
				CompileLog.debug("ConstructorDeclaration ::= ConstructorHeader MethodBody");} //$NON-NLS-1$
			consumeConstructorDeclaration();
			break;

		case 189:
			if (DEBUG) {
				CompileLog.debug("ConstructorDeclaration ::= ConstructorHeader SEMICOLON");} //$NON-NLS-1$
			consumeInvalidConstructorDeclaration();
			break;

		case 190:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= this LPAREN...");} //$NON-NLS-1$
			consumeExplicitConstructorInvocation(0, THIS_CALL);
			break;

		case 191:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= OnlyTypeArguments this");} //$NON-NLS-1$
			consumeExplicitConstructorInvocationWithTypeArguments(0, THIS_CALL);
			break;

		case 192:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= super LPAREN...");} //$NON-NLS-1$
			consumeExplicitConstructorInvocation(0, SUPER_CALL);
			break;

		case 193:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= OnlyTypeArguments...");} //$NON-NLS-1$
			consumeExplicitConstructorInvocationWithTypeArguments(0, SUPER_CALL);
			break;

		case 194:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= Primary DOT super...");} //$NON-NLS-1$
			consumeExplicitConstructorInvocation(1, SUPER_CALL);
			break;

		case 195:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= Primary DOT...");} //$NON-NLS-1$
			consumeExplicitConstructorInvocationWithTypeArguments(1, SUPER_CALL);
			break;

		case 196:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= Name DOT super LPAREN");} //$NON-NLS-1$
			consumeExplicitConstructorInvocation(2, SUPER_CALL);
			break;

		case 197:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= Name DOT...");} //$NON-NLS-1$
			consumeExplicitConstructorInvocationWithTypeArguments(2, SUPER_CALL);
			break;

		case 198:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= Primary DOT this...");} //$NON-NLS-1$
		...
		case 200:
			if (DEBUG) {
				CompileLog.debug("ExplicitConstructorInvocation ::= Name DOT this LPAREN");} //$NON-NLS-1$
		...
		case 202:
			if (DEBUG) {
				CompileLog.debug("InterfaceDeclaration ::= InterfaceHeader InterfaceBody");} //$NON-NLS-1$
			consumeInterfaceDeclaration();
			break;

		case 203:
			if (DEBUG) {
				CompileLog.debug("InterfaceHeader ::= InterfaceHeaderName...");} //$NON-NLS-1$
			consumeInterfaceHeader();
			break;

		case 204:
			if (DEBUG) {
				CompileLog.debug("InterfaceHeaderName ::= InterfaceHeaderName1...");} //$NON-NLS-1$
			consumeTypeHeaderNameWithTypeParameters();
			break;

		case 206:
			if (DEBUG) {
				CompileLog.debug("InterfaceHeaderName1 ::= Modifiersopt interface...");} //$NON-NLS-1$
			consumeInterfaceHeaderName1();
			break;

		case 207:
			if (DEBUG) {
				CompileLog.debug("InterfaceHeaderExtends ::= extends InterfaceTypeList");} //$NON-NLS-1$
			consumeInterfaceHeaderExtends();
			break;

		case 210:
			if (DEBUG) {
				CompileLog.debug("InterfaceMemberDeclarations ::=...");} //$NON-NLS-1$
			consumeInterfaceMemberDeclarations();
			break;

		case 211:
			if (DEBUG) {
				CompileLog.debug("InterfaceMemberDeclaration ::= SEMICOLON");} //$NON-NLS-1$
			consumeEmptyTypeDeclaration();
			break;

		case 213:
			if (DEBUG) {
				CompileLog.debug("InterfaceMemberDeclaration ::= MethodHeader MethodBody");} //$NON-NLS-1$
			consumeInvalidMethodDeclaration();
			break;

		case 214:
			if (DEBUG) {
				CompileLog.debug("InvalidConstructorDeclaration ::= ConstructorHeader...");} //$NON-NLS-1$
		...
		case 223:
			if (DEBUG) {
				CompileLog.debug("PushLeftBrace ::=");} //$NON-NLS-1$
			consumePushLeftBrace();
			break;

		case 224:
			if (DEBUG) {
				CompileLog.debug("ArrayInitializer ::= LBRACE PushLeftBrace ,opt RBRACE");} //$NON-NLS-1$
			consumeEmptyArrayInitializer();
			break;

		case 225:
			if (DEBUG) {
				CompileLog.debug("ArrayInitializer ::= LBRACE PushLeftBrace...");} //$NON-NLS-1$
		...
		case 228:
			if (DEBUG) {
				CompileLog.debug("VariableInitializers ::= VariableInitializers COMMA...");} //$NON-NLS-1$
			consumeVariableInitializers();
			break;

		case 229:
			if (DEBUG) {
				CompileLog.debug("Block ::= OpenBlock LBRACE BlockStatementsopt RBRACE");} //$NON-NLS-1$
			consumeBlock();
			break;

		case 230:
			if (DEBUG) {
				CompileLog.debug("OpenBlock ::=");} //$NON-NLS-1$
			consumeOpenBlock();
			break;

		case 232:
			if (DEBUG) {
				CompileLog.debug("BlockStatements ::= BlockStatements BlockStatement");} //$NON-NLS-1$
			consumeBlockStatements();
			break;

		case 236:
			if (DEBUG) {
				CompileLog.debug("BlockStatement ::= InterfaceDeclaration");} //$NON-NLS-1$
			consumeInvalidInterfaceDeclaration();
			break;

		case 237:
			if (DEBUG) {
				CompileLog.debug("BlockStatement ::= AnnotationTypeDeclaration");} //$NON-NLS-1$
			consumeInvalidAnnotationTypeDeclaration();
			break;

		case 238:
			if (DEBUG) {
				CompileLog.debug("BlockStatement ::= EnumDeclaration");} //$NON-NLS-1$
			consumeInvalidEnumDeclaration();
			break;

		case 239:
			if (DEBUG) {
				CompileLog.debug("LocalVariableDeclarationStatement ::=...");} //$NON-NLS-1$
			consumeLocalVariableDeclarationStatement();
			break;

		case 240:
			if (DEBUG) {
				CompileLog.debug("LocalVariableDeclaration ::= Type PushModifiers...");} //$NON-NLS-1$
			consumeLocalVariableDeclaration();
			break;

		case 241:
			if (DEBUG) {
				CompileLog.debug("LocalVariableDeclaration ::= Modifiers Type...");} //$NON-NLS-1$
			consumeLocalVariableDeclaration();
			break;

		case 242:
			if (DEBUG) {
				CompileLog.debug("PushModifiers ::=");} //$NON-NLS-1$
			consumePushModifiers();
			break;

		case 243:
			if (DEBUG) {
				CompileLog.debug("PushModifiersForHeader ::=");} //$NON-NLS-1$
			consumePushModifiersForHeader();
			break;

		case 244:
			if (DEBUG) {
				CompileLog.debug("PushRealModifiers ::=");} //$NON-NLS-1$
			consumePushRealModifiers();
			break;

		case 270:
			if (DEBUG) {
				CompileLog.debug("EmptyStatement ::= SEMICOLON");} //$NON-NLS-1$
			consumeEmptyStatement();
			break;

		case 271:
			if (DEBUG) {
				CompileLog.debug("LabeledStatement ::= Label COLON Statement");} //$NON-NLS-1$
			consumeStatementLabel();
			break;

		case 272:
			if (DEBUG) {
				CompileLog.debug("LabeledStatementNoShortIf ::= Label COLON...");} //$NON-NLS-1$
			consumeStatementLabel();
			break;

		case 273:
			if (DEBUG) {
				CompileLog.debug("Label ::= Identifier");} //$NON-NLS-1$
			consumeLabel();
			break;

		case 274:
			if (DEBUG) {
				CompileLog.debug("ExpressionStatement ::= StatementExpression SEMICOLON");} //$NON-NLS-1$
			consumeExpressionStatement();
			break;

		case 283:
			if (DEBUG) {
				CompileLog.debug("IfThenStatement ::= if LPAREN Expression RPAREN...");} //$NON-NLS-1$
			consumeStatementIfNoElse();
			break;

		case 284:
			if (DEBUG) {
				CompileLog.debug("IfThenElseStatement ::= if LPAREN Expression RPAREN...");} //$NON-NLS-1$
			consumeStatementIfWithElse();
			break;

		case 285:
			if (DEBUG) {
				CompileLog.debug("IfThenElseStatementNoShortIf ::= if LPAREN Expression...");} //$NON-NLS-1$
			consumeStatementIfWithElse();
			break;

		case 286:
			if (DEBUG) {
				CompileLog.debug("SwitchStatement ::= switch LPAREN Expression RPAREN...");} //$NON-NLS-1$
			consumeStatementSwitch();
			break;

		case 287:
			if (DEBUG) {
				CompileLog.debug("SwitchBlock ::= LBRACE RBRACE");} //$NON-NLS-1$
			consumeEmptySwitchBlock();
			break;

		case 290:
			if (DEBUG) {
				CompileLog.debug("SwitchBlock ::= LBRACE SwitchBlockStatements...");} //$NON-NLS-1$
			consumeSwitchBlock();
			break;

		case 292:
			if (DEBUG) {
				CompileLog.debug("SwitchBlockStatements ::= SwitchBlockStatements...");} //$NON-NLS-1$
			consumeSwitchBlockStatements();
			break;

		case 293:
			if (DEBUG) {
				CompileLog.debug("SwitchBlockStatement ::= SwitchLabels BlockStatements");} //$NON-NLS-1$
			consumeSwitchBlockStatement();
			break;

		case 295:
			if (DEBUG) {
				CompileLog.debug("SwitchLabels ::= SwitchLabels SwitchLabel");} //$NON-NLS-1$
			consumeSwitchLabels();
			break;

		case 296:
			if (DEBUG) {
				CompileLog.debug("SwitchLabel ::= case ConstantExpression COLON");} //$NON-NLS-1$
			consumeCaseLabel();
			break;

		case 297:
			if (DEBUG) {
				CompileLog.debug("SwitchLabel ::= default COLON");} //$NON-NLS-1$
			consumeDefaultLabel();
			break;

		case 298:
			if (DEBUG) {
				CompileLog.debug("WhileStatement ::= while LPAREN Expression RPAREN...");} //$NON-NLS-1$
			consumeStatementWhile();
			break;

		case 299:
			if (DEBUG) {
				CompileLog.debug("WhileStatementNoShortIf ::= while LPAREN Expression...");} //$NON-NLS-1$
			consumeStatementWhile();
			break;

		case 300:
			if (DEBUG) {
				CompileLog.debug("DoStatement ::= do Statement while LPAREN Expression...");} //$NON-NLS-1$
			consumeStatementDo();
			break;

		case 301:
			if (DEBUG) {
				CompileLog.debug("ForStatement ::= for LPAREN ForInitopt SEMICOLON...");} //$NON-NLS-1$
			consumeStatementFor();
			break;

		case 302:
			if (DEBUG) {
				CompileLog.debug("ForStatementNoShortIf ::= for LPAREN ForInitopt...");} //$NON-NLS-1$
			consumeStatementFor();
			break;

		case 303:
			if (DEBUG) {
				CompileLog.debug("ForInit ::= StatementExpressionList");} //$NON-NLS-1$
			consumeForInit();
			break;

		case 307:
			if (DEBUG) {
				CompileLog.debug("StatementExpressionList ::= StatementExpressionList...");} //$NON-NLS-1$
			consumeStatementExpressionList();
			break;

		case 308:
			if (DEBUG) {
				CompileLog.debug("AssertStatement ::= assert Expression SEMICOLON");} //$NON-NLS-1$
			consumeSimpleAssertStatement();
			break;

		case 309:
			if (DEBUG) {
				CompileLog.debug("AssertStatement ::= assert Expression COLON Expression");} //$NON-NLS-1$
			consumeAssertStatement();
			break;

		case 310:
			if (DEBUG) {
				CompileLog.debug("BreakStatement ::= break SEMICOLON");} //$NON-NLS-1$
			consumeStatementBreak();
			break;

		case 311:
			if (DEBUG) {
				CompileLog.debug("BreakStatement ::= break Identifier SEMICOLON");} //$NON-NLS-1$
			consumeStatementBreakWithLabel();
			break;

		case 312:
			if (DEBUG) {
				CompileLog.debug("ContinueStatement ::= continue SEMICOLON");} //$NON-NLS-1$
			consumeStatementContinue();
			break;

		case 313:
			if (DEBUG) {
				CompileLog.debug("ContinueStatement ::= continue Identifier SEMICOLON");} //$NON-NLS-1$
			consumeStatementContinueWithLabel();
			break;

		case 314:
			if (DEBUG) {
				CompileLog.debug("ReturnStatement ::= return Expressionopt SEMICOLON");} //$NON-NLS-1$
			consumeStatementReturn();
			break;

		case 315:
			if (DEBUG) {
				CompileLog.debug("ThrowStatement ::= throw Expression SEMICOLON");} //$NON-NLS-1$
			consumeStatementThrow();
			break;

		case 316:
			if (DEBUG) {
				CompileLog.debug("SynchronizedStatement ::= OnlySynchronized LPAREN...");} //$NON-NLS-1$
			consumeStatementSynchronized();
			break;

		case 317:
			if (DEBUG) {
				CompileLog.debug("OnlySynchronized ::= synchronized");} //$NON-NLS-1$
			consumeOnlySynchronized();
			break;

		case 318:
			if (DEBUG) {
				CompileLog.debug("TryStatement ::= try TryBlock Catches");} //$NON-NLS-1$
			consumeStatementTry(false);
			break;

		case 319:
			if (DEBUG) {
				CompileLog.debug("TryStatement ::= try TryBlock Catchesopt Finally");} //$NON-NLS-1$
			consumeStatementTry(true);
			break;

		case 321:
			if (DEBUG) {
				CompileLog.debug("ExitTryBlock ::=");} //$NON-NLS-1$
			consumeExitTryBlock();
			break;

		case 323:
			if (DEBUG) {
				CompileLog.debug("Catches ::= Catches CatchClause");} //$NON-NLS-1$
			consumeCatches();
			break;

		case 324:
			if (DEBUG) {
				CompileLog.debug("CatchClause ::= catch LPAREN FormalParameter RPAREN...");} //$NON-NLS-1$
			consumeStatementCatch();
			break;

		case 326:
			if (DEBUG) {
				CompileLog.debug("PushLPAREN ::= LPAREN");} //$NON-NLS-1$
			consumeLeftParen();
			break;

		case 327:
			if (DEBUG) {
				CompileLog.debug("PushRPAREN ::= RPAREN");} //$NON-NLS-1$
			consumeRightParen();
			break;

		case 332:
			if (DEBUG) {
				CompileLog.debug("PrimaryNoNewArray ::= this");} //$NON-NLS-1$
			consumePrimaryNoNewArrayThis();
			break;

		case 333:
			if (DEBUG) {
				CompileLog.debug("PrimaryNoNewArray ::= PushLPAREN Expression_NotName...");} //$NON-NLS-1$
			consumePrimaryNoNewArray();
			break;

		case 334:
			if (DEBUG) {
				CompileLog.debug("PrimaryNoNewArray ::= PushLPAREN Name PushRPAREN");} //$NON-NLS-1$
			consumePrimaryNoNewArrayWithName();
			break;

		case 337:
			if (DEBUG) {
				CompileLog.debug("PrimaryNoNewArray ::= Name DOT this");} //$NON-NLS-1$
			consumePrimaryNoNewArrayNameThis();
			break;

		case 338:
			if (DEBUG) {
				CompileLog.debug("PrimaryNoNewArray ::= Name DOT super");} //$NON-NLS-1$
			consumePrimaryNoNewArrayNameSuper();
			break;

		case 339:
			if (DEBUG) {
				CompileLog.debug("PrimaryNoNewArray ::= Name DOT class");} //$NON-NLS-1$
			consumePrimaryNoNewArrayName();
			break;

		case 340:
			if (DEBUG) {
				CompileLog.debug("PrimaryNoNewArray ::= Name Dims DOT class");} //$NON-NLS-1$
			consumePrimaryNoNewArrayArrayType();
			break;

		case 341:
			if (DEBUG) {
				CompileLog.debug("PrimaryNoNewArray ::= PrimitiveType Dims DOT class");} //$NON-NLS-1$
			consumePrimaryNoNewArrayPrimitiveArrayType();
			break;

		case 342:
			if (DEBUG) {
				CompileLog.debug("PrimaryNoNewArray ::= PrimitiveType DOT class");} //$NON-NLS-1$
			consumePrimaryNoNewArrayPrimitiveType();
			break;

		case 345:
			if (DEBUG) {
				CompileLog.debug("AllocationHeader ::= new ClassType LPAREN...");} //$NON-NLS-1$
			consumeAllocationHeader();
			break;

		case 346:
			if (DEBUG) {
				CompileLog.debug("ClassInstanceCreationExpression ::= new...");} //$NON-NLS-1$
			consumeClassInstanceCreationExpressionWithTypeArguments();
			break;

		case 347:
			if (DEBUG) {
				CompileLog.debug("ClassInstanceCreationExpression ::= new ClassType LPAREN");} //$NON-NLS-1$
			consumeClassInstanceCreationExpression();
			break;

		case 348:
			if (DEBUG) {
				CompileLog.debug("ClassInstanceCreationExpression ::= Primary DOT new...");} //$NON-NLS-1$
		...
		case 350:
			if (DEBUG) {
				CompileLog.debug("ClassInstanceCreationExpression ::=...");} //$NON-NLS-1$
			consumeClassInstanceCreationExpressionQualified();
			break;
		...
		case 352:
			if (DEBUG) {
				CompileLog.debug("ClassInstanceCreationExpressionName ::= Name DOT");} //$NON-NLS-1$
			consumeClassInstanceCreationExpressionName();
			break;

		case 353:
			if (DEBUG) {
				CompileLog.debug("ClassBodyopt ::=");} //$NON-NLS-1$
			consumeClassBodyopt();
			break;

		case 355:
			if (DEBUG) {
				CompileLog.debug("EnterAnonymousClassBody ::=");} //$NON-NLS-1$
			consumeEnterAnonymousClassBody();
			break;

		case 357:
			if (DEBUG) {
				CompileLog.debug("ArgumentList ::= ArgumentList COMMA Expression");} //$NON-NLS-1$
			consumeArgumentList();
			break;

		case 358:
			if (DEBUG) {
				CompileLog.debug("ArrayCreationHeader ::= new PrimitiveType...");} //$NON-NLS-1$
			consumeArrayCreationHeader();
			break;

		case 359:
			if (DEBUG) {
				CompileLog.debug("ArrayCreationHeader ::= new ClassOrInterfaceType...");} //$NON-NLS-1$
			consumeArrayCreationHeader();
			break;

		case 360:
			if (DEBUG) {
				CompileLog.debug("ArrayCreationWithoutArrayInitializer ::= new...");} //$NON-NLS-1$
			consumeArrayCreationExpressionWithoutInitializer();
			break;

		case 361:
			if (DEBUG) {
				CompileLog.debug("ArrayCreationWithArrayInitializer ::= new PrimitiveType");} //$NON-NLS-1$
		...
		case 363:
			if (DEBUG) {
				CompileLog.debug("ArrayCreationWithArrayInitializer ::= new...");} //$NON-NLS-1$
			consumeArrayCreationExpressionWithInitializer();
			break;

		case 365:
			if (DEBUG) {
				CompileLog.debug("DimWithOrWithOutExprs ::= DimWithOrWithOutExprs...");} //$NON-NLS-1$
			consumeDimWithOrWithOutExprs();
			break;

		case 367:
			if (DEBUG) {
				CompileLog.debug("DimWithOrWithOutExpr ::= LBRACKET RBRACKET");} //$NON-NLS-1$
			consumeDimWithOrWithOutExpr();
			break;

		case 368:
			if (DEBUG) {
				CompileLog.debug("Dims ::= DimsLoop");} //$NON-NLS-1$
			consumeDims();
			break;

		case 371:
			if (DEBUG) {
				CompileLog.debug("OneDimLoop ::= LBRACKET RBRACKET");} //$NON-NLS-1$
			consumeOneDimLoop();
			break;

		case 372:
			if (DEBUG) {
				CompileLog.debug("FieldAccess ::= Primary DOT Identifier");} //$NON-NLS-1$
			consumeFieldAccess(false);
			break;

		case 373:
			if (DEBUG) {
				CompileLog.debug("FieldAccess ::= super DOT Identifier");} //$NON-NLS-1$
			consumeFieldAccess(true);
			break;

		case 374:
			if (DEBUG) {
				CompileLog.debug("MethodInvocation ::= Name LPAREN ArgumentListopt RPAREN");} //$NON-NLS-1$
			consumeMethodInvocationName();
			break;

		case 375:
			if (DEBUG) {
				CompileLog.debug("MethodInvocation ::= Name DOT OnlyTypeArguments...");} //$NON-NLS-1$
			consumeMethodInvocationNameWithTypeArguments();
			break;

		case 376:
			if (DEBUG) {
				CompileLog.debug("MethodInvocation ::= Primary DOT OnlyTypeArguments...");} //$NON-NLS-1$
			consumeMethodInvocationPrimaryWithTypeArguments();
			break;

		case 377:
			if (DEBUG) {
				CompileLog.debug("MethodInvocation ::= Primary DOT Identifier LPAREN...");} //$NON-NLS-1$
			consumeMethodInvocationPrimary();
			break;

		case 378:
			if (DEBUG) {
				CompileLog.debug("MethodInvocation ::= super DOT OnlyTypeArguments...");} //$NON-NLS-1$
			consumeMethodInvocationSuperWithTypeArguments();
			break;

		case 379:
			if (DEBUG) {
				CompileLog.debug("MethodInvocation ::= super DOT Identifier LPAREN...");} //$NON-NLS-1$
			consumeMethodInvocationSuper();
			break;

		case 380:
			if (DEBUG) {
				CompileLog.debug("ArrayAccess ::= Name LBRACKET Expression RBRACKET");} //$NON-NLS-1$
			consumeArrayAccess(true);
			break;

		case 381:
			if (DEBUG) {
				CompileLog.debug("ArrayAccess ::= PrimaryNoNewArray LBRACKET Expression...");} //$NON-NLS-1$
			consumeArrayAccess(false);
			break;

		case 382:
			if (DEBUG) {
				CompileLog.debug("ArrayAccess ::= ArrayCreationWithArrayInitializer...");} //$NON-NLS-1$
			consumeArrayAccess(false);
			break;

		case 384:
			if (DEBUG) {
				CompileLog.debug("PostfixExpression ::= Name");} //$NON-NLS-1$
			consumePostfixExpression();
			break;

		case 387:
			if (DEBUG) {
				CompileLog.debug("PostIncrementExpression ::= PostfixExpression PLUS_PLUS");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.PLUS, true);
			break;

		case 388:
			if (DEBUG) {
				CompileLog.debug("PostDecrementExpression ::= PostfixExpression...");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.MINUS, true);
			break;

		case 389:
			if (DEBUG) {
				CompileLog.debug("PushPosition ::=");} //$NON-NLS-1$
			consumePushPosition();
			break;

		case 392:
			if (DEBUG) {
				CompileLog.debug("UnaryExpression ::= PLUS PushPosition UnaryExpression");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.PLUS);
			break;

		case 393:
			if (DEBUG) {
				CompileLog.debug("UnaryExpression ::= MINUS PushPosition UnaryExpression");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.MINUS);
			break;

		case 395:
			if (DEBUG) {
				CompileLog.debug("PreIncrementExpression ::= PLUS_PLUS PushPosition...");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.PLUS, false);
			break;

		case 396:
			if (DEBUG) {
				CompileLog.debug("PreDecrementExpression ::= MINUS_MINUS PushPosition...");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.MINUS, false);
			break;

		case 398:
			if (DEBUG) {
				CompileLog.debug("UnaryExpressionNotPlusMinus ::= TWIDDLE PushPosition...");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.TWIDDLE);
			break;

		case 399:
			if (DEBUG) {
				CompileLog.debug("UnaryExpressionNotPlusMinus ::= NOT PushPosition...");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.NOT);
			break;

		case 401:
			if (DEBUG) {
				CompileLog.debug("CastExpression ::= PushLPAREN PrimitiveType Dimsopt...");} //$NON-NLS-1$
			consumeCastExpressionWithPrimitiveType();
			break;

		case 402:
			if (DEBUG) {
				CompileLog.debug("CastExpression ::= PushLPAREN Name...");} //$NON-NLS-1$
		...
		case 404:
			if (DEBUG) {
				CompileLog.debug("CastExpression ::= PushLPAREN Name PushRPAREN...");} //$NON-NLS-1$
			consumeCastExpressionLL1();
			break;

		case 405:
			if (DEBUG) {
				CompileLog.debug("CastExpression ::= PushLPAREN Name Dims PushRPAREN...");} //$NON-NLS-1$
			consumeCastExpressionWithNameArray();
			break;

		case 406:
			if (DEBUG) {
				CompileLog.debug("OnlyTypeArgumentsForCastExpression ::= OnlyTypeArguments");} //$NON-NLS-1$
			consumeOnlyTypeArgumentsForCastExpression();
			break;

		case 407:
			if (DEBUG) {
				CompileLog.debug("InsideCastExpression ::=");} //$NON-NLS-1$
			consumeInsideCastExpression();
			break;

		case 408:
			if (DEBUG) {
				CompileLog.debug("InsideCastExpressionLL1 ::=");} //$NON-NLS-1$
			consumeInsideCastExpressionLL1();
			break;

		case 409:
			if (DEBUG) {
				CompileLog.debug("InsideCastExpressionWithQualifiedGenerics ::=");} //$NON-NLS-1$
			consumeInsideCastExpressionWithQualifiedGenerics();
			break;

		case 411:
			if (DEBUG) {
				CompileLog.debug("MultiplicativeExpression ::= MultiplicativeExpression...");} //$NON-NLS-1$
		...
		case 415:
			if (DEBUG) {
				CompileLog.debug("AdditiveExpression ::= AdditiveExpression PLUS...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.PLUS);
			break;

		case 416:
			if (DEBUG) {
				CompileLog.debug("AdditiveExpression ::= AdditiveExpression MINUS...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.MINUS);
			break;

		case 418:
			if (DEBUG) {
				CompileLog.debug("ShiftExpression ::= ShiftExpression LEFT_SHIFT...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.LEFT_SHIFT);
			break;

		case 419:
			if (DEBUG) {
				CompileLog.debug("ShiftExpression ::= ShiftExpression RIGHT_SHIFT...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.RIGHT_SHIFT);
			break;

		case 420:
			if (DEBUG) {
				CompileLog.debug("ShiftExpression ::= ShiftExpression UNSIGNED_RIGHT_SHIFT");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.UNSIGNED_RIGHT_SHIFT);
			break;

		case 422:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression ::= RelationalExpression LESS...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.LESS);
			break;

		case 423:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression ::= RelationalExpression GREATER...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.GREATER);
			break;

		case 424:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression ::= RelationalExpression LESS_EQUAL");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.LESS_EQUAL);
			break;

		case 425:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression ::= RelationalExpression...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.GREATER_EQUAL);
			break;

		case 427:
			if (DEBUG) {
				CompileLog.debug("InstanceofExpression ::= InstanceofExpression instanceof");} //$NON-NLS-1$
			consumeInstanceOfExpression();
			break;

		case 429:
			if (DEBUG) {
				CompileLog.debug("EqualityExpression ::= EqualityExpression EQUAL_EQUAL...");} //$NON-NLS-1$
			consumeEqualityExpression(OperatorIds.EQUAL_EQUAL);
			break;

		case 430:
			if (DEBUG) {
				CompileLog.debug("EqualityExpression ::= EqualityExpression NOT_EQUAL...");} //$NON-NLS-1$
			consumeEqualityExpression(OperatorIds.NOT_EQUAL);
			break;

		case 432:
			if (DEBUG) {
				CompileLog.debug("AndExpression ::= AndExpression AND EqualityExpression");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.AND);
			break;

		case 434:
			if (DEBUG) {
				CompileLog.debug("ExclusiveOrExpression ::= ExclusiveOrExpression XOR...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.XOR);
			break;

		case 436:
			if (DEBUG) {
				CompileLog.debug("InclusiveOrExpression ::= InclusiveOrExpression OR...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.OR);
			break;

		case 438:
			if (DEBUG) {
				CompileLog.debug("ConditionalAndExpression ::= ConditionalAndExpression...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.AND_AND);
			break;

		case 440:
			if (DEBUG) {
				CompileLog.debug("ConditionalOrExpression ::= ConditionalOrExpression...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.OR_OR);
			break;

		case 442:
			if (DEBUG) {
				CompileLog.debug("ConditionalExpression ::= ConditionalOrExpression...");} //$NON-NLS-1$
			consumeConditionalExpression(OperatorIds.QUESTIONCOLON);
			break;

		case 445:
			if (DEBUG) {
				CompileLog.debug("Assignment ::= PostfixExpression AssignmentOperator...");} //$NON-NLS-1$
			consumeAssignment();
			break;

		case 447:
			if (DEBUG) {
				CompileLog.debug("Assignment ::= InvalidArrayInitializerAssignement");} //$NON-NLS-1$
			ignoreExpressionAssignment();
			break;

		case 448:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(EQUAL);
			break;

		case 449:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= MULTIPLY_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(MULTIPLY);
			break;

		case 450:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= DIVIDE_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(DIVIDE);
			break;

		case 451:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= REMAINDER_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(REMAINDER);
			break;

		case 452:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= PLUS_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(PLUS);
			break;

		case 453:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= MINUS_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(MINUS);
			break;

		case 454:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= LEFT_SHIFT_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(LEFT_SHIFT);
			break;

		case 455:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= RIGHT_SHIFT_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(RIGHT_SHIFT);
			break;

		case 456:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= UNSIGNED_RIGHT_SHIFT_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(UNSIGNED_RIGHT_SHIFT);
			break;

		case 457:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= AND_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(AND);
			break;

		case 458:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= XOR_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(XOR);
			break;

		case 459:
			if (DEBUG) {
				CompileLog.debug("AssignmentOperator ::= OR_EQUAL");} //$NON-NLS-1$
			consumeAssignmentOperator(OR);
			break;

		case 463:
			if (DEBUG) {
				CompileLog.debug("Expressionopt ::=");} //$NON-NLS-1$
			consumeEmptyExpression();
			break;

		case 468:
			if (DEBUG) {
				CompileLog.debug("ClassBodyDeclarationsopt ::=");} //$NON-NLS-1$
			consumeEmptyClassBodyDeclarationsopt();
			break;

		case 469:
			if (DEBUG) {
				CompileLog.debug("ClassBodyDeclarationsopt ::= NestedType...");} //$NON-NLS-1$
			consumeClassBodyDeclarationsopt();
			break;

		case 470:
			if (DEBUG) {
				CompileLog.debug("Modifiersopt ::=");} //$NON-NLS-1$
			consumeDefaultModifiers();
			break;

		case 471:
			if (DEBUG) {
				CompileLog.debug("Modifiersopt ::= Modifiers");} //$NON-NLS-1$
			consumeModifiers();
			break;

		case 472:
			if (DEBUG) {
				CompileLog.debug("BlockStatementsopt ::=");} //$NON-NLS-1$
			consumeEmptyBlockStatementsopt();
			break;

		case 474:
			if (DEBUG) {
				CompileLog.debug("Dimsopt ::=");} //$NON-NLS-1$
			consumeEmptyDimsopt();
			break;

		case 476:
			if (DEBUG) {
				CompileLog.debug("ArgumentListopt ::=");} //$NON-NLS-1$
			consumeEmptyArgumentListopt();
			break;

		case 480:
			if (DEBUG) {
				CompileLog.debug("FormalParameterListopt ::=");} //$NON-NLS-1$
			consumeFormalParameterListopt();
			break;

		case 484:
			if (DEBUG) {
				CompileLog.debug("InterfaceMemberDeclarationsopt ::=");} //$NON-NLS-1$
			consumeEmptyInterfaceMemberDeclarationsopt();
			break;

		case 485:
			if (DEBUG) {
				CompileLog.debug("InterfaceMemberDeclarationsopt ::= NestedType...");} //$NON-NLS-1$
			consumeInterfaceMemberDeclarationsopt();
			break;

		case 486:
			if (DEBUG) {
				CompileLog.debug("NestedType ::=");} //$NON-NLS-1$
			consumeNestedType();
			break;

		case 487:
			if (DEBUG) {
				CompileLog.debug("ForInitopt ::=");} //$NON-NLS-1$
			consumeEmptyForInitopt();
			break;

		case 489:
			if (DEBUG) {
				CompileLog.debug("ForUpdateopt ::=");} //$NON-NLS-1$
			consumeEmptyForUpdateopt();
			break;

		case 493:
			if (DEBUG) {
				CompileLog.debug("Catchesopt ::=");} //$NON-NLS-1$
			consumeEmptyCatchesopt();
			break;

		case 495:
			if (DEBUG) {
				CompileLog.debug("EnumDeclaration ::= EnumHeader EnumBody");} //$NON-NLS-1$
			consumeEnumDeclaration();
			break;

		case 496:
			if (DEBUG) {
				CompileLog.debug("EnumHeader ::= EnumHeaderName ClassHeaderImplementsopt");} //$NON-NLS-1$
			consumeEnumHeader();
			break;

		case 497:
			if (DEBUG) {
				CompileLog.debug("EnumHeaderName ::= Modifiersopt enum Identifier");} //$NON-NLS-1$
		...
		case 499:
			if (DEBUG) {
				CompileLog.debug("EnumBody ::= LBRACE EnumBodyDeclarationsopt RBRACE");} //$NON-NLS-1$
			consumeEnumBodyNoConstants();
			break;

		case 500:
			if (DEBUG) {
				CompileLog.debug("EnumBody ::= LBRACE COMMA EnumBodyDeclarationsopt...");} //$NON-NLS-1$
			consumeEnumBodyNoConstants();
			break;

		case 501:
			if (DEBUG) {
				CompileLog.debug("EnumBody ::= LBRACE EnumConstants COMMA...");} //$NON-NLS-1$
			consumeEnumBodyWithConstants();
			break;

		case 502:
			if (DEBUG) {
				CompileLog.debug("EnumBody ::= LBRACE EnumConstants...");} //$NON-NLS-1$
			consumeEnumBodyWithConstants();
			break;

		case 504:
			if (DEBUG) {
				CompileLog.debug("EnumConstants ::= EnumConstants COMMA EnumConstant");} //$NON-NLS-1$
			consumeEnumConstants();
			break;

		case 505:
			if (DEBUG) {
				CompileLog.debug("EnumConstantHeaderName ::= Modifiersopt Identifier");} //$NON-NLS-1$
			consumeEnumConstantHeaderName();
			break;

		case 506:
			if (DEBUG) {
				CompileLog.debug("EnumConstantHeader ::= EnumConstantHeaderName...");} //$NON-NLS-1$
			consumeEnumConstantHeader();
			break;

		case 507:
			if (DEBUG) {
				CompileLog.debug("EnumConstant ::= EnumConstantHeader ForceNoDiet...");} //$NON-NLS-1$
			consumeEnumConstantWithClassBody();
			break;

		case 508:
			if (DEBUG) {
				CompileLog.debug("EnumConstant ::= EnumConstantHeader");} //$NON-NLS-1$
			consumeEnumConstantNoClassBody();
			break;

		case 509:
			if (DEBUG) {
				CompileLog.debug("Arguments ::= LPAREN ArgumentListopt RPAREN");} //$NON-NLS-1$
			consumeArguments();
			break;

		case 510:
			if (DEBUG) {
				CompileLog.debug("Argumentsopt ::=");} //$NON-NLS-1$
			consumeEmptyArguments();
			break;

		case 512:
			if (DEBUG) {
				CompileLog.debug("EnumDeclarations ::= SEMICOLON ClassBodyDeclarationsopt");} //$NON-NLS-1$
			consumeEnumDeclarations();
			break;

		case 513:
			if (DEBUG) {
				CompileLog.debug("EnumBodyDeclarationsopt ::=");} //$NON-NLS-1$
			consumeEmptyEnumDeclarations();
			break;

		case 515:
			if (DEBUG) {
				CompileLog.debug("EnhancedForStatement ::= EnhancedForStatementHeader...");} //$NON-NLS-1$
			consumeEnhancedForStatement();
			break;

		case 516:
			if (DEBUG) {
				CompileLog.debug("EnhancedForStatementNoShortIf ::=...");} //$NON-NLS-1$
			consumeEnhancedForStatement();
			break;

		case 517:
			if (DEBUG) {
				CompileLog.debug("EnhancedForStatementHeaderInit ::= for LPAREN Type...");} //$NON-NLS-1$
			consumeEnhancedForStatementHeaderInit(false);
			break;

		case 518:
			if (DEBUG) {
				CompileLog.debug("EnhancedForStatementHeaderInit ::= for LPAREN Modifiers");} //$NON-NLS-1$
			consumeEnhancedForStatementHeaderInit(true);
			break;

		case 519:
			if (DEBUG) {
				CompileLog.debug("EnhancedForStatementHeader ::=...");} //$NON-NLS-1$
			consumeEnhancedForStatementHeader();
			break;

		case 520:
			if (DEBUG) {
				CompileLog.debug("SingleStaticImportDeclaration ::=...");} //$NON-NLS-1$
			consumeImportDeclaration();
			break;

		case 521:
			if (DEBUG) {
				CompileLog.debug("SingleStaticImportDeclarationName ::= import static Name");} //$NON-NLS-1$
			consumeSingleStaticImportDeclarationName();
			break;

		case 522:
			if (DEBUG) {
				CompileLog.debug("StaticImportOnDemandDeclaration ::=...");} //$NON-NLS-1$
			consumeImportDeclaration();
			break;

		case 523:
			if (DEBUG) {
				CompileLog.debug("StaticImportOnDemandDeclarationName ::= import static...");} //$NON-NLS-1$
			consumeStaticImportOnDemandDeclarationName();
			break;

		case 524:
			if (DEBUG) {
				CompileLog.debug("TypeArguments ::= LESS TypeArgumentList1");} //$NON-NLS-1$
			consumeTypeArguments();
			break;

		case 525:
			if (DEBUG) {
				CompileLog.debug("OnlyTypeArguments ::= LESS TypeArgumentList1");} //$NON-NLS-1$
			consumeOnlyTypeArguments();
			break;

		case 527:
			if (DEBUG) {
				CompileLog.debug("TypeArgumentList1 ::= TypeArgumentList COMMA...");} //$NON-NLS-1$
			consumeTypeArgumentList1();
			break;

		case 529:
			if (DEBUG) {
				CompileLog.debug("TypeArgumentList ::= TypeArgumentList COMMA TypeArgument");} //$NON-NLS-1$
			consumeTypeArgumentList();
			break;

		case 530:
			if (DEBUG) {
				CompileLog.debug("TypeArgument ::= ReferenceType");} //$NON-NLS-1$
			consumeTypeArgument();
			break;

		case 534:
			if (DEBUG) {
				CompileLog.debug("ReferenceType1 ::= ReferenceType GREATER");} //$NON-NLS-1$
			consumeReferenceType1();
			break;

		case 535:
			if (DEBUG) {
				CompileLog.debug("ReferenceType1 ::= ClassOrInterface LESS...");} //$NON-NLS-1$
			consumeTypeArgumentReferenceType1();
			break;

		case 537:
			if (DEBUG) {
				CompileLog.debug("TypeArgumentList2 ::= TypeArgumentList COMMA...");} //$NON-NLS-1$
			consumeTypeArgumentList2();
			break;

		case 540:
			if (DEBUG) {
				CompileLog.debug("ReferenceType2 ::= ReferenceType RIGHT_SHIFT");} //$NON-NLS-1$
			consumeReferenceType2();
			break;

		case 541:
			if (DEBUG) {
				CompileLog.debug("ReferenceType2 ::= ClassOrInterface LESS...");} //$NON-NLS-1$
			consumeTypeArgumentReferenceType2();
			break;

		case 543:
			if (DEBUG) {
				CompileLog.debug("TypeArgumentList3 ::= TypeArgumentList COMMA...");} //$NON-NLS-1$
			consumeTypeArgumentList3();
			break;

		case 546:
			if (DEBUG) {
				CompileLog.debug("ReferenceType3 ::= ReferenceType UNSIGNED_RIGHT_SHIFT");} //$NON-NLS-1$
			consumeReferenceType3();
			break;

		case 547:
			if (DEBUG) {
				CompileLog.debug("Wildcard ::= QUESTION");} //$NON-NLS-1$
			consumeWildcard();
			break;

		case 548:
			if (DEBUG) {
				CompileLog.debug("Wildcard ::= QUESTION WildcardBounds");} //$NON-NLS-1$
			consumeWildcardWithBounds();
			break;

		case 549:
			if (DEBUG) {
				CompileLog.debug("WildcardBounds ::= extends ReferenceType");} //$NON-NLS-1$
			consumeWildcardBoundsExtends();
			break;

		case 550:
			if (DEBUG) {
				CompileLog.debug("WildcardBounds ::= super ReferenceType");} //$NON-NLS-1$
			consumeWildcardBoundsSuper();
			break;

		case 551:
			if (DEBUG) {
				CompileLog.debug("Wildcard1 ::= QUESTION GREATER");} //$NON-NLS-1$
			consumeWildcard1();
			break;

		case 552:
			if (DEBUG) {
				CompileLog.debug("Wildcard1 ::= QUESTION WildcardBounds1");} //$NON-NLS-1$
			consumeWildcard1WithBounds();
			break;

		case 553:
			if (DEBUG) {
				CompileLog.debug("WildcardBounds1 ::= extends ReferenceType1");} //$NON-NLS-1$
			consumeWildcardBounds1Extends();
			break;

		case 554:
			if (DEBUG) {
				CompileLog.debug("WildcardBounds1 ::= super ReferenceType1");} //$NON-NLS-1$
			consumeWildcardBounds1Super();
			break;

		case 555:
			if (DEBUG) {
				CompileLog.debug("Wildcard2 ::= QUESTION RIGHT_SHIFT");} //$NON-NLS-1$
			consumeWildcard2();
			break;

		case 556:
			if (DEBUG) {
				CompileLog.debug("Wildcard2 ::= QUESTION WildcardBounds2");} //$NON-NLS-1$
			consumeWildcard2WithBounds();
			break;

		case 557:
			if (DEBUG) {
				CompileLog.debug("WildcardBounds2 ::= extends ReferenceType2");} //$NON-NLS-1$
			consumeWildcardBounds2Extends();
			break;

		case 558:
			if (DEBUG) {
				CompileLog.debug("WildcardBounds2 ::= super ReferenceType2");} //$NON-NLS-1$
			consumeWildcardBounds2Super();
			break;

		case 559:
			if (DEBUG) {
				CompileLog.debug("Wildcard3 ::= QUESTION UNSIGNED_RIGHT_SHIFT");} //$NON-NLS-1$
			consumeWildcard3();
			break;

		case 560:
			if (DEBUG) {
				CompileLog.debug("Wildcard3 ::= QUESTION WildcardBounds3");} //$NON-NLS-1$
			consumeWildcard3WithBounds();
			break;

		case 561:
			if (DEBUG) {
				CompileLog.debug("WildcardBounds3 ::= extends ReferenceType3");} //$NON-NLS-1$
			consumeWildcardBounds3Extends();
			break;

		case 562:
			if (DEBUG) {
				CompileLog.debug("WildcardBounds3 ::= super ReferenceType3");} //$NON-NLS-1$
			consumeWildcardBounds3Super();
			break;

		case 563:
			if (DEBUG) {
				CompileLog.debug("TypeParameterHeader ::= Identifier");} //$NON-NLS-1$
			consumeTypeParameterHeader();
			break;

		case 564:
			if (DEBUG) {
				CompileLog.debug("TypeParameters ::= LESS TypeParameterList1");} //$NON-NLS-1$
			consumeTypeParameters();
			break;

		case 566:
			if (DEBUG) {
				CompileLog.debug("TypeParameterList ::= TypeParameterList COMMA...");} //$NON-NLS-1$
			consumeTypeParameterList();
			break;

		case 568:
			if (DEBUG) {
				CompileLog.debug("TypeParameter ::= TypeParameterHeader extends...");} //$NON-NLS-1$
		...
		case 571:
			if (DEBUG) {
				CompileLog.debug("AdditionalBoundList ::= AdditionalBoundList...");} //$NON-NLS-1$
			consumeAdditionalBoundList();
			break;

		case 572:
			if (DEBUG) {
				CompileLog.debug("AdditionalBound ::= AND ReferenceType");} //$NON-NLS-1$
			consumeAdditionalBound();
			break;

		case 574:
			if (DEBUG) {
				CompileLog.debug("TypeParameterList1 ::= TypeParameterList COMMA...");} //$NON-NLS-1$
			consumeTypeParameterList1();
			break;

		case 575:
			if (DEBUG) {
				CompileLog.debug("TypeParameter1 ::= TypeParameterHeader GREATER");} //$NON-NLS-1$
			consumeTypeParameter1();
			break;

		case 576:
			if (DEBUG) {
				CompileLog.debug("TypeParameter1 ::= TypeParameterHeader extends...");} //$NON-NLS-1$
		...
		case 579:
			if (DEBUG) {
				CompileLog.debug("AdditionalBoundList1 ::= AdditionalBoundList...");} //$NON-NLS-1$
			consumeAdditionalBoundList1();
			break;

		case 580:
			if (DEBUG) {
				CompileLog.debug("AdditionalBound1 ::= AND ReferenceType1");} //$NON-NLS-1$
			consumeAdditionalBound1();
			break;

		case 586:
			if (DEBUG) {
				CompileLog.debug("UnaryExpression_NotName ::= PLUS PushPosition...");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.PLUS);
			break;

		case 587:
			if (DEBUG) {
				CompileLog.debug("UnaryExpression_NotName ::= MINUS PushPosition...");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.MINUS);
			break;

		case 590:
			if (DEBUG) {
				CompileLog.debug("UnaryExpressionNotPlusMinus_NotName ::= TWIDDLE...");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.TWIDDLE);
			break;

		case 591:
			if (DEBUG) {
				CompileLog.debug("UnaryExpressionNotPlusMinus_NotName ::= NOT PushPosition");} //$NON-NLS-1$
			consumeUnaryExpression(OperatorIds.NOT);
			break;

		case 594:
			if (DEBUG) {
				CompileLog.debug("MultiplicativeExpression_NotName ::=...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.MULTIPLY);
			break;

		case 595:
			if (DEBUG) {
				CompileLog.debug("MultiplicativeExpression_NotName ::= Name MULTIPLY...");} //$NON-NLS-1$
		...
		case 597:
			if (DEBUG) {
				CompileLog.debug("MultiplicativeExpression_NotName ::= Name DIVIDE...");} //$NON-NLS-1$
		...
		case 599:
			if (DEBUG) {
				CompileLog.debug("MultiplicativeExpression_NotName ::= Name REMAINDER...");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.REMAINDER);
			break;

		case 601:
			if (DEBUG) {
				CompileLog.debug("AdditiveExpression_NotName ::=...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.PLUS);
			break;

		case 602:
			if (DEBUG) {
				CompileLog.debug("AdditiveExpression_NotName ::= Name PLUS...");} //$NON-NLS-1$
		...
		case 604:
			if (DEBUG) {
				CompileLog.debug("AdditiveExpression_NotName ::= Name MINUS...");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.MINUS);
			break;

		case 606:
			if (DEBUG) {
				CompileLog.debug("ShiftExpression_NotName ::= ShiftExpression_NotName...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.LEFT_SHIFT);
			break;

		case 607:
			if (DEBUG) {
				CompileLog.debug("ShiftExpression_NotName ::= Name LEFT_SHIFT...");} //$NON-NLS-1$
		...
		case 609:
			if (DEBUG) {
				CompileLog.debug("ShiftExpression_NotName ::= Name RIGHT_SHIFT...");} //$NON-NLS-1$
		...
		case 611:
			if (DEBUG) {
				CompileLog.debug("ShiftExpression_NotName ::= Name UNSIGNED_RIGHT_SHIFT...");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.UNSIGNED_RIGHT_SHIFT);
			break;

		case 613:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression_NotName ::= ShiftExpression_NotName");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.LESS);
			break;

		case 614:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression_NotName ::= Name LESS...");} //$NON-NLS-1$
		...
		case 616:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression_NotName ::= Name GREATER...");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.GREATER);
			break;

		case 617:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression_NotName ::=...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.LESS_EQUAL);
			break;

		case 618:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression_NotName ::= Name LESS_EQUAL...");} //$NON-NLS-1$
		...
		case 620:
			if (DEBUG) {
				CompileLog.debug("RelationalExpression_NotName ::= Name GREATER_EQUAL...");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.GREATER_EQUAL);
			break;

		case 622:
			if (DEBUG) {
				CompileLog.debug("InstanceofExpression_NotName ::= Name instanceof...");} //$NON-NLS-1$
			consumeInstanceOfExpressionWithName();
			break;

		case 623:
			if (DEBUG) {
				CompileLog.debug("InstanceofExpression_NotName ::=...");} //$NON-NLS-1$
			consumeInstanceOfExpression();
			break;

		case 625:
			if (DEBUG) {
				CompileLog.debug("EqualityExpression_NotName ::=...");} //$NON-NLS-1$
			consumeEqualityExpression(OperatorIds.EQUAL_EQUAL);
			break;

		case 626:
			if (DEBUG) {
				CompileLog.debug("EqualityExpression_NotName ::= Name EQUAL_EQUAL...");} //$NON-NLS-1$
		...
		case 628:
			if (DEBUG) {
				CompileLog.debug("EqualityExpression_NotName ::= Name NOT_EQUAL...");} //$NON-NLS-1$
			consumeEqualityExpressionWithName(OperatorIds.NOT_EQUAL);
			break;

		case 630:
			if (DEBUG) {
				CompileLog.debug("AndExpression_NotName ::= AndExpression_NotName AND...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.AND);
			break;

		case 631:
			if (DEBUG) {
				CompileLog.debug("AndExpression_NotName ::= Name AND EqualityExpression");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.AND);
			break;

		case 633:
			if (DEBUG) {
				CompileLog.debug("ExclusiveOrExpression_NotName ::=...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.XOR);
			break;

		case 634:
			if (DEBUG) {
				CompileLog.debug("ExclusiveOrExpression_NotName ::= Name XOR AndExpression");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.XOR);
			break;

		case 636:
			if (DEBUG) {
				CompileLog.debug("InclusiveOrExpression_NotName ::=...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.OR);
			break;

		case 637:
			if (DEBUG) {
				CompileLog.debug("InclusiveOrExpression_NotName ::= Name OR...");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.OR);
			break;

		case 639:
			if (DEBUG) {
				CompileLog.debug("ConditionalAndExpression_NotName ::=...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.AND_AND);
			break;

		case 640:
			if (DEBUG) {
				CompileLog.debug("ConditionalAndExpression_NotName ::= Name AND_AND...");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.AND_AND);
			break;

		case 642:
			if (DEBUG) {
				CompileLog.debug("ConditionalOrExpression_NotName ::=...");} //$NON-NLS-1$
			consumeBinaryExpression(OperatorIds.OR_OR);
			break;

		case 643:
			if (DEBUG) {
				CompileLog.debug("ConditionalOrExpression_NotName ::= Name OR_OR...");} //$NON-NLS-1$
			consumeBinaryExpressionWithName(OperatorIds.OR_OR);
			break;

		case 645:
			if (DEBUG) {
				CompileLog.debug("ConditionalExpression_NotName ::=...");} //$NON-NLS-1$
			consumeConditionalExpression(OperatorIds.QUESTIONCOLON);
			break;

		case 646:
			if (DEBUG) {
				CompileLog.debug("ConditionalExpression_NotName ::= Name QUESTION...");} //$NON-NLS-1$
			consumeConditionalExpressionWithName(OperatorIds.QUESTIONCOLON);
			break;

		case 650:
			if (DEBUG) {
				CompileLog.debug("AnnotationTypeDeclarationHeaderName ::= Modifiers AT...");} //$NON-NLS-1$
		...
		case 652:
			if (DEBUG) {
				CompileLog.debug("AnnotationTypeDeclarationHeaderName ::= AT...");} //$NON-NLS-1$
			consumeAnnotationTypeDeclarationHeaderNameWithTypeParameters();
			break;
		...
		case 654:
			if (DEBUG) {
				CompileLog.debug("AnnotationTypeDeclarationHeader ::=...");} //$NON-NLS-1$
			consumeAnnotationTypeDeclarationHeader();
			break;

		case 655:
			if (DEBUG) {
				CompileLog.debug("AnnotationTypeDeclaration ::=...");} //$NON-NLS-1$
			consumeAnnotationTypeDeclaration();
			break;

		case 657:
			if (DEBUG) {
				CompileLog.debug("AnnotationTypeMemberDeclarationsopt ::=");} //$NON-NLS-1$
			consumeEmptyAnnotationTypeMemberDeclarationsopt();
			break;

		case 658:
			if (DEBUG) {
				CompileLog.debug("AnnotationTypeMemberDeclarationsopt ::= NestedType...");} //$NON-NLS-1$
			consumeAnnotationTypeMemberDeclarationsopt();
			break;

		case 660:
			if (DEBUG) {
				CompileLog.debug("AnnotationTypeMemberDeclarations ::=...");} //$NON-NLS-1$
			consumeAnnotationTypeMemberDeclarations();
			break;

		case 661:
			if (DEBUG) {
				CompileLog.debug("AnnotationMethodHeaderName ::= Modifiersopt...");} //$NON-NLS-1$
			consumeMethodHeaderNameWithTypeParameters(true);
			break;

		case 662:
			if (DEBUG) {
				CompileLog.debug("AnnotationMethodHeaderName ::= Modifiersopt Type...");} //$NON-NLS-1$
			consumeMethodHeaderName(true);
			break;

		case 663:
			if (DEBUG) {
				CompileLog.debug("AnnotationMethodHeaderDefaultValueopt ::=");} //$NON-NLS-1$
			consumeEmptyMethodHeaderDefaultValue();
			break;

		case 664:
			if (DEBUG) {
				CompileLog.debug("AnnotationMethodHeaderDefaultValueopt ::= DefaultValue");} //$NON-NLS-1$
			consumeMethodHeaderDefaultValue();
			break;

		case 665:
			if (DEBUG) {
				CompileLog.debug("AnnotationMethodHeader ::= AnnotationMethodHeaderName...");} //$NON-NLS-1$
			consumeMethodHeader();
			break;

		case 666:
			if (DEBUG) {
				CompileLog.debug("AnnotationTypeMemberDeclaration ::=...");} //$NON-NLS-1$
			consumeAnnotationTypeMemberDeclaration();
			break;

		case 674:
			if (DEBUG) {
				CompileLog.debug("AnnotationName ::= AT Name");} //$NON-NLS-1$
			consumeAnnotationName();
			break;

		case 675:
			if (DEBUG) {
				CompileLog.debug("NormalAnnotation ::= AnnotationName LPAREN...");} //$NON-NLS-1$
			consumeNormalAnnotation();
			break;

		case 676:
			if (DEBUG) {
				CompileLog.debug("MemberValuePairsopt ::=");} //$NON-NLS-1$
			consumeEmptyMemberValuePairsopt();
			break;

		case 679:
			if (DEBUG) {
				CompileLog.debug("MemberValuePairs ::= MemberValuePairs COMMA...");} //$NON-NLS-1$
			consumeMemberValuePairs();
			break;

		case 680:
			if (DEBUG) {
				CompileLog.debug("MemberValuePair ::= SimpleName EQUAL EnterMemberValue...");} //$NON-NLS-1$
			consumeMemberValuePair();
			break;

		case 681:
			if (DEBUG) {
				CompileLog.debug("EnterMemberValue ::=");} //$NON-NLS-1$
			consumeEnterMemberValue();
			break;

		case 682:
			if (DEBUG) {
				CompileLog.debug("ExitMemberValue ::=");} //$NON-NLS-1$
			consumeExitMemberValue();
			break;

		case 684:
			if (DEBUG) {
				CompileLog.debug("MemberValue ::= Name");} //$NON-NLS-1$
			consumeMemberValueAsName();
			break;

		case 687:
			if (DEBUG) {
				CompileLog.debug("MemberValueArrayInitializer ::=...");} //$NON-NLS-1$
		...
		case 691:
			if (DEBUG) {
				CompileLog.debug("EnterMemberValueArrayInitializer ::=");} //$NON-NLS-1$
			consumeEnterMemberValueArrayInitializer();
			break;

		case 693:
			if (DEBUG) {
				CompileLog.debug("MemberValues ::= MemberValues COMMA MemberValue");} //$NON-NLS-1$
			consumeMemberValues();
			break;

		case 694:
			if (DEBUG) {
				CompileLog.debug("MarkerAnnotation ::= AnnotationName");} //$NON-NLS-1$
			consumeMarkerAnnotation();
			break;

		case 695:
			if (DEBUG) {
				CompileLog.debug("SingleMemberAnnotationMemberValue ::= MemberValue");} //$NON-NLS-1$
			consumeSingleMemberAnnotationMemberValue();
			break;

		case 696:
			if (DEBUG) {
				CompileLog.debug("SingleMemberAnnotation ::= AnnotationName LPAREN...");} //$NON-NLS-1$
			consumeSingleMemberAnnotation();
			break;

		case 697:
			if (DEBUG) {
				CompileLog.debug("RecoveryMethodHeaderName ::= Modifiersopt TypeParameters");} //$NON-NLS-1$
			consumeRecoveryMethodHeaderNameWithTypeParameters();
			break;

		case 698:
			if (DEBUG) {
				CompileLog.debug("RecoveryMethodHeaderName ::= Modifiersopt Type...");} //$NON-NLS-1$
			consumeRecoveryMethodHeaderName();
			break;

		case 699:
			if (DEBUG) {
				CompileLog.debug("RecoveryMethodHeader ::= RecoveryMethodHeaderName...");} //$NON-NLS-1$
			consumeMethodHeader();
			break;
	...
	protected void consumeSingleStaticImportDeclarationName() {
		...
		/*
		 * push an ImportRef build from the last name stored in the identifier
		 * stack.
		 */
		...
		if (!this.statementRecoveryActivated && this.options.sourceLevel < ClassFileConstants.JDK1_5 && this.lastErrorEndPositionBeforeRecovery < this.scanner.currentPosition) {
			impt.modifiers = ClassFileConstants.AccDefault; // convert the
			// static import
			// reference to a
			// non-static
			// importe reference
	...
	protected void consumeStatementBreak() {
		...
		if (this.pendingRecoveredType != null) {
			// Used only in statements recovery.
			// This is not a real break statement but a placeholder for an
			// existing local type.
	...
	protected void consumeStatementCatch() {
		...
		this.astLengthPtr--;
		this.listLength = 0; // reset formalParameter counter (incremented for
		// catch variable)
	}
	...
	protected void consumeStatementIfWithElse() {
		...
		// optimize the push/pop
		this.astStack[--this.astPtr] = new IfStatement(this.expressionStack[this.expressionPtr--], (Statement) this.astStack[this.astPtr], (Statement) this.astStack[this.astPtr + 1],
	...
	protected void consumeStatementReturn() {
		...
		// return pushs a position on this.intStack in case there is no
		// expression
	...
	protected void consumeStatementSynchronized() {
		...
		if (this.astLengthStack[this.astLengthPtr] == 0) {
			...
			this.expressionLengthPtr--;
			this.astStack[this.astPtr] = new SynchronizedStatement(this.expressionStack[this.expressionPtr--], (Block) this.astStack[this.astPtr], this.intStack[this.intPtr--],
	...
	protected void consumeStatementWhile() {
		...
		// WhileStatementNoShortIf ::= 'while' '(' Expression ')'
		// StatementNoShortIf
	...
	protected void consumeStaticInitializer() {
		...
		Block block = (Block) this.astStack[this.astPtr];
		if (this.diet)
			block.bits &= ~ASTNode.UndocumentedEmptyBlock; // clear bit set
		// since was diet
	...
	protected void consumeStaticOnly() {
		...
		this.nestedMethod[this.nestedType]++;
		resetModifiers();
		this.expressionLengthPtr--; // remove the 0 pushed in consumeToken() for
		// the static modifier

		// recovery
		if (this.currentElement != null) {
			this.recoveredStaticInitializerStart = this.intStack[this.intPtr]; // remember
			// start
			// position
			// only
			// for
	...
	protected void consumeToken(int type) {
		...
		// // clear the commentPtr of the scanner in case we read something
		// different from a modifier
		// switch(type) {
		...
		// this.scanner.commentPtr = -1;
		// }
		// CompileLog.debug(this.scanner.toStringAction(type));
		switch (type) {
		...
		case TokenNameinterface:
			// 'class' is pushing two int (positions) on the stack ==>
			// 'interface' needs to do it too....
		...
		// declaration baseType and so takes the place of a type without getting
		// into
		...
		case TokenNameStringLiteral:
			...
			if (this.recordStringLiterals && this.checkExternalizeStrings && this.lastPosistion < this.scanner.currentPosition && !this.statementRecoveryActivated) {
				stringLiteral = this.createStringLiteral(this.scanner.getCurrentTokenSourceString(), this.scanner.startPosition, this.scanner.currentPosition - 1, Util.getLineNumber(
		...
		case TokenNameRPAREN:
			...
			// foo(x)
			this.rParenPos = this.scanner.currentPosition - 1; // position of
			// the end of
			// right
			// parenthesis
			// (in case of
	...
	protected void consumeWildcard1WithBounds() {
		// Nothing to do
		// The wildcard is created by the consumeWildcardBounds1Extends or by
		// consumeWildcardBounds1Super
	}
	...
	protected void consumeWildcard2WithBounds() {
		// Nothing to do
		// The wildcard is created by the consumeWildcardBounds2Extends or by
		// consumeWildcardBounds2Super
	}
	...
	protected void consumeWildcard3WithBounds() {
		// Nothing to do
		// The wildcard is created by the consumeWildcardBounds3Extends or by
		// consumeWildcardBounds3Super
	}
	...
	protected void consumeWildcardWithBounds() {
		// Nothing to do
		// The wildcard is created by the consumeWildcardBoundsExtends or by
		// consumeWildcardBoundsSuper
	}

	/**
	 * Given the current comment stack, answer whether some comment is available
	 * in a certain exclusive range
	 * 
	 * @param sourceStart
	 *            int
	 * @param sourceEnd
	...
	protected void dispatchDeclarationInto(int length) {
		/*
		 * they are length on this.astStack that should go into methods fields
		 * constructors lists of the typeDecl
		 * 
		 * Return if there is a constructor declaration in the methods
		 * declaration
		 */
		...
		for (int i = length - 1; i >= 0; i--) {
			...
			if (astNode instanceof AbstractMethodDeclaration) {
				// methods and constructors have been regrouped into one single
				// list
				flag[i] = 2;
				size2++;
		...
		{
			if (flagI != flag[end]) // treat the last element as a ended
			// flag.....
			{ // array copy
				switch (flagI) {
				case 1:
	...
	protected void dispatchDeclarationIntoEnumDeclaration(int length) {
		...
		for (int i = length - 1; i >= 0; i--) {
			...
			if (astNode instanceof AbstractMethodDeclaration) {
				...
				// ((AllocationExpression)constant.initialization).type = new
				// SingleTypeReference(enumDeclaration.name,
				// (((long) enumDeclaration.sourceStart) << 32) +
	...
	protected CompilationUnitDeclaration endParse(int act) {
		...
		if (this.statementRecoveryActivated) {
			...
			if (VERBOSE_RECOVERY) {
				CompileLog.debug("");
				CompileLog.debug("--------------------------"); //$NON-NLS-1$
				CompileLog.debug("" + this.compilationUnit);
				CompileLog.debug("----------------------------------"); //$NON-NLS-1$
			}
		...
		for (int i = 0; i < this.scanner.foundTaskCount; i++) {
			if (!this.statementRecoveryActivated)
				problemReporter().task(new String(this.scanner.foundTaskTags[i]), new String(this.scanner.foundTaskMessages[i]),
						this.scanner.foundTaskPriorities[i] == null ? null : new String(this.scanner.foundTaskPriorities[i]), this.scanner.foundTaskPositions[i][0],
	...
	public int flushCommentsDefinedPriorTo(int position) {
		...
		if (validCount > 0) {
			int immediateCommentEnd = -this.scanner.commentStops[index + 1]; // non-javadoc
			// comment
			// end
			// positions
			// are
			// negative
			if (immediateCommentEnd > 0) { // only tolerating non-javadoc
				// comments
	...
	/*
	 * Answer back an array of sourceStart/sourceEnd positions of the available
	 * JavaDoc comments. The array is a flattened structure: 2*n entries with
	 * consecutives start and end positions.
	 * 
	 * If no JavaDoc is available, then null is answered instead of an empty
	 * array.
	 * 
	 * e.g. { 10, 20, 25, 45 } --> javadoc1 from 10 to 20, javadoc2 from 25 to
	 * 45
	 */
	public int[] getJavaDocPositions() {
		...
		for (int i = 0, max = this.scanner.commentPtr; i <= max; i++) {
			...
			if (this.scanner.commentStops[i] > 0) {
				...
				positions[index++] = this.scanner.commentStops[i] - 1; // stop
				// is
				// one
				// over
			}
	...
	protected char getNextCharacter(char[] comment, int[] index) {
		...
		case '\\':
			...
			while (comment[index[0]] == 'u')
				index[0]++;
			if (!(((c1 = ScannerHelper.getNumericValue(comment[index[0]++])) > 15 || c1 < 0) || ((c2 = ScannerHelper.getNumericValue(comment[index[0]++])) > 15 || c2 < 0)
	...
	protected TypeReference getTypeReference(int dim) {
		/*
		 * build a Reference on a variable that may be qualified or not This
		 * variable is a type reference and dim will be its dimensions
		 */
	...
	protected NameReference getUnspecifiedReference() {
		...
		// Qualified variable reference
		{
			...
			long[] positions = new long[length];
			System.arraycopy(this.identifierPositionStack, this.identifierPtr + 1, positions, 0, length);
			ref = new QualifiedNameReference(tokens, positions, (int) (this.identifierPositionStack[this.identifierPtr + 1] >> 32), // sourceStart
	...
	protected NameReference getUnspecifiedReferenceOptimized() {
		/*
		 * build a (unspecified) NameReference which may be qualified The
		 * optimization occurs for qualified reference while we are certain in
		 * this case the last item of the qualified name is a field access. This
		 * optimization is IMPORTANT while it results that when a NameReference
		 * is build, the type checker should always look for that it is not a
		 * type reference
		 */
		...
		// Qualified-variable-reference
		// In fact it is variable-reference DOT field-ref , but it would result
		// in a type
		...
		// NameReference
		// or else..........This optimisation is not really relevant so just
		// leave as it is
	...
	public void goForBlockStatementsOrCatchHeader() {
		// tells the scanner to go for block statements or method headers
		// parsing
	...
	public void goForExpression() {
		...
		this.scanner.recordLineSeparator = true; // recovery goals must record
		// line separators
	}
	...
	public void goForTypeDeclaration() {
		// tells the scanner to go for type (interface or class) declaration
		// parsing
	...
	public void initialize(boolean initializeNLS) {
		...
		this.intPtr = -1;
		this.nestedMethod[this.nestedType = 0] = 0; // need to reset for further
		// reuse
		this.variablesCounter[this.nestedType] = 0;
		this.dimensions = 0;
		this.realBlockPtr = -1;
		...
		if (this.noAstNodes.length < astLength) {
			...
			// CompileLog.debug("Resized AST stacks : "+ astLength);
		...
		if (this.noExpressions.length < expressionLength) {
			...
			// CompileLog.debug("Resized EXPR stacks : "+ expressionLength);
		}
	...
	public void initializeScanner() {
		this.scanner = new Scanner(false /* comment */, false /* whitespace */, false, /*
																					 ...
																					 * )
																					 */
		this.options.sourceLevel /* sourceLevel */, this.options.complianceLevel /* complianceLevel */, this.options.taskTags/* taskTags */, this.options.taskPriorites/* taskPriorities */,
	...
	private void jumpOverType() {
		if (this.recoveredTypes != null && this.nextTypeStart > -1 && this.nextTypeStart < this.scanner.currentPosition) {
			...
			if (DEBUG_AUTOMATON) {
				CompileLog.debug("Jump         -"); //$NON-NLS-1$
			}
	...
	protected void markEnclosingMemberWithLocalType() {
		...
		for (int i = this.astPtr; i >= 0; i--) {
			ASTNode node = this.astStack[i];
			if (node instanceof AbstractMethodDeclaration || node instanceof FieldDeclaration || (node instanceof TypeDeclaration // mark
					// type
					// for
					// now:
					// all
					...
					// this
					// type
					// and enclosing type must not be closed (see
					// https://bugs.eclipse.org/bugs/show_bug.cgi?id=147485)
	...
	/*
	 * Move checkpoint location (current implementation is moving it by one
	 * token)
	 * 
	 * Answers true if successfully moved checkpoint (in other words, it did not
	 * attempt to move it beyond end of file).
	 */
	protected boolean moveRecoveryCheckpoint() {
		...
		do {
			try {
				...
				if (this.scanner.currentPosition == this.scanner.startPosition) {
					this.scanner.currentPosition++; // on fake completion
					// identifier
					this.nextIgnoredToken = -1;
				}
		...
		if (this.nextIgnoredToken == TokenNameEOF) { // no more recovery after
			// this point
			if (this.currentToken == TokenNameEOF) { // already tried one
				// iteration on EOF
				return false;
			}
		}
		...
		/*
		 * The following implementation moves the checkpoint location by one
		 * line:
		 * 
		 * int pos = this.lastCheckPoint; // reset this.scanner, and move
		 * checkpoint by one token this.scanner.startPosition = pos;
		 * this.scanner.currentPosition = pos; this.scanner.diet = false; //
		 * quit jumping over method bodies
		 * 
		 * // if about to restart, then no need to shift token if
		 * (this.restartRecovery){ this.lastIgnoredToken = -1; return true; }
		 * 
		 * // protect against shifting on an invalid token this.lastIgnoredToken
		 * = this.nextIgnoredToken; this.nextIgnoredToken = -1;
		 * 
		 * boolean wasTokenizingWhiteSpace = this.scanner.tokenizeWhiteSpace;
		 * this.scanner.tokenizeWhiteSpace = true; checkpointMove: do { try {
		 * this.nextIgnoredToken = this.scanner.getNextToken();
		 * switch(this.nextIgnoredToken){ case Scanner.TokenNameWHITESPACE :
		 * if(this.scanner.getLineNumber(this.scanner.startPosition) ==
		 * this.scanner.getLineNumber(this.scanner.currentPosition)){
		 * this.nextIgnoredToken = -1; } break; case TokenNameSEMICOLON : case
		 * TokenNameLBRACE : case TokenNameRBRACE : break; case
		 * TokenNameIdentifier : if(this.scanner.currentPosition ==
		 * this.scanner.startPosition){ this.scanner.currentPosition++; // on
		 * fake completion identifier } default: this.nextIgnoredToken = -1;
		 * break; case TokenNameEOF : break checkpointMove; } }
		 * catch(InvalidInputException e){ pos = this.scanner.currentPosition; }
		 * } while (this.nextIgnoredToken < 0); this.scanner.tokenizeWhiteSpace
		 * = wasTokenizingWhiteSpace;
		 * 
		 * if (this.nextIgnoredToken == TokenNameEOF) { // no more recovery
		 * after this point if (this.currentToken == TokenNameEOF) { // already
		 * tried one iteration on EOF return false; } } this.lastCheckPoint =
		 * this.scanner.currentPosition;
		 * 
		 * // reset this.scanner again to previous checkpoint location
		 * this.scanner.startPosition = pos; this.scanner.currentPosition = pos;
		 * this.scanner.commentPtr = -1;
		 * 
		 * return true;
		 */
	...
	protected void optimizedConcatNodeLists() {
		/*
		 * back from a recursive loop. Virtualy group the astNode into an array
		 * using this.astLengthStack
		 */
		 ...
		 * means that the p could be equals to 0 in case there is no astNode
		 * pushed on the this.astStack. Look at the InterfaceMemberDeclarations
		 * for an example. This case optimizes the fact that p == 1.
		 */
	...
	protected void parse() {
		if (DEBUG)
			CompileLog.debug("-- ENTER INSIDE PARSE METHOD --"); //$NON-NLS-1$

		if (DEBUG_AUTOMATON) {
			CompileLog.debug("- Start --------------------------------"); //$NON-NLS-1$
		}
		...
		ProcessTerminals: for (;;) {
			...
			if (act == ERROR_ACTION || this.restartRecovery) {
				...
				if (DEBUG_AUTOMATON) {
					if (this.restartRecovery) {
						CompileLog.debug("Restart      - "); //$NON-NLS-1$
					} else {
						CompileLog.debug("Error        - "); //$NON-NLS-1$
					}
				}
			...
			if (act <= NUM_RULES) {
				...
				if (DEBUG_AUTOMATON) {
					CompileLog.debug("Reduce       - "); //$NON-NLS-1$
				}
				...
				if (DEBUG_AUTOMATON) {
					CompileLog.debug("Shift/Reduce - (" + name[terminal_index[this.currentToken]] + ") "); //$NON-NLS-1$  //$NON-NLS-2$ 
				}
				...
				if (act < ACCEPT_ACTION) { /* shift */
					...
					if (DEBUG_AUTOMATON) {
						CompileLog.debug("Shift        - (" + name[terminal_index[this.currentToken]] + ")"); //$NON-NLS-1$  //$NON-NLS-2$
					}
					continue ProcessTerminals;
				}
				break ProcessTerminals;
			...
			do { /* reduce */
				...
				if (DEBUG_AUTOMATON) {
					CompileLog.debug(name[non_terminal_index[lhs[act]]]);
				}
		...
		if (DEBUG_AUTOMATON) {
			CompileLog.debug("- End ----------------------------------"); //$NON-NLS-1$
		}
		...
		if (DEBUG)
			CompileLog.debug("-- EXIT FROM PARSE METHOD --"); //$NON-NLS-1$
	}
	...
	public void parse(Initializer initializer, TypeDeclaration type, CompilationUnitDeclaration unit) {
		...
		this.scanner.resetTo(initializer.bodyStart, initializer.bodyEnd); // just
		// on
		// the
		// beginning
		// {
	...
	protected void pushIdentifier() {
		/*
		 * push the consumeToken on the identifier stack. Increase the total
		 * number of identifier in the stack. identifierPtr points on the next
		 * top
		 */
	...
	protected void pushIdentifier(int flag) {
		/*
		 * push a special flag on the stack : -zero stands for optional Name
		 * -negative number for direct ref to base types. identifierLengthPtr
		 * points on the top
		 */
	...
	protected void pushOnGenericsStack(ASTNode node) {
		/*
		 * add a new obj on top of the generics stack genericsPtr points on the
		 * top
		 */
	...
	protected void recoverStatements() {
		class MethodVisitor extends ASTVisitor {
			...
			private void endVisitMethod(AbstractMethodDeclaration methodDeclaration, ClassScope scope) {
				...
				Parser.this.parseStatements(methodDeclaration, methodDeclaration.bodyStart, methodDeclaration.bodyEnd, foundTypes, compilationUnit);
			...
			public void endVisit(Initializer initializer, MethodScope scope) {
				...
				Scanner oldScanner = Parser.this.scanner;
				Parser.this.scanner = Parser.this.recoveryScanner;
				Parser.this.parseStatements(this.enclosingType, initializer.bodyStart, initializer.bodyEnd, foundTypes, compilationUnit);
				Parser.this.scanner = oldScanner;
				Parser.this.referenceContext = oldContext;
	...
	/*
	 * Token check performed on every token shift once having entered recovery
	 * mode.
	 */
	public void recoveryTokenCheck() {
		...
		case TokenNameStringLiteral:
			if (this.recordStringLiterals && this.checkExternalizeStrings && this.lastPosistion < this.scanner.currentPosition && !this.statementRecoveryActivated) {
				StringLiteral stringLiteral = this.createStringLiteral(this.scanner.getCurrentTokenSourceString(), this.scanner.startPosition, this.scanner.currentPosition - 1, Util.getLineNumber(
						this.scanner.startPosition, this.scanner.lineEnds, 0, this.scanner.linePtr));
				this.compilationUnit.recordStringLiteral(stringLiteral, this.currentElement != null);
			}
			break;
		...
		case TokenNameRBRACE:
			...
			if (newElement != this.currentElement) {
				this.currentElement = newElement;
				// if (newElement instanceof RecoveredField && this.dietInt <=
				// 0) {
				// if (((RecoveredField)newElement).fieldDeclaration.type ==
				// null) { // enum constant
	...
	protected void reportSyntaxErrors(boolean isDietParse, int oldFirstToken) {
		...
		if (isDietParse) {
			...
			int[][] intervalToSkip = xap.lui.compile.ca.jdt.internal.compiler.parser.diagnose.RangeUtil.computeDietRange(types);
	...
	/*
	 * Reset context so as to resume to regular parse loop If unable to reset
	 * for resuming, answers false.
	 * 
	 * Move checkpoint location, reset internal stacks and decide which grammar
	 * goal is activated.
	 */
	protected boolean resumeAfterRecovery() {
		if (!this.methodRecoveryActivated && !this.statementRecoveryActivated) {
			...
			if (this.referenceContext instanceof CompilationUnitDeclaration) {
				goForHeaders();
				this.diet = true; // passed this point, will not consider method
				// bodies
				return true;
			}
	...
	protected void updateRecoveryState() {
		...
		/*
		 * check and update recovered state based on current token, this action
		 * is also performed when shifting token after recovery got activated
		 * once.
		 */
		this.recoveryTokenCheck();
	}
