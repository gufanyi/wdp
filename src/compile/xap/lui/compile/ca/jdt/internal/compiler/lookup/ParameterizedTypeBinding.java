...
//		}
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#canBeInstantiated()
	 */
	 ...
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#capture(Scope,int)
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#collectMissingTypes(java.util.List)
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#computeId()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#constantPoolName()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#debugName()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#enclosingType()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.Substitution#environment()
	 */
	public LookupEnvironment environment() {
	...
	/**
     * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#erasure()
     */
    public TypeBinding erasure() {
        return this.type.erasure(); // erasure
    }
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#fieldCount()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#fields()
	 */
	public FieldBinding[] fields() {
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#getAnnotationTagBits()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#getExactConstructor(TypeBinding[])
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#getExactMethod(char[], TypeBinding[],CompilationUnitScope)
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#getField(char[], boolean)
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#getMemberType(char[])
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#getMethods(char[])
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#implementsMethod(MethodBinding)
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#isParameterizedType()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.Substitution#isRawSubstitution()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#memberTypes()
	 */
	public ReferenceBinding[] memberTypes() {
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#methods()
	 */
	public MethodBinding[] methods() {
		if ((tagBits & TagBits.AreMethodsComplete) != 0)
			return this.methods;
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#qualifiedPackageName()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#qualifiedSourceName()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.Binding#readableName()
	 */
...
//			}
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.Binding#shortReadableName()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#signature()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding#sourceName()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.Substitution#substitute(xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeVariableBinding)
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#superclass()
	 */
	public ReferenceBinding superclass() {
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#superInterfaces()
	 */
	public ReferenceBinding[] superInterfaces() {
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#syntheticEnclosingInstanceTypes()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ReferenceBinding#syntheticOuterLocalVariables()
	 */
