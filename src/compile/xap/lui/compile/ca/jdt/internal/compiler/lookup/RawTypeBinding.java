...
public class RawTypeBinding extends ParameterizedTypeBinding {
	...
	/**
	 * @see xap.lui.compile.ca.jdt.internal.compiler.lookup.ParameterizedTypeBinding#createParameterizedMethod(xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding)
	 */
