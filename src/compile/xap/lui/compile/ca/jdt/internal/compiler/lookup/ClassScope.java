...
import xap.lui.compile.ca.jdt.internal.compiler.lookup.MemberTypeBinding;
...
//		}
	...
	private boolean detectHierarchyCycle(SourceTypeBinding sourceType, ReferenceBinding superType, TypeReference reference) {
		...
		if (superType.isHierarchyBeingConnected()) {
			xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference ref = ((SourceTypeBinding) superType).scope.superTypeReference;
