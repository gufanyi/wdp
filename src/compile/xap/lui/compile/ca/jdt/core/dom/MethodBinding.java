...
class MethodBinding implements IMethodBinding {
	...
	private xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding binding;
	...
	MethodBinding(BindingResolver resolver, xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding binding) {
	...
	public IAnnotationBinding[] getAnnotations() {
		...
		xap.lui.compile.ca.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations = this.binding.getAnnotations();
	...
	public IAnnotationBinding[] getParameterAnnotations(int index) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.lookup.AnnotationBinding[][] bindingAnnotations = this.binding.getParameterAnnotations();
		...
		for (int i = 0; i < length; i++) {
			xap.lui.compile.ca.jdt.internal.compiler.lookup.AnnotationBinding[] paramBindingAnnotations = bindingAnnotations[i];
	...
	public ITypeBinding[] getParameterTypes() {
		...
		xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding[] parameters = this.binding.parameters;
...
//					Util.log(new IllegalArgumentException(), message.toString());
	...
	public ITypeBinding[] getExceptionTypes() {
		...
		xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding[] exceptions = this.binding.thrownExceptions;
...
//				defaultBindingResolver.getBindingsToNodesMap());
	...
	/**
	 * @see xap.lui.compile.ca.jdt.core.dom.IMethodBinding#isVarargs()
	 * @since 3.1
	 */
	...
	public boolean isEqualTo(IBinding other) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding otherBinding = ((MethodBinding) other).binding;
		return BindingComparator.isEqual(this.binding, otherBinding);
	}

	/**
	 * @see xap.lui.compile.ca.jdt.core.dom.IMethodBinding#getTypeParameters()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.core.dom.IMethodBinding#isGenericMethod()
	 * @since 3.1
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.core.dom.IMethodBinding#getTypeArguments()
	 */
	public ITypeBinding[] getTypeArguments() {
		...
		if (this.binding instanceof ParameterizedGenericMethodBinding) {
			...
			xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding[] typeArgumentsBindings = genericMethodBinding.typeArguments;
	...
	/**
	 * @see xap.lui.compile.ca.jdt.core.dom.IMethodBinding#isParameterizedMethod()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.core.dom.IMethodBinding#isRawMethod()
	 */
	...
	/**
	 * @see xap.lui.compile.ca.jdt.core.dom.IMethodBinding#getMethodDeclaration()
	 */
