...
import xap.lui.compile.ca.jdt.core.IAnnotatable;
...
import xap.lui.compile.ca.jdt.internal.compiler.util.*;
...
class AnnotationBinding implements IAnnotationBinding {
	...
	private xap.lui.compile.ca.jdt.internal.compiler.lookup.AnnotationBinding binding;
	private BindingResolver bindingResolver;
	private String key;

	AnnotationBinding(xap.lui.compile.ca.jdt.internal.compiler.lookup.AnnotationBinding annotation, BindingResolver resolver) {
		if (annotation == null)
