...
import xap.lui.compile.ca.jdt.internal.compiler.lookup.VariableBinding;
...
class BindingComparator {
	...
	static boolean isEqual(Binding declaringElement, Binding declaringElement2, HashSet visitedTypes) {
		if (declaringElement instanceof xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding) {
			if (!(declaringElement2 instanceof xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding)){
				return false;
			}
			return isEqual((xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding) declaringElement,
					(xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding) declaringElement2,
					visitedTypes);
		} else if (declaringElement instanceof xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding) {
			if (!(declaringElement2 instanceof xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding)) {
				return false;
			}
			return isEqual((xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding) declaringElement,
					(xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding) declaringElement2,
					visitedTypes);
		...
		} else if (declaringElement instanceof xap.lui.compile.ca.jdt.internal.compiler.lookup.PackageBinding) {
			if (!(declaringElement2 instanceof xap.lui.compile.ca.jdt.internal.compiler.lookup.PackageBinding)) {
				return false;
			}
			xap.lui.compile.ca.jdt.internal.compiler.lookup.PackageBinding packageBinding = (xap.lui.compile.ca.jdt.internal.compiler.lookup.PackageBinding) declaringElement;
			xap.lui.compile.ca.jdt.internal.compiler.lookup.PackageBinding packageBinding2 = (xap.lui.compile.ca.jdt.internal.compiler.lookup.PackageBinding) declaringElement2;
	...
	static boolean isEqual(xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding methodBinding,
			xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding methodBinding2) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding[] bindings, xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding[] otherBindings) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding[] bindings, xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding[] otherBindings, HashSet visitedTypes) {
		if (bindings == null) {
			return otherBindings == null;
		}
		if (otherBindings == null) {
	...
	static boolean isEqual(xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding, xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding2, HashSet visitedTypes) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding, xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding2) {
