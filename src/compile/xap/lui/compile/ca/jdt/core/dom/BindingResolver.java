...
class BindingResolver {
	 ...
	 */
	xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode) {
		return null;
	}
	 ...
	 */
	IMethodBinding getMethodBinding(xap.lui.compile.ca.jdt.internal.compiler.lookup.MethodBinding methodBinding) {
		return null;
	}
	 ...
	 */
	IPackageBinding getPackageBinding(xap.lui.compile.ca.jdt.internal.compiler.lookup.PackageBinding packageBinding) {
		return null;
	}
	 ...
	 */
	ITypeBinding getTypeBinding(xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding referenceBinding) {
		return null;
	}
	 ...
	 */
	IVariableBinding getVariableBinding(xap.lui.compile.ca.jdt.internal.compiler.lookup.VariableBinding binding) {
		return null;
	}
	 ...
	 */
	IAnnotationBinding getAnnotationInstance(xap.lui.compile.ca.jdt.internal.compiler.lookup.AnnotationBinding instance) {
		return null;
	}
	 ...
	 */
	void store(ASTNode newNode, xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode oldASTNode) {
		// default implementation: do nothing
	}
