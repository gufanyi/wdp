...
import xap.lui.compile.ca.jdt.internal.compiler.ast.StringLiteralConcatenation;
...
import xap.lui.compile.ca.jdt.internal.compiler.parser.RecoveryScanner;
import xap.lui.compile.ca.jdt.internal.compiler.parser.Scanner;
import xap.lui.compile.ca.jdt.internal.compiler.parser.TerminalTokens;
...
//		Object sourceModeSetting = options.get(JavaCore.COMPILER_SOURCE);
	...
	protected void adjustSourcePositionsForParent(xap.lui.compile.ca.jdt.internal.compiler.ast.Expression expression) {
	...
	protected void buildBodyDeclarations(xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration, AbstractTypeDeclaration typeDecl) {
		// add body declaration in the lexical order
		xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration[] members = typeDeclaration.memberTypes;
		xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration[] fields = typeDeclaration.fields;
		xap.lui.compile.ca.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = typeDeclaration.methods;
		...
		while ((fieldsIndex < fieldsLength)
			...
			xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration nextFieldDeclaration = null;
			xap.lui.compile.ca.jdt.internal.compiler.ast.AbstractMethodDeclaration nextMethodDeclaration = null;
			xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration = null;
	...
	protected void buildBodyDeclarations(xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration enumDeclaration2, EnumDeclaration enumDeclaration) {
		// add body declaration in the lexical order
		xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration[] members = enumDeclaration2.memberTypes;
		xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration[] fields = enumDeclaration2.fields;
		xap.lui.compile.ca.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = enumDeclaration2.methods;
	...
	protected void buildBodyDeclarations(xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration expression, AnonymousClassDeclaration anonymousClassDeclaration) {
		// add body declaration in the lexical order
		xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration[] members = expression.memberTypes;
		xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration[] fields = expression.fields;
		xap.lui.compile.ca.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = expression.methods;
	...
	protected void checkAndAddMultipleFieldDeclaration(xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration[] fields, int index, List bodyDeclarations) {
		if (fields[index] instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.Initializer) {
			xap.lui.compile.ca.jdt.internal.compiler.ast.Initializer oldInitializer = (xap.lui.compile.ca.jdt.internal.compiler.ast.Initializer) fields[index];
	...
	protected void checkAndAddMultipleLocalDeclaration(xap.lui.compile.ca.jdt.internal.compiler.ast.Statement[] stmts, int index, List blockStatements) {
		if (index > 0
				&& stmts[index - 1] instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration) {
			xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration local1 = (xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration) stmts[index - 1];
			xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration local2 = (xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration) stmts[index];
			if (local1.declarationSourceStart == local2.declarationSourceStart) {
				...
				variableDeclarationStatement.fragments().add(convertToVariableDeclarationFragment((xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration)stmts[index]));
			} else {
				// we can create a new FieldDeclaration
				blockStatements.add(convertToVariableDeclarationStatement((xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration)stmts[index]));
			}
		} else {
			// we can create a new FieldDeclaration
			blockStatements.add(convertToVariableDeclarationStatement((xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration)stmts[index]));
...
//	}
//		
	public ASTNode convert(xap.lui.compile.ca.jdt.internal.compiler.ast.AbstractMethodDeclaration methodDeclaration) {
		checkCanceled();
		if (methodDeclaration instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.AnnotationMethodDeclaration) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.AnnotationMethodDeclaration) methodDeclaration);
		}
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference[] thrownExceptions = methodDeclaration.thrownExceptions;
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Argument[] parameters = methodDeclaration.arguments;
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.ExplicitConstructorCall explicitConstructorCall = null;
		if (isConstructor) {
			xap.lui.compile.ca.jdt.internal.compiler.ast.ConstructorDeclaration constructorDeclaration = (xap.lui.compile.ca.jdt.internal.compiler.ast.ConstructorDeclaration) methodDeclaration;
		...
		} else if (methodDeclaration instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.MethodDeclaration) {
			xap.lui.compile.ca.jdt.internal.compiler.ast.MethodDeclaration method = (xap.lui.compile.ca.jdt.internal.compiler.ast.MethodDeclaration) methodDeclaration;
			xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference typeReference = method.returnType;
		...
		if (closingPosition != -1) {
			...
			xap.lui.compile.ca.jdt.internal.compiler.ast.Statement[] statements = methodDeclaration.statements;
			...
			if (block != null && (statements != null || explicitConstructorCall != null)) {
				if (explicitConstructorCall != null && explicitConstructorCall.accessMode != xap.lui.compile.ca.jdt.internal.compiler.ast.ExplicitConstructorCall.ImplicitSuper) {
					block.statements().add(convert(explicitConstructorCall));
				}
				int statementsLength = statements == null ? 0 : statements.length;
				for (int i = 0; i < statementsLength; i++) {
					if (statements[i] instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.TypeParameter[] typeParameters = methodDeclaration.typeParameters();
...
//			CompileLog.error(e);
	...
	public ClassInstanceCreation convert(xap.lui.compile.ca.jdt.internal.compiler.ast.AllocationExpression expression) {
...
//		}
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression[] arguments = expression.arguments;
		if (arguments != null) {
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.AND_AND_Expression expression) {
		InfixExpression infixExpression = new InfixExpression(this.ast);
		infixExpression.setOperator(InfixExpression.Operator.CONDITIONAL_AND);
//		if (this.resolveBindings) {
//			this.recordNodes(infixExpression, expression);
//		}
		final int expressionOperatorID = (expression.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
		if (expression.left instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.BinaryExpression
				&& ((expression.left.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0)) {
			...
			xap.lui.compile.ca.jdt.internal.compiler.ast.Expression leftOperand = expression.left;
			xap.lui.compile.ca.jdt.internal.compiler.ast.Expression rightOperand = null;
			do {
				rightOperand = ((xap.lui.compile.ca.jdt.internal.compiler.ast.BinaryExpression) leftOperand).right;
				if ((((leftOperand.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID
							&& ((leftOperand.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))
					 || ((rightOperand instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.BinaryExpression
				 			&& ((rightOperand.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID)
							&& ((rightOperand.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))) {
...
//					}
				...
				leftOperand = ((xap.lui.compile.ca.jdt.internal.compiler.ast.BinaryExpression) leftOperand).left;
			} while (leftOperand instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.BinaryExpression && ((leftOperand.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0));
	...
	public AnnotationTypeDeclaration convertToAnnotationDeclaration(xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
		checkCanceled();
...
//		}
	...
	public ASTNode convert(xap.lui.compile.ca.jdt.internal.compiler.ast.AnnotationMethodDeclaration annotationTypeMemberDeclaration) {
		checkCanceled();
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference typeReference = annotationTypeMemberDeclaration.returnType;
		if (typeReference != null) {
			Type returnType = convertType(typeReference);
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression memberValue = annotationTypeMemberDeclaration.defaultValue;
		if (memberValue != null) {
...
//	
	public SingleVariableDeclaration convert(xap.lui.compile.ca.jdt.internal.compiler.ast.Argument argument) {
...
//		}
	...
	public Annotation convert(xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation annotation) {
		if (annotation instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.SingleMemberAnnotation) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.SingleMemberAnnotation) annotation);
		} else if (annotation instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.MarkerAnnotation) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.MarkerAnnotation) annotation);
		} else {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.NormalAnnotation) annotation);
		}
	}
//
	public ArrayCreation convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayAllocationExpression expression) {
...
//		}
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression[] dimensions = expression.dimensions;
...
//		}	
	...
	public ArrayInitializer convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayInitializer expression) {
...
//		}
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression[] expressions = expression.expressions;
		if (expressions != null) {
...
//				}
	...
	public ArrayAccess convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayReference reference) {
...
//		}
	...
	public AssertStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.AssertStatement statement) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression exceptionArgument = statement.exceptionArgument;
	...
	public Assignment convert(xap.lui.compile.ca.jdt.internal.compiler.ast.Assignment expression) {
...
//		}
	 ...
	 */
	public TypeDeclaration convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode[] nodes) {
		final TypeDeclaration typeDecl = new TypeDeclaration(this.ast);
		typeDecl.setInterface(false);
		int nodesLength = nodes.length;
		for (int i = 0; i < nodesLength; i++) {
			xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode node = nodes[i];
			if (node instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.Initializer) {
				xap.lui.compile.ca.jdt.internal.compiler.ast.Initializer oldInitializer = (xap.lui.compile.ca.jdt.internal.compiler.ast.Initializer) node;
				Initializer initializer = new Initializer(this.ast);
				initializer.setBody(convert(oldInitializer.block));
				setModifiers(initializer, oldInitializer);
				initializer.setSourceRange(oldInitializer.declarationSourceStart, oldInitializer.sourceEnd - oldInitializer.declarationSourceStart + 1);
...
//				initializer.setJavadoc(convert(oldInitializer.javadoc));
			...
			} else if (node instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration) {
				xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration = (xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration) node;
				if (i > 0
					&& (nodes[i - 1] instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration)
					&& ((xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration)nodes[i - 1]).declarationSourceStart == fieldDeclaration.declarationSourceStart) {
					// we have a multiple field declaration
					// We retrieve the existing fieldDeclaration to add the new VariableDeclarationFragment
			...
			} else if(node instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.AbstractMethodDeclaration) {
				AbstractMethodDeclaration nextMethodDeclaration = (AbstractMethodDeclaration) node;
				if (!nextMethodDeclaration.isDefaultConstructor() && !nextMethodDeclaration.isClinit()) {
					typeDecl.bodyDeclarations().add(convert(nextMethodDeclaration));
				}
			} else if(node instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration) {
				xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration = (xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration) node;
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.BinaryExpression expression) {
		InfixExpression infixExpression = new InfixExpression(this.ast);
//		if (this.resolveBindings) {
//			this.recordNodes(infixExpression, expression);
//		}

		int expressionOperatorID = (expression.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
		switch (expressionOperatorID) {
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.EQUAL_EQUAL :
				infixExpression.setOperator(InfixExpression.Operator.EQUALS);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.LESS_EQUAL :
				infixExpression.setOperator(InfixExpression.Operator.LESS_EQUALS);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.GREATER_EQUAL :
				infixExpression.setOperator(InfixExpression.Operator.GREATER_EQUALS);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.NOT_EQUAL :
				infixExpression.setOperator(InfixExpression.Operator.NOT_EQUALS);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.LEFT_SHIFT :
				infixExpression.setOperator(InfixExpression.Operator.LEFT_SHIFT);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.RIGHT_SHIFT :
				infixExpression.setOperator(InfixExpression.Operator.RIGHT_SHIFT_SIGNED);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.UNSIGNED_RIGHT_SHIFT :
				infixExpression.setOperator(InfixExpression.Operator.RIGHT_SHIFT_UNSIGNED);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.OR_OR :
				infixExpression.setOperator(InfixExpression.Operator.CONDITIONAL_OR);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.AND_AND :
				infixExpression.setOperator(InfixExpression.Operator.CONDITIONAL_AND);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.PLUS :
				infixExpression.setOperator(InfixExpression.Operator.PLUS);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.MINUS :
				infixExpression.setOperator(InfixExpression.Operator.MINUS);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.REMAINDER :
				infixExpression.setOperator(InfixExpression.Operator.REMAINDER);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.XOR :
				infixExpression.setOperator(InfixExpression.Operator.XOR);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.AND :
				infixExpression.setOperator(InfixExpression.Operator.AND);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.MULTIPLY :
				infixExpression.setOperator(InfixExpression.Operator.TIMES);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.OR :
				infixExpression.setOperator(InfixExpression.Operator.OR);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.DIVIDE :
				infixExpression.setOperator(InfixExpression.Operator.DIVIDE);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.GREATER :
				infixExpression.setOperator(InfixExpression.Operator.GREATER);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.LESS :
...
//					}
			...
			final xap.lui.compile.ca.jdt.internal.compiler.ast.Expression[] stringLiterals = literal.literals;
	...
	public Block convert(xap.lui.compile.ca.jdt.internal.compiler.ast.Block statement) {
		Block block = new Block(this.ast);
		if (statement.sourceEnd > 0) {
			block.setSourceRange(statement.sourceStart, statement.sourceEnd - statement.sourceStart + 1);
		}
		xap.lui.compile.ca.jdt.internal.compiler.ast.Statement[] statements = statement.statements;
		if (statements != null) {
	...
	public BreakStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.BreakStatement statement)  {
	...
	public SwitchCase convert(xap.lui.compile.ca.jdt.internal.compiler.ast.CaseStatement statement) {
		SwitchCase switchCase = new SwitchCase(this.ast);
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression constantExpression = statement.constantExpression;
	...
	public CastExpression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.CastExpression expression) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression type = expression.type;
		trimWhiteSpacesAndComments(type);
		if (type instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference ) {
			castExpression.setType(convertType((xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference)type));
		} else if (type instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.NameReference) {
			castExpression.setType(convertToType((xap.lui.compile.ca.jdt.internal.compiler.ast.NameReference)type));
		}
...
//		}
	...
	public CharacterLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.CharLiteral expression) {
...
//		}
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ClassLiteralAccess expression) {
...
//		}
	...
	public CompilationUnit convert(xap.lui.compile.ca.jdt.internal.compiler.ast.CompilationUnitDeclaration unit, char[] source) {
...
//		}
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.ImportReference[] imports = unit.imports;
		if (imports != null) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration[] types = unit.types;
		if (types != null) {
			int typesLength = types.length;
			for (int i = 0; i < typesLength; i++) {
				xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration declaration = types[i];
...
//		}
	...
	public Assignment convert(xap.lui.compile.ca.jdt.internal.compiler.ast.CompoundAssignment expression) {
		Assignment assignment = new Assignment(this.ast);
		Expression lhs = convert(expression.lhs);
		assignment.setLeftHandSide(lhs);
		int start = lhs.getStartPosition();
...
//		}
	...
	public ConditionalExpression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ConditionalExpression expression) {
...
//		}
	...
	public ContinueStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ContinueStatement statement)  {
	...
	public DoStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.DoStatement statement) {
	...
	public NumberLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.DoubleLiteral expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;	
		int sourceStart = expression.sourceStart;
...
//		}
	...
	public EmptyStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.EmptyStatement statement) {
	...
	public EnumConstantDeclaration convert(xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration enumConstant) {
		checkCanceled();
		...
		final xap.lui.compile.ca.jdt.internal.compiler.ast.Expression initialization = enumConstant.initialization;
		if (initialization != null) {
			if (initialization instanceof QualifiedAllocationExpression) {
				xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration anonymousType = ((QualifiedAllocationExpression) initialization).anonymousType;
...
//					}
			...
			final xap.lui.compile.ca.jdt.internal.compiler.ast.Expression[] arguments = ((xap.lui.compile.ca.jdt.internal.compiler.ast.AllocationExpression) initialization).arguments;
			if (arguments != null) {
...
//		}
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.EqualExpression expression) {
		InfixExpression infixExpression = new InfixExpression(this.ast);
//		if (this.resolveBindings) {
...
//		}
		...
		int startPosition = leftExpression.getStartPosition();
		infixExpression.setSourceRange(startPosition, expression.sourceEnd - startPosition + 1);
		switch ((expression.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) {
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.EQUAL_EQUAL :
				infixExpression.setOperator(InfixExpression.Operator.EQUALS);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.NOT_EQUAL :
	...
	public Statement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ExplicitConstructorCall statement) {
		...
		if (statement.isSuperAccess() || statement.isSuper()) {
			...
			xap.lui.compile.ca.jdt.internal.compiler.ast.Expression[] arguments = statement.arguments;
			if (arguments != null) {
				int length = arguments.length;
				for (int i = 0; i < length; i++) {
...
//		}
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.Expression expression) {
		if ((expression.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0) {
			return convertToParenthesizedExpression(expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation) expression);
		}		
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.CastExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.CastExpression) expression);
		}
		// switch between all types of expression
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayAllocationExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayAllocationExpression) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedAllocationExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedAllocationExpression) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.AllocationExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.AllocationExpression) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayInitializer) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayInitializer) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.PrefixExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.PrefixExpression) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.PostfixExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.PostfixExpression) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.CompoundAssignment) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.CompoundAssignment) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.Assignment) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.Assignment) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ClassLiteralAccess) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ClassLiteralAccess) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.FalseLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.FalseLiteral) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.TrueLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.TrueLiteral) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.NullLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.NullLiteral) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.CharLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.CharLiteral) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.DoubleLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.DoubleLiteral) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.FloatLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.FloatLiteral) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.IntLiteralMinValue) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.IntLiteralMinValue) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.IntLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.IntLiteral) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.LongLiteralMinValue) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.LongLiteralMinValue) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.LongLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.LongLiteral) expression);
		}
		if (expression instanceof StringLiteralConcatenation) {
			return convert((StringLiteralConcatenation) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ExtendedStringLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ExtendedStringLiteral) expression);
		}	
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.StringLiteral) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.StringLiteral) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.AND_AND_Expression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.AND_AND_Expression) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.OR_OR_Expression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.OR_OR_Expression) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.EqualExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.EqualExpression) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.BinaryExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.BinaryExpression) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.InstanceOfExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.InstanceOfExpression) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.UnaryExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.UnaryExpression) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ConditionalExpression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ConditionalExpression) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.MessageSend) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.MessageSend) expression);
		}				
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.Reference) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.Reference) expression);
		}
		if (expression instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference) expression);
		}
		return null;
	}

	public StringLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ExtendedStringLiteral expression) {
...
//		}
	...
	public BooleanLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.FalseLiteral expression) {
...
//		}
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.FieldReference reference) {
...
//			}
			if (reference.receiver instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedSuperReference) {
				Name qualifier = convert((xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedSuperReference) reference.receiver);
...
//			}
	...
	public NumberLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.FloatLiteral expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;	
		int sourceStart = expression.sourceStart;
		NumberLiteral literal = new NumberLiteral(this.ast);
		literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
...
//		}
	...
	public Statement convert(ForeachStatement statement) {
		switch(this.ast.apiLevel) {
			...
			case AST.JLS3 :
				...
				xap.lui.compile.ca.jdt.internal.compiler.ast.Expression collection = statement.collection;
	...
	public ForStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ForStatement statement) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Statement[] initializations = statement.initializations;
		if (initializations != null) {
			// we know that we have at least one initialization
			if (initializations[0] instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration) {
				xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration initialization = (xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration) initializations[0];
				...
				for (int i = 1; i < initializationsLength; i++) {
					initialization = (xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration)initializations[i];
				...
				if (initializationsLength != 1) {
					...
					int end = ((xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration) initializations[initializationsLength - 1]).declarationSourceEnd;
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Statement[] increments = statement.increments;
		if (increments != null) {
	...
	public IfStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.IfStatement statement) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Statement statement2 = statement.elseStatement;
		if (statement2 != null) {
	...
	public InstanceofExpression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.InstanceOfExpression expression) {
...
//		}
	...
	public NumberLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.IntLiteral expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;	
		int sourceStart = expression.sourceStart;
...
//		}
	...
	public NumberLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.IntLiteralMinValue expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;	
		int sourceStart = expression.sourceStart;
		NumberLiteral literal = new NumberLiteral(this.ast);
		literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
...
//		}
	...
	public void convert(xap.lui.compile.ca.jdt.internal.compiler.ast.Javadoc javadoc, BodyDeclaration bodyDeclaration) {
...
//					}
	...
	public void convert(xap.lui.compile.ca.jdt.internal.compiler.ast.Javadoc javadoc, PackageDeclaration packageDeclaration) {
...
//					}
	...
	public LabeledStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.LabeledStatement statement) {
	...
	public NumberLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.LongLiteral expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;	
		int sourceStart = expression.sourceStart;
		final NumberLiteral literal = new NumberLiteral(this.ast);
		literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
...
//		}
	...
	public NumberLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.LongLiteralMinValue expression) {
		int length = expression.sourceEnd - expression.sourceStart + 1;	
		int sourceStart = expression.sourceStart;
		final NumberLiteral literal = new NumberLiteral(this.ast);
		literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
...
//			}
			...
			if (expression.receiver instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedSuperReference) {
				Name qualifier = convert((xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedSuperReference) expression.receiver);
...
//					}
			...
			xap.lui.compile.ca.jdt.internal.compiler.ast.Expression receiver = expression.receiver;
			if (receiver instanceof MessageSend) {
				if ((receiver.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0) {
...
//			}
	...
	public MarkerAnnotation convert(xap.lui.compile.ca.jdt.internal.compiler.ast.MarkerAnnotation annotation) {
...
//		}
	...
	public MemberValuePair convert(xap.lui.compile.ca.jdt.internal.compiler.ast.MemberValuePair memberValuePair) {
...
//		}
	...
	public Name convert(xap.lui.compile.ca.jdt.internal.compiler.ast.NameReference reference) {
		if (reference instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedNameReference) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedNameReference) reference);
		} else {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.SingleNameReference) reference);
		}
	}
	...
	public InfixExpression convert(StringLiteralConcatenation expression) {
		...
		infixExpression.setOperator(InfixExpression.Operator.PLUS);
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression[] stringLiterals = expression.literals;
		infixExpression.setLeftOperand(convert(stringLiterals[0]));
		infixExpression.setRightOperand(convert(stringLiterals[1]));
...
//		}
	...
	public NormalAnnotation convert(xap.lui.compile.ca.jdt.internal.compiler.ast.NormalAnnotation annotation) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.MemberValuePair[] memberValuePairs = annotation.memberValuePairs;
...
//		}
	...
	public NullLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.NullLiteral expression) {
...
//		}
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.OR_OR_Expression expression) {
		InfixExpression infixExpression = new InfixExpression(this.ast);
		infixExpression.setOperator(InfixExpression.Operator.CONDITIONAL_OR);
//		if (this.resolveBindings) {
//			this.recordNodes(infixExpression, expression);
...
//					}
	...
	public PostfixExpression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.PostfixExpression expression) {
...
//		}
	...
	public PrefixExpression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.PrefixExpression expression) {
...
//		}
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedAllocationExpression allocation) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression[] arguments = allocation.arguments;
		if (arguments != null) {
			int length = arguments.length;
			for (int i = 0; i < length; i++) {
...
//			}
	...
	public Name convert(xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedNameReference nameReference) {
		return setQualifiedNameNameAndSourceRanges(nameReference.tokens, nameReference.sourcePositions, nameReference);
	}

	public Name convert(xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedSuperReference reference) {
		return convert(reference.qualification);
	}

	public ThisExpression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedThisReference reference) {
...
//		}
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.Reference reference) {
		if (reference instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.NameReference) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.NameReference) reference);
		}
		if (reference instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ThisReference) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ThisReference) reference);
		}
		if (reference instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayReference) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ArrayReference) reference);
		}
		if (reference instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.FieldReference) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.FieldReference) reference);
		}
		return null; // cannot be reached
	}
	
	public ReturnStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ReturnStatement statement) {
	...
	public SingleMemberAnnotation convert(xap.lui.compile.ca.jdt.internal.compiler.ast.SingleMemberAnnotation annotation) {
...
//		}
	...
	public SimpleName convert(xap.lui.compile.ca.jdt.internal.compiler.ast.SingleNameReference nameReference) {
		final SimpleName name = new SimpleName(this.ast);
...
//		}
	...
	public Statement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.Statement statement) {
		if (statement instanceof ForeachStatement) {
			return convert((ForeachStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration) {
			xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration localDeclaration = (xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration)statement;
			return convertToVariableDeclarationStatement(localDeclaration);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.AssertStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.AssertStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.Block) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.Block) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.BreakStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.BreakStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ContinueStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ContinueStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.CaseStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.CaseStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.DoStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.DoStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.EmptyStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.EmptyStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ExplicitConstructorCall) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ExplicitConstructorCall) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ForStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ForStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.IfStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.IfStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.LabeledStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.LabeledStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ReturnStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ReturnStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.SwitchStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.SwitchStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.SynchronizedStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.SynchronizedStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.ThrowStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.ThrowStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.TryStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.TryStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration) {
			ASTNode result = convert((xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration) statement);
			if (result == null) {
				return createFakeEmptyStatement(statement);
			}
		...
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.WhileStatement) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.WhileStatement) statement);
		}
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.Expression) {
			xap.lui.compile.ca.jdt.internal.compiler.ast.Expression statement2 = (xap.lui.compile.ca.jdt.internal.compiler.ast.Expression) statement;
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.StringLiteral expression) {
		if (expression instanceof StringLiteralConcatenation) {
			return convert((StringLiteralConcatenation) expression);
		}
		int length = expression.sourceEnd - expression.sourceStart + 1;	
...
//		}
	...
	public SwitchStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.SwitchStatement statement) {
	...
	public SynchronizedStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.SynchronizedStatement statement) {
	...
	public Expression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ThisReference reference) {
		if (reference.isImplicitThis()) {
			// There is no source associated with an implicit this
			return null;
		} else if (reference instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedSuperReference) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedSuperReference) reference);
		} else if (reference instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedThisReference) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedThisReference) reference);
		}  else {
...
//			}
	...
	public ThrowStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.ThrowStatement statement) {
	...
	public BooleanLiteral convert(xap.lui.compile.ca.jdt.internal.compiler.ast.TrueLiteral expression) {
		final BooleanLiteral literal = new BooleanLiteral(this.ast);
...
//		}
	...
	public TryStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.TryStatement statement) {
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Argument[] catchArguments = statement.catchArguments;
		if (catchArguments != null) {
			int catchArgumentsLength = catchArguments.length;
			xap.lui.compile.ca.jdt.internal.compiler.ast.Block[] catchBlocks = statement.catchBlocks;
	...
	public ASTNode convert(xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
		int kind = xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration.kind(typeDeclaration.modifiers);
		switch (kind) {
			case xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration.ENUM_DECL :
				if (this.ast.apiLevel == AST.JLS2_INTERNAL) {
					return null;
				} else {
					return convertToEnumDeclaration(typeDeclaration);
				}
			case xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration.ANNOTATION_TYPE_DECL :
				if (this.ast.apiLevel == AST.JLS2_INTERNAL) {
					return null;
				} else {
		...
		typeDecl.setInterface(kind == xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration.INTERFACE_DECL);
		final SimpleName typeName = new SimpleName(this.ast);
		typeName.internalSetIdentifier(new String(typeDeclaration.name));
		typeName.setSourceRange(typeDeclaration.sourceStart, typeDeclaration.sourceEnd - typeDeclaration.sourceStart + 1);
		typeDecl.setName(typeName);
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference[] superInterfaces = typeDeclaration.superInterfaces;
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.TypeParameter[] typeParameters = typeDeclaration.typeParameters;
		if (typeParameters != null) {
			switch(this.ast.apiLevel) {
				case AST.JLS2_INTERNAL :
					typeDecl.setFlags(typeDecl.getFlags() | ASTNode.MALFORMED);
...
//		}
	...
	public TypeParameter convert(xap.lui.compile.ca.jdt.internal.compiler.ast.TypeParameter typeParameter) {
...
//		}
	...
	public Name convert(xap.lui.compile.ca.jdt.internal.compiler.ast.TypeReference typeReference) {
		char[][] typeName = typeReference.getTypeName();
		int length = typeName.length;
		if (length > 1) {
			// QualifiedName
			xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedTypeReference qualifiedTypeReference = (xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedTypeReference) typeReference;
...
//			}
	...
	public PrefixExpression convert(xap.lui.compile.ca.jdt.internal.compiler.ast.UnaryExpression expression) {
		final PrefixExpression prefixExpression = new PrefixExpression(this.ast);
//		if (this.resolveBindings) {
...
//		}
		...
		switch ((expression.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) {
			...
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.MINUS :
				...
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.NOT :
				prefixExpression.setOperator(PrefixExpression.Operator.NOT);
				break;
			case xap.lui.compile.ca.jdt.internal.compiler.ast.OperatorIds.TWIDDLE :
				prefixExpression.setOperator(PrefixExpression.Operator.COMPLEMENT);
		}
		return prefixExpression;
	}
	
	public WhileStatement convert(xap.lui.compile.ca.jdt.internal.compiler.ast.WhileStatement statement) {
	...
	public ImportDeclaration convertImport(xap.lui.compile.ca.jdt.internal.compiler.ast.ImportReference importReference) {
		final ImportDeclaration importDeclaration = new ImportDeclaration(this.ast);
		final boolean onDemand = (importReference.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0;
...
//
	public PackageDeclaration convertPackage(xap.lui.compile.ca.jdt.internal.compiler.ast.CompilationUnitDeclaration compilationUnitDeclaration) {
		xap.lui.compile.ca.jdt.internal.compiler.ast.ImportReference importReference = compilationUnitDeclaration.currentPackage;
...
//			}
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation[] annotations = importReference.annotations;
		if (annotations != null) {
			switch(this.ast.apiLevel) {
				case AST.JLS2_INTERNAL :
...
//		}
	...
	private EnumDeclaration convertToEnumDeclaration(xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
		checkCanceled();
...
//		}
	...
	public Expression convertToExpression(xap.lui.compile.ca.jdt.internal.compiler.ast.Statement statement) {
		if (statement instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.Expression) {
			return convert((xap.lui.compile.ca.jdt.internal.compiler.ast.Expression) statement);
		} else {
			return null;
		}
	}

	protected FieldDeclaration convertToFieldDeclaration(xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration fieldDecl) {
...
//		}
	...
	public ParenthesizedExpression convertToParenthesizedExpression(xap.lui.compile.ca.jdt.internal.compiler.ast.Expression expression) {
...
//		}
		...
		int numberOfParenthesis = (expression.bits & xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) >> xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
		expression.bits &= ~xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK;
		expression.bits |= (numberOfParenthesis - 1) << xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
		parenthesizedExpression.setExpression(convert(expression));
		return parenthesizedExpression;
	}
		
	public Type convertToType(xap.lui.compile.ca.jdt.internal.compiler.ast.NameReference reference) {
...
//		}
	...
	protected VariableDeclarationExpression convertToVariableDeclarationExpression(xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration localDeclaration) {
...
//		}
	...
	protected VariableDeclarationFragment convertToVariableDeclarationFragment(xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration) {
...
//		}
	...
	protected VariableDeclarationFragment convertToVariableDeclarationFragment(xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration localDeclaration) {
		final VariableDeclarationFragment variableDeclarationFragment = new VariableDeclarationFragment(this.ast);
		final SimpleName name = new SimpleName(this.ast);
		name.internalSetIdentifier(new String(localDeclaration.name));
		...
		xap.lui.compile.ca.jdt.internal.compiler.ast.Expression initialization = localDeclaration.initialization;
...
//		}
	...
	protected VariableDeclarationStatement convertToVariableDeclarationStatement(xap.lui.compile.ca.jdt.internal.compiler.ast.LocalDeclaration localDeclaration) {
		final VariableDeclarationFragment variableDeclarationFragment = convertToVariableDeclarationFragment(localDeclaration);
...
//			}
		...
		if (typeReference instanceof xap.lui.compile.ca.jdt.internal.compiler.ast.SingleTypeReference) {
			// this is either an ArrayTypeReference or a SingleTypeReference
			char[] name = ((xap.lui.compile.ca.jdt.internal.compiler.ast.SingleTypeReference) typeReference).getTypeName()[0];
...
//				}
			...
			if (typeReference instanceof ParameterizedQualifiedTypeReference) {
				...
				switch(this.ast.apiLevel) {
					case AST.JLS2_INTERNAL : {
							char[][] name = ((xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedTypeReference) typeReference).getTypeName();
...
//							}
				...
				char[][] name = ((xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedTypeReference) typeReference).getTypeName();
				int nameLength = name.length;
				long[] positions = ((xap.lui.compile.ca.jdt.internal.compiler.ast.QualifiedTypeReference) typeReference).sourcePositions;
				sourceStart = (int)(positions[0]>>>32);
				length = (int)(positions[nameLength - 1] & 0xFFFFFFFF) - sourceStart + 1;
...
//		}
	...
	protected Statement createFakeEmptyStatement(xap.lui.compile.ca.jdt.internal.compiler.ast.Statement statement) {
...
//	 */	
	private void trimWhiteSpacesAndComments(xap.lui.compile.ca.jdt.internal.compiler.ast.Expression expression) {
		int start = expression.sourceStart;
		int end = expression.sourceEnd;
		int token;
...
//
	...
	protected void setModifiers(AnnotationTypeDeclaration typeDecl, xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
	...
	protected void setModifiers(AnnotationTypeMemberDeclaration annotationTypeMemberDecl, xap.lui.compile.ca.jdt.internal.compiler.ast.AnnotationMethodDeclaration annotationTypeMemberDeclaration) {
	 ...
	 */
	protected void setModifiers(BodyDeclaration bodyDeclaration, xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation[] annotations, int modifiersEnd) {
				...
				switch(token) {
					...
					case TerminalTokens.TokenNameAT :
						...
						if (annotations != null && indexInAnnotations < annotations.length) {
							xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation annotation = annotations[indexInAnnotations++];
	...
	protected void setModifiers(EnumDeclaration enumDeclaration, xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration enumDeclaration2) {
	...
	protected void setModifiers(EnumConstantDeclaration enumConstantDeclaration, xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration) {
		switch(this.ast.apiLevel) {
			case AST.JLS2_INTERNAL :
	 ...
	 * @param fieldDecl
	 */
	protected void setModifiers(FieldDeclaration fieldDeclaration, xap.lui.compile.ca.jdt.internal.compiler.ast.FieldDeclaration fieldDecl) {
		switch(this.ast.apiLevel) {
			case AST.JLS2_INTERNAL :
	 ...
	 */
	protected void setModifiers(Initializer initializer, xap.lui.compile.ca.jdt.internal.compiler.ast.Initializer oldInitializer) {
		switch(this.ast.apiLevel) {
			case AST.JLS2_INTERNAL: 
	...
	protected void setModifiers(SingleVariableDeclaration variableDecl, Argument argument) {
		switch(this.ast.apiLevel) {
			...
			case AST.JLS3 :
				...
				xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation[] annotations = argument.annotations;
				int indexInAnnotations = 0;
				try {
					int token;
					while ((token = this.scanner.getNextToken()) != TerminalTokens.TokenNameEOF) {
	...
	protected void setModifiers(SingleVariableDeclaration variableDecl, LocalDeclaration localDeclaration) {
		...
		case AST.JLS3 :
			...
			xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation[] annotations = localDeclaration.annotations;
			int indexInAnnotations = 0;
			try {
				int token;
				while ((token = this.scanner.getNextToken()) != TerminalTokens.TokenNameEOF) {
	 ...
	 */
	protected void setModifiers(TypeDeclaration typeDecl, xap.lui.compile.ca.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
		switch(this.ast.apiLevel) { 
			case AST.JLS2_INTERNAL :
	...
	protected QualifiedName setQualifiedNameNameAndSourceRanges(char[][] typeName, long[] positions, xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode node) {
		int length = typeName.length;
...
//		}
	...
	protected QualifiedName setQualifiedNameNameAndSourceRanges(char[][] typeName, long[] positions, int endingIndex, xap.lui.compile.ca.jdt.internal.compiler.ast.ASTNode node) {
...
//        }
	...
	protected void setTypeNameForAnnotation(xap.lui.compile.ca.jdt.internal.compiler.ast.Annotation compilerAnnotation, Annotation annotation) {
