...
class RecoveredTypeBinding implements ITypeBinding {
	...
	private xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding binding;
	...
	RecoveredTypeBinding(BindingResolver resolver, xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding) {
		this.resolver = resolver;
