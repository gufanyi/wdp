...
import xap.lui.compile.ca.jdt.internal.compiler.lookup.ElementValuePair;
...
class MemberValuePairBinding implements IMemberValuePairBinding {
	...
	static Object buildDOMValue(final Object internalObject, BindingResolver resolver) {
		...
		} else if (internalObject instanceof xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding) {
			return resolver.getTypeBinding((xap.lui.compile.ca.jdt.internal.compiler.lookup.TypeBinding) internalObject);
		} else if (internalObject instanceof xap.lui.compile.ca.jdt.internal.compiler.lookup.AnnotationBinding) {
			return resolver.getAnnotationInstance((xap.lui.compile.ca.jdt.internal.compiler.lookup.AnnotationBinding) internalObject);
		} else if (internalObject instanceof xap.lui.compile.ca.jdt.internal.compiler.lookup.FieldBinding) {
			return resolver.getVariableBinding((xap.lui.compile.ca.jdt.internal.compiler.lookup.FieldBinding) internalObject);
