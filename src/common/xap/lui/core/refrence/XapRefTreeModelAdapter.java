...
public class XapRefTreeModelAdapter implements IRefTreeModel {

	private xap.sys.appfw.refinfo.IRefTreeModel xapRefModel=null;

	public xap.sys.appfw.refinfo.IRefTreeModel getXapRefModel() {
		return xapRefModel;
	}

	public void setXapRefModel(xap.sys.appfw.refinfo.IRefTreeModel xapRefModel) {
