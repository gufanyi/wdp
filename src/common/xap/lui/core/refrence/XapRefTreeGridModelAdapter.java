...
public class XapRefTreeGridModelAdapter implements IRefTreeGridModel {

	private xap.sys.appfw.refinfo.IRefTreeGridModel xapRefModel=null;

	public xap.sys.appfw.refinfo.IRefTreeGridModel getXapRefModel() {
		return xapRefModel;
	}

	public void setXapRefModel(xap.sys.appfw.refinfo.IRefTreeGridModel xapRefModel) {
	...
	public String getChildField() {
		return xapRefModel.getChildField();
	}

	@Override
	public String getCodingRule() {
		return xapRefModel.getCodingRule();
	}

	@Override
	public String getFatherField() {
		return xapRefModel.getFatherField();
	}

	@Override
	public String getMark() {
		return xapRefModel.getMark();
	}

	@Override
	public String getRootName() {
		return xapRefModel.getRootName();
	}

	@Override
	public boolean isNotLeafNodeSelected() {
		return xapRefModel.isNotLeafNodeSelected();
	}

	@Override
	public List<List<Object>> filterNotLeafNode(List<List<Object>> data) {
		return xapRefModel.filterNotLeafNode(data);
	}

	@Override
	public RefResultSet getClassData() {
		return (RefResultSet)xapRefModel.getClassData();
	}

	@Override
	public String getClassPkFieldCode() {
		return xapRefModel.getClassPkFieldCode();
	}

	@Override
	public String[] getClassFieldCode() {
		return xapRefModel.getClassFieldCode();
	}

	@Override
	public String getClassTableName() {
		return xapRefModel.getClassTableName();
	}

	@Override
	public int getClassFieldIndex(String field) {
		return xapRefModel.getClassFieldIndex(field);
	}

	@Override
	public String getClassJoinField() {
		return xapRefModel.getClassJoinField();
	}

	@Override
	public String getClassJoinValue() {
		return xapRefModel.getClassJoinValue();
	}

	@Override
	public void setClassJoinValue(String strClassJoinValue) {
		xapRefModel.setClassJoinValue(strClassJoinValue);
	}

	@Override
	public String[] getClassOrderPart() {
		return xapRefModel.getClassOrderPart();
	}

	@Override
	public String getClassRefCodeField() {
		return xapRefModel.getClassRefCodeField();
	}

	@Override
	public String getClassRefNameField() {
		return xapRefModel.getClassRefNameField();
	}

	@Override
	public String[] getClassWherePart() {
		return xapRefModel.getClassWherePart();
	}

	@Override
	public void setClassWherePart(Object where) {
		xapRefModel.setClassWherePart(where);
	}

	@Override
	public String getDocJoinField() {
		return xapRefModel.getDocJoinField();
	}
