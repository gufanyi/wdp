...
public abstract class TreeLevel extends LuiElement implements IDataBinding,Serializable,Cloneable
{
	 ...
	 */
    @XmlAttribute(name="masterField")
	private String masterField;
	
	/**
	 * 用于设定与上层节点间的关系，当该层节点被展开时，系统自动从上层节点绑定的record
	 * 对象中获取masterkeyFields指定的字段的值并作为当前层绑定的dataset的parameters
	...
	@XmlElementRefs({@XmlElementRef(name = "RecursiveTreeLevel", type = RecursiveTreeLevel.class), @XmlElementRef(name = "SimpleTreeLevel", type = SimpleTreeLevel.class)})
	...
	public void setMasterKeyField(String masterKeyFields) {
		this.masterField = masterKeyFields;
	}
