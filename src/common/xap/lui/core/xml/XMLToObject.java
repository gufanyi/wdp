...
public class XMLToObject {
    ...
    public static Class classA[] = { Boolean.class, Character.class, Integer.class, Long.class, Double.class,
            Float.class, String.class, java.math.BigDecimal.class, int.class, char.class, boolean.class, long.class,
    ...
    private void fillFieldValue(Field f, Object o, String str) throws Exception {
        ...
        Class classA[] = { Boolean.class, Character.class, Integer.class, Long.class, String.class, Double.class,
                Float.class, java.math.BigDecimal.class };
        ...
        if (!value.equals("null") && isObjectPrimitiveClass) {
            ...
            else if (itemClass == java.math.BigDecimal.class)
