...
public class ObjectToXML
{
   ...
   {Boolean.class, Character.class, Integer.class, Long.class, Double.class, Float.class, String.class,
         java.math.BigDecimal.class, int.class, char.class, boolean.class, long.class, double.class, float.class};
   ...
   private Class getArrayItemClass(Class arrayClass) throws Exception
   {
      ...
      {"[B", "[C", "[I", "[J"};
      Class[] type =
      {byte.class, char.class, int.class, long.class};
   ...
   private Node getDocument(Document doc, Element nod, Object o, int deepSet, Class defaultClass, String arrayName,boolean addClassType)
         throws Exception
   {
      int deep = deepSet + 1;
      if (o == null)
      ...
      if (o.getClass().isArray())
      {
         ...
         for (int j = 0; j < length; j++)
         {
            ...
            getDocument(doc, arrayList, Array.get(o, j), deep, itemType, arrayName,addClassType);
         ...
         for (int i = 0; i < fa.length; i++)
         {
            ...
            if(oc != null)
            {
	            ...
	            else
	            {
	               ...
	               if (oc.getClass().isArray())
	               {
	                  getDocument(doc, nod, oc, deep, fa[i].getType(), fa[i].getName(),addClassType);
	               }
	               else
	               {
	                  getDocument(doc, child, oc, deep, fa[i].getType(), null,addClassType);
	                  appendChild(doc, nod, child);
	               }
	            }
            }
