...
//	public static final String SESSION_LANGUAGE_KEY = "SESSION_DEFAULT_LANGUAGE";
	...
	/** web框架自己用的缓存名称*/
	public static final String LUI_CORE_CACHE = "LUI_CORE_CACHE";
	
	public static final String PAGEMETA_POOL_KEY = "PAGEMETA_POOL_KEY";
	
	public static final String WIDGET_POOL_KEY = "WIDGET_POOL_KEY";
	
	public static final String PROP_POOL_KEY="PROP_POOL_KEY";
	
	public static final String TEMP_FROM_LUI_PATH = "/webtemp";
	
	//js多语路径放置位置
	public static final String TEMP_JSSELFDEFINE_PATH = "/webtemp/html/nodes/";
	
	public static final String TEMP_JSSELFDEFINE_FILE = "/ml_resource.js";
	...
	public static final String KEEP_HEART_BEAT = "KEEP_HEART_BEAT";
