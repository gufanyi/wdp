...
//		dt2rtMap.put(StringDataTypeConst.DATE, RenderTypeConst.DefaultRender);
		...
		dt2rtMap.put(StringDataTypeConst.FBOOLEAN, RenderTypeConst.BooleanRender);
//		dt2rtMap.put(StringDataTypeConst.FDATE, RenderTypeConst.DefaultRender);
		dt2rtMap.put(StringDataTypeConst.FDATE, RenderTypeConst.DateRender);
		dt2rtMap.put(StringDataTypeConst.FDate_begin, RenderTypeConst.DateRender);
		dt2rtMap.put(StringDataTypeConst.FDate_end, RenderTypeConst.DateRender);
		dt2rtMap.put(StringDataTypeConst.FDATETIME, RenderTypeConst.DateTimeRender);
		dt2rtMap.put(StringDataTypeConst.FLiteralDate, RenderTypeConst.DateRender);
		dt2rtMap.put(StringDataTypeConst.FDOUBLE, RenderTypeConst.DecimalRender);
		dt2rtMap.put(StringDataTypeConst.FNUMBERFORMAT, RenderTypeConst.IntegerRender);
		dt2rtMap.put(StringDataTypeConst.FTIME, RenderTypeConst.DefaultRender);
