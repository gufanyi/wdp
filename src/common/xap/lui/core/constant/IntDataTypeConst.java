...
//	public final static int FREF = 5; //参照
...
//	public final static int TIME = 8; //时间
	...
	public static final int FBoolean_TYPE	= 10;
	public static final int FDouble_TYPE = 11;
	public static final int FDateTime_TYPE = 12;
	public static final int FLiteralDate = 28;
	
	//FDate_begin
	public static final int FDate_begin = 29;
	//FDate_end 
	public static final int FDate_end = 30;
	
	public static final int FDate_TYPE = 13;
	public static final int FTime_TYPE = 14;
	public static final int FNumberFormat_TYPE = 15;
