...
public class LuiPageContext {
	public static final String NOID = "";
	public static final String UNKNOWN_LAYOUT_ID = "unknownlayoutid";
	public static final String UNKNOWN_CTRL_ID = "unknownctrlid";
	...
	public static final String SOURCE_TYPE_CONTEXTMENU = "contextmenu";
	...
	public static final String SOURCE_TYPE_LINE= "line";
	public static final String SOURCE_TYPE_BAR= "bar";
	public static final String SOURCE_TYPE_PIE= "pie";
	...
	public static final String SOURCE_TYPE_TEXTBUTTON = "textbutton";
...
//	public static final String SOURCE_TYPE_BORDERPANEL = "borderpanel"; // border布局中的panel
	 ...
	 * 增加绝对布局
	 */
	public static final String SOURCE_TYPE_ABSOLUTELAYOUT ="absolutelayout";
	...
	public static final String SOURCE_TYPE_PANELSPACE = "panelspace";
	...
	public static final String SOURCE_TYPE_DIVIDLAYOUT = "dividlayout";
	public static final String SOURCE_TYPE_DIVIDPROPPANEL = "dividproppanel";
	public static final String SOURCE_TYPE_DIVIDCENTERPANEL = "dividcenterpanel";
	...
	public static final String SOURCE_TYPE_GENERICREFNODE = "genericrefnode";
	public static final String SOURCE_TYPE_COMBODATA = "combodata";
	public static final String SOURCE_TYPE_TOOLBARITEM = "toolbar_element";
...
//	
//	private LuiPageContext parentGlobalContext;
...
//		return LuiRuntimeEnvironment.getWebContext().getWebSession();
//	}
//	
//	public WebContext getWebContext() {
//		return LuiRuntimeEnvironment.getWebContext();
//	}
//
...
//	}
//
//	public void setParentGlobalContext(LuiPageContext pcontext) {
//		this.parentGlobalContext = pcontext;
//		pcontext.parent = true;
//	}
//
//	public LuiPageContext getParentGlobalContext() {
...
//		String pageUniqueId = LuiRuntimeEnvironment.getWebContext().getPageUniqueId();
//		if(url.indexOf("?") != -1)
//			url += "&";
//		else
//			url += "?";
//		url += ParamConstant.OTHER_PAGE_UNIQUE_ID + "=" + pageUniqueId;
//		//$.pageutils.showDialog(pageUrl, title, width, height, id, refresh, clearState) {
//		this.addExecScript("$.pageutils.showDialog(\"" + url + "\", \"" + title + "\", " + width + "," + height + ", \"" + id + "\");");
//	}
//	
//	public void hideCurrentDialog() {
//		if(parent){
//			this.addExecScript("parent.$.pageutils.hideDialog();");
//		}
//		else{
//			this.addExecScript("window.$.pageutils.hideDialog();");
//		}
//	}
//	
//	/**
...
//			url += "?";
//		url += ParamConstant.OTHER_PAGE_UNIQUE_ID + "=" + pageUniqueId;
//		this.addExecScript("$.pageutils.openNormalWindowInCenter('" + url + "', '" + title + "', " + height + ", " + width + ", " + closeParent + ");\n");
//	}
//	
//	/**
//	 * 打开一个最大化窗口
...
//		this.addExecScript("$.pageutils.showMaxWin('" + url + "', '" + title + "', " + closeParent + ")");
...
//		String referer = (String) LuiRuntimeEnvironment.getWebContext().getWebSession().getAttribute(WebSession.REFERER);
//		if(referer != null)
