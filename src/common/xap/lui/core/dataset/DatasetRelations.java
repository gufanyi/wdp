 ...
 *
 */
@XmlRootElement(name = "DatasetRelations")
@XmlAccessorType(XmlAccessType.NONE)
public class DatasetRelations extends ViewElement {
	private static final long serialVersionUID = 1L;
	@XmlElement(name = "DatasetRelation")
	private LuiSet<DatasetRelation> relationList = new LuiHashSet<DatasetRelation>();
	/**
	 ...
	 * @param relationList
	 */
	public void setRelationList(LuiSet<DatasetRelation> relationList) {
	...
	public String[] getMasterDatasetIds() {
		...
		/* 将一主多子的情况记录为一个主记录 */
		for (DatasetRelation inner : this.relationList) {
			set.add(inner.getMasterDataset());
		}
	...
	public DatasetRelation getDsRelation(String masterDsId, String detailDsId) {
		String ds1, ds2;
		for (DatasetRelation inner : this.relationList) {
			ds1 = inner.getMasterDataset();
			ds2 = inner.getDetailDataset();
	 ...
	 */
	public DatasetRelation getDsRelationById(String id) {
		for (DatasetRelation inner : this.relationList) {
			if (id.equals(inner.getId())) {
				return inner;
			}
		}
		return null;
	...
	public Object clone() {
		...
		dsRelation.relationList = new LuiHashSet<DatasetRelation>();
