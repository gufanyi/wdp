...
public class Field extends ExtAttriSupport implements Cloneable, Serializable{
    ...
    public static final String MDFIELD_MULTILANG = "Multi";
    
    //设置某字段是UFID类型的值
    public static final String MDFIELD_UFID = "$UFID";
	...
	*/
	...
	public void setPrecision(String precision) {
		...
		if(!LifeCyclePhase .nullstatus.equals(RequestLifeCycleContext.get().getPhase())){
			setCtxChanged(true);
